...
*/var br,G_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,m){function w(){}w.prototype=m.prototype,_.D=m.prototype,_.prototype=new w,_.prototype.constructor=_,_.C=function(T,A,R){for(var S=Array(arguments.length-2),Z=2;Z<arguments.length;Z++)S[Z-2]=arguments[Z];return m.prototype[A].apply(T,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(_,m,w){w||(w=0);var T=Array(16);if(typeof m=="string")for(var A=0;16>A;++A)T[A]=m.charCodeAt(w++)|m.charCodeAt(w++)<<8|m.charCodeAt(w++)<<16|m.charCodeAt(w++)<<24;else for(A=0;16>A;++A)T[A]=m[w++]|m[w++]<<8|m[w++]<<16|m[w++]<<24;m=_.g[0],w=_.g[1],A=_.g[2];var R=_.g[3],S=m+(R^w&(A^R))+T[0]+3614090360&4294967295;m=w+(S<<7&4294967295|S>>>25),S=R+(A^m&(w^A))+T[1]+3905402710&4294967295,R=m+(S<<12&4294967295|S>>>20),S=A+(w^R&(m^w))+T[2]+606105819&4294967295,A=R+(S<<17&4294967295|S>>>15),S=w+(m^A&(R^m))+T[3]+3250441966&4294967295,w=A+(S<<22&4294967295|S>>>10),S=m+(R^w&(A^R))+T[4]+4118548399&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(A^m&(w^A))+T[5]+1200080426&4294967295,R=m+(S<<12&4294967295|S>>>20),S=A+(w^R&(m^w))+T[6]+2821735955&4294967295,A=R+(S<<17&4294967295|S>>>15),S=w+(m^A&(R^m))+T[7]+4249261313&4294967295,w=A+(S<<22&4294967295|S>>>10),S=m+(R^w&(A^R))+T[8]+1770035416&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(A^m&(w^A))+T[9]+2336552879&4294967295,R=m+(S<<12&4294967295|S>>>20),S=A+(w^R&(m^w))+T[10]+4294925233&4294967295,A=R+(S<<17&4294967295|S>>>15),S=w+(m^A&(R^m))+T[11]+2304563134&4294967295,w=A+(S<<22&4294967295|S>>>10),S=m+(R^w&(A^R))+T[12]+1804603682&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(A^m&(w^A))+T[13]+4254626195&4294967295,R=m+(S<<12&4294967295|S>>>20),S=A+(w^R&(m^w))+T[14]+2792965006&4294967295,A=R+(S<<17&4294967295|S>>>15),S=w+(m^A&(R^m))+T[15]+1236535329&4294967295,w=A+(S<<22&4294967295|S>>>10),S=m+(A^R&(w^A))+T[1]+4129170786&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^A&(m^w))+T[6]+3225465664&4294967295,R=m+(S<<9&4294967295|S>>>23),S=A+(m^w&(R^m))+T[11]+643717713&4294967295,A=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(A^R))+T[0]+3921069994&4294967295,w=A+(S<<20&4294967295|S>>>12),S=m+(A^R&(w^A))+T[5]+3593408605&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^A&(m^w))+T[10]+38016083&4294967295,R=m+(S<<9&4294967295|S>>>23),S=A+(m^w&(R^m))+T[15]+3634488961&4294967295,A=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(A^R))+T[4]+3889429448&4294967295,w=A+(S<<20&4294967295|S>>>12),S=m+(A^R&(w^A))+T[9]+568446438&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^A&(m^w))+T[14]+3275163606&4294967295,R=m+(S<<9&4294967295|S>>>23),S=A+(m^w&(R^m))+T[3]+4107603335&4294967295,A=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(A^R))+T[8]+1163531501&4294967295,w=A+(S<<20&4294967295|S>>>12),S=m+(A^R&(w^A))+T[13]+2850285829&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^A&(m^w))+T[2]+4243563512&4294967295,R=m+(S<<9&4294967295|S>>>23),S=A+(m^w&(R^m))+T[7]+1735328473&4294967295,A=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(A^R))+T[12]+2368359562&4294967295,w=A+(S<<20&4294967295|S>>>12),S=m+(w^A^R)+T[5]+4294588738&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^A)+T[8]+2272392833&4294967295,R=m+(S<<11&4294967295|S>>>21),S=A+(R^m^w)+T[11]+1839030562&4294967295,A=R+(S<<16&4294967295|S>>>16),S=w+(A^R^m)+T[14]+4259657740&4294967295,w=A+(S<<23&4294967295|S>>>9),S=m+(w^A^R)+T[1]+2763975236&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^A)+T[4]+1272893353&4294967295,R=m+(S<<11&4294967295|S>>>21),S=A+(R^m^w)+T[7]+4139469664&4294967295,A=R+(S<<16&4294967295|S>>>16),S=w+(A^R^m)+T[10]+3200236656&4294967295,w=A+(S<<23&4294967295|S>>>9),S=m+(w^A^R)+T[13]+681279174&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^A)+T[0]+3936430074&4294967295,R=m+(S<<11&4294967295|S>>>21),S=A+(R^m^w)+T[3]+3572445317&4294967295,A=R+(S<<16&4294967295|S>>>16),S=w+(A^R^m)+T[6]+76029189&4294967295,w=A+(S<<23&4294967295|S>>>9),S=m+(w^A^R)+T[9]+3654602809&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^A)+T[12]+3873151461&4294967295,R=m+(S<<11&4294967295|S>>>21),S=A+(R^m^w)+T[15]+530742520&4294967295,A=R+(S<<16&4294967295|S>>>16),S=w+(A^R^m)+T[2]+3299628645&4294967295,w=A+(S<<23&4294967295|S>>>9),S=m+(A^(w|~R))+T[0]+4096336452&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~A))+T[7]+1126891415&4294967295,R=m+(S<<10&4294967295|S>>>22),S=A+(m^(R|~w))+T[14]+2878612391&4294967295,A=R+(S<<15&4294967295|S>>>17),S=w+(R^(A|~m))+T[5]+4237533241&4294967295,w=A+(S<<21&4294967295|S>>>11),S=m+(A^(w|~R))+T[12]+1700485571&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~A))+T[3]+2399980690&4294967295,R=m+(S<<10&4294967295|S>>>22),S=A+(m^(R|~w))+T[10]+4293915773&4294967295,A=R+(S<<15&4294967295|S>>>17),S=w+(R^(A|~m))+T[1]+2240044497&4294967295,w=A+(S<<21&4294967295|S>>>11),S=m+(A^(w|~R))+T[8]+1873313359&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~A))+T[15]+4264355552&4294967295,R=m+(S<<10&4294967295|S>>>22),S=A+(m^(R|~w))+T[6]+2734768916&4294967295,A=R+(S<<15&4294967295|S>>>17),S=w+(R^(A|~m))+T[13]+1309151649&4294967295,w=A+(S<<21&4294967295|S>>>11),S=m+(A^(w|~R))+T[4]+4149444226&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~A))+T[11]+3174756917&4294967295,R=m+(S<<10&4294967295|S>>>22),S=A+(m^(R|~w))+T[2]+718787259&4294967295,A=R+(S<<15&4294967295|S>>>17),S=w+(R^(A|~m))+T[9]+3951481745&4294967295,_.g[0]=_.g[0]+m&4294967295,_.g[1]=_.g[1]+(A+(S<<21&4294967295|S>>>11))&4294967295,_.g[2]=_.g[2]+A&4294967295,_.g[3]=_.g[3]+R&4294967295}r.prototype.u=function(_,m){m===void 0&&(m=_.length);for(var w=m-this.blockSize,T=this.B,A=this.h,R=0;R<m;){if(A==0)for(;R<=w;)i(this,_,R),R+=this.blockSize;if(typeof _=="string"){for(;R<m;)if(T[A++]=_.charCodeAt(R++),A==this.blockSize){i(this,T),A=0;break}}else for(;R<m;)if(T[A++]=_[R++],A==this.blockSize){i(this,T),A=0;break}}this.h=A,this.o+=m},r.prototype.v=function(){var _=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);_[0]=128;for(var m=1;m<_.length-8;++m)_[m]=0;var w=8*this.o;for(m=_.length-8;m<_.length;++m)_[m]=w&255,w/=256;for(this.u(_),_=Array(16),m=w=0;4>m;++m)for(var T=0;32>T;T+=8)_[w++]=this.g[m]>>>T&255;return _};function s(_,m){var w=l;return Object.prototype.hasOwnProperty.call(w,_)?w[_]:w[_]=m(_)}function o(_,m){this.h=m;for(var w=[],T=!0,A=_.length-1;0<=A;A--){var R=_[A]|0;T&&R==m||(w[A]=R,T=!1)}this.g=w}var l={};function u(_){return-128<=_&&128>_?s(_,function(m){return new o([m|0],0>m?-1:0)}):new o([_|0],0>_?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return y;if(0>_)return O(h(-_));for(var m=[],w=1,T=0;_>=w;T++)m[T]=_/w|0,w*=4294967296;return new o(m,0)}function f(_,m){if(_.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(_.charAt(0)=="-")return O(f(_.substring(1),m));if(0<=_.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=h(Math.pow(m,8)),T=y,A=0;A<_.length;A+=8){var R=Math.min(8,_.length-A),S=parseInt(_.substring(A,A+R),m);8>R?(R=h(Math.pow(m,R)),T=T.j(R).add(h(S))):(T=T.j(w),T=T.add(h(S)))}return T}var y=u(0),v=u(1),k=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-O(this).m();for(var _=0,m=1,w=0;w<this.g.length;w++){var T=this.i(w);_+=(0<=T?T:4294967296+T)*m,m*=4294967296}return _},t.toString=function(_){if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(C(this))return"0";if(N(this))return"-"+O(this).toString(_);for(var m=h(Math.pow(_,6)),w=this,T="";;){var A=b(w,m).g;w=I(w,A.j(m));var R=((0<w.g.length?w.g[0]:w.h)>>>0).toString(_);if(w=A,C(w))return R+T;for(;6>R.length;)R="0"+R;T=R+T}},t.i=function(_){return 0>_?0:_<this.g.length?this.g[_]:this.h};function C(_){if(_.h!=0)return!1;for(var m=0;m<_.g.length;m++)if(_.g[m]!=0)return!1;return!0}function N(_){return _.h==-1}t.l=function(_){return _=I(this,_),N(_)?-1:C(_)?0:1};function O(_){for(var m=_.g.length,w=[],T=0;T<m;T++)w[T]=~_.g[T];return new o(w,~_.h).add(v)}t.abs=function(){return N(this)?O(this):this},t.add=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0,A=0;A<=m;A++){var R=T+(this.i(A)&65535)+(_.i(A)&65535),S=(R>>>16)+(this.i(A)>>>16)+(_.i(A)>>>16);T=S>>>16,R&=65535,S&=65535,w[A]=S<<16|R}return new o(w,w[w.length-1]&-2147483648?-1:0)};function I(_,m){return _.add(O(m))}t.j=function(_){if(C(this)||C(_))return y;if(N(this))return N(_)?O(this).j(O(_)):O(O(this).j(_));if(N(_))return O(this.j(O(_)));if(0>this.l(k)&&0>_.l(k))return h(this.m()*_.m());for(var m=this.g.length+_.g.length,w=[],T=0;T<2*m;T++)w[T]=0;for(T=0;T<this.g.length;T++)for(var A=0;A<_.g.length;A++){var R=this.i(T)>>>16,S=this.i(T)&65535,Z=_.i(A)>>>16,se=_.i(A)&65535;w[2*T+2*A]+=S*se,E(w,2*T+2*A),w[2*T+2*A+1]+=R*se,E(w,2*T+2*A+1),w[2*T+2*A+1]+=S*Z,E(w,2*T+2*A+1),w[2*T+2*A+2]+=R*Z,E(w,2*T+2*A+2)}for(T=0;T<m;T++)w[T]=w[2*T+1]<<16|w[2*T];for(T=m;T<2*m;T++)w[T]=0;return new o(w,0)};function E(_,m){for(;(_[m]&65535)!=_[m];)_[m+1]+=_[m]>>>16,_[m]&=65535,m++}function x(_,m){this.g=_,this.h=m}function b(_,m){if(C(m))throw Error("division by zero");if(C(_))return new x(y,y);if(N(_))return m=b(O(_),m),new x(O(m.g),O(m.h));if(N(m))return m=b(_,O(m)),new x(O(m.g),m.h);if(30<_.g.length){if(N(_)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var w=v,T=m;0>=T.l(_);)w=F(w),T=F(T);var A=j(w,1),R=j(T,1);for(T=j(T,2),w=j(w,2);!C(T);){var S=R.add(T);0>=S.l(_)&&(A=A.add(w),R=S),T=j(T,1),w=j(w,1)}return m=I(_,A.j(m)),new x(A,m)}for(A=y;0<=_.l(m);){for(w=Math.max(1,Math.floor(_.m()/m.m())),T=Math.ceil(Math.log(w)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),R=h(w),S=R.j(m);N(S)||0<S.l(_);)w-=T,R=h(w),S=R.j(m);C(R)&&(R=v),A=A.add(R),_=I(_,S)}return new x(A,_)}t.A=function(_){return b(this,_).h},t.and=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)&_.i(T);return new o(w,this.h&_.h)},t.or=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)|_.i(T);return new o(w,this.h|_.h)},t.xor=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)^_.i(T);return new o(w,this.h^_.h)};function F(_){for(var m=_.g.length+1,w=[],T=0;T<m;T++)w[T]=_.i(T)<<1|_.i(T-1)>>>31;return new o(w,_.h)}function j(_,m){var w=m>>5;m%=32;for(var T=_.g.length-w,A=[],R=0;R<T;R++)A[R]=0<m?_.i(R+w)>>>m|_.i(R+w+1)<<32-m:_.i(R+w);return new o(A,_.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,G_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,br=o}).apply(typeof og<"u"?og:typeof self<"u"?self:typeof window<"u"?window:{});var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hd(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Wd(t){const e=t.mapValue.fields.__previous_value__;return Hd(e)?Wd(e):e}function lo(t){const e=dr(t.mapValue.fields.__local_write_time__.timestampValue);return new Ve(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YA=new Te(H.comparator);function Pn(){return YA}const mw=new Te(H.comparator);function As(...t){let e=mw;for(const n of t)e=e.insert(n.key,n);return e}function gw(t){let e=mw;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Cr(){return Us()}function yw(){return Us()}function Us(){return new Yi(t=>t.toString(),(t,e)=>t.isEqual(e))}const XA=new Te(H.comparator),JA=new qe(H.comparator);function te(...t){let e=JA;for(const n of t)e=e.add(n);return e}const ZA=new qe(ae);function ek(){return ZA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tf{constructor(){this.Tr=new qe(Le.Er),this.dr=new qe(Le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,n){const r=new Le(e,n);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Vr(new Le(e,n))}mr(e,n){e.forEach(r=>this.removeReference(r,n))}gr(e){const n=new H(new me([])),r=new Le(n,e),i=new Le(n,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const n=new H(new me([])),r=new Le(n,e),i=new Le(n,e+1);let s=te();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new Le(e,0),r=this.Tr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class Le{constructor(e,n){this.key=e,this.wr=n}static Er(e,n){return H.comparator(e.key,n.key)||ae(e.wr,n.wr)}static Ar(e,n){return ae(e.wr,n.wr)||H.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xl=new Ud("@firebase/auth");function wC(t,...e){xl.logLevel<=ne.WARN&&xl.warn(`Auth (${Wi}): ${t}`,...e)}function Ba(t,...e){xl.logLevel<=ne.ERROR&&xl.error(`Auth (${Wi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hn extends Do{constructor(){super("github.com")}static credential(e){return Br._fromParams({providerId:Hn.PROVIDER_ID,signInMethod:Hn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Hn.credentialFromTaggedObject(e)}static credentialFromError(e){return Hn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Hn.credential(e.oauthAccessToken)}catch{return null}}}Hn.GITHUB_SIGN_IN_METHOD="github.com";Hn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tR(t,e,n=!1){const{auth:r}=t;if(yn(r.app))return Promise.reject(lr(r));const i="reauthenticate";try{const s=await yo(t,W0(r,i,e,t),n);Q(s.idToken,r,"internal-error");const o=Rf(s.idToken);Q(o,r,"internal-error");const{sub:l}=o;return Q(t.uid===l,r,"user-mismatch"),pr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Nn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UN(t=zd()){return kE().then(e=>{if(!e)throw ct.create("unsupported-browser")},e=>{throw ct.create("indexed-db-unsupported")}),Hi(it(t),"messaging").getImmediate()}async function BN(t,e){return t=it(t),AE(t,e)}FN();const zN={apiKey:"AIzaSyACbnHcH9OPbZurDjWf8m1cazFOSSadYKE",authDomain:"deungbul-qt.firebaseapp.com",projectId:"deungbul-qt",storageBucket:"deungbul-qt.firebasestorage.app",messagingSenderId:"1048157032708",appId:"1:1048157032708:web:46aab740a361a9f5ebc051",measurementId:"G-GQXXJHHKL7"},$N="BCm1sLB19B--eH-e3FgGQhaxwZlWeoF7oA7Fa2V3FWZWE44quYgHDyugQNux5hIe7U7qhRSvRvLEERpojWaXqEo",Bf=W_(zN),Qt=eC(Bf),Hh=gP(Bf);let Ea=null;async function qN(){return Ea||(await kE().catch(()=>!1)?(Ea=UN(Bf),Ea):null)}function HN(t){sR(Hh,e=>{e?t(e):ZC(Hh).catch(n=>console.error("익명 로그인 실패",n))})}const Ta="qt_entries";function Nl(t=new Date){const e=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${e}-${n}-${r}`}function WN(){const[t,e]=W.useState({}),[n,r]=W.useState(!0);W.useEffect(()=>{const l=m0(o0(Qt,Ta),g0("date","desc"));return E0(l,h=>{const f={};h.forEach(y=>{f[y.id]=y.data()}),e(f),r(!1)},h=>{console.error("entries 구독 실패",h),r(!1)})},[]);const i=W.useCallback(async(l,u)=>{const h=ar(Qt,Ta,l);await go(h,{date:l,...u,writtenAt:Kg()},{merge:!0})},[]),s=W.useCallback(async(l,u,h)=>{const f=ar(Qt,Ta,l);await go(f,{date:l,checked:u,comment:h??"",checkedAt:Kg()},{merge:!0})},[]),o=W.useCallback(async l=>{const u=ar(Qt,Ta,l);await w0(u)},[]);return{entries:t,loading:n,saveEntry:i,setCheck:s,deleteEntry:o}}const KN=["일","월","화","수","목","금","토"];function QN({entries:t,onSelectDate:e}){const[n,r]=W.useState(new Date),i=n.getFullYear(),s=n.getMonth(),l=new Date(i,s,1).getDay(),u=new Date(i,s+1,0).getDate(),h=Nl(),f=[];for(let v=0;v<l;v++)f.push(null);for(let v=1;v<=u;v++)f.push(v);const y=v=>{r(new Date(i,s+v,1))};return p.jsxs("div",{className:"px-4 pt-4",children:[p.jsxs("div",{className:"flex items-center justify-between mb-4",children:[p.jsx("button",{onClick:()=>y(-1),className:"text-faint text-xl px-3 py-1",children:"‹"}),p.jsxs("h2",{className:"font-display text-lg",children:[i,"년 ",s+1,"월"]}),p.jsx("button",{onClick:()=>y(1),className:"text-faint text-xl px-3 py-1",children:"›"})]}),p.jsx("div",{className:"grid grid-cols-7 gap-1 mb-2",children:KN.map(v=>p.jsx("div",{className:"text-center text-xs text-faint py-1",children:v},v))}),p.jsx("div",{className:"grid grid-cols-7 gap-1",children:f.map((v,k)=>{var F,j;if(v===null)return p.jsx("div",{},`empty-${k}`);const C=`${i}-${String(s+1).padStart(2,"0")}-${String(v).padStart(2,"0")}`,N=t[C],O=Array.isArray(N==null?void 0:N.sectionQA)?N.sectionQA.some(_=>{var m;return(m=_.answer)==null?void 0:m.trim()}):!1,I=Array.isArray(N==null?void 0:N.groupQA)?N.groupQA.some(_=>{var m;return(m=_.answer)==null?void 0:m.trim()}):!1,E=!!(O||I||(F=N==null?void 0:N.groupSummary)!=null&&F.trim()||(j=N==null?void 0:N.content)!=null&&j.trim()||Array.isArray(N==null?void 0:N.passageQA)&&N.passageQA.some(_=>{var m;return(m=_.answer)==null?void 0:m.trim()})),x=!!(N!=null&&N.checked),b=C===h;return p.jsxs("button",{onClick:()=>e(C),className:"flex flex-col items-center gap-0.5 py-1",children:[p.jsx("div",{className:["lamp-dot",x?"is-checked":E?"is-written":""].join(" "),style:b?{outline:"2px solid rgba(247,241,226,0.6)",outlineOffset:"2px"}:{},children:x&&p.jsx("span",{className:"rabbit-icon",children:"🐇"})}),p.jsx("span",{className:`text-[10px] ${b?"text-paper font-semibold":"text-faint"}`,children:v})]},C)})}),p.jsxs("div",{className:"flex gap-5 mt-6 text-xs text-faint justify-center pb-2",children:[p.jsxs("div",{className:"flex items-center gap-2",children:[p.jsx("div",{style:{width:18,height:18,borderRadius:"50%",border:"1.5px solid #D9CFB8"}}),p.jsx("span",{children:"미작성"})]}),p.jsxs("div",{className:"flex items-center gap-2",children:[p.jsx("div",{style:{width:18,height:18,borderRadius:"50%",background:"radial-gradient(circle, #fff5c0 0%, #E8A33D 60%, #F2C879 100%)",boxShadow:"0 0 8px 2px rgba(232,163,61,0.5)"}}),p.jsx("span",{children:"보름달 (작성)"})]}),p.jsxs("div",{className:"flex items-center gap-2",children:[p.jsx("div",{style:{width:22,height:22,borderRadius:"50%",background:"radial-gradient(circle, #fff5c0 0%, #E8A33D 60%, #F2C879 100%)",boxShadow:"0 0 8px 2px rgba(232,163,61,0.5)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13},children:p.jsx("span",{style:{filter:"brightness(0) saturate(100%)"},children:"🐇"})}),p.jsx("span",{children:"코디네이터 확인"})]})]})]})}const Ac="units";function CE(){const[t,e]=W.useState([]),[n,r]=W.useState(!0);W.useEffect(()=>{const o=m0(o0(Qt,Ac),g0("startDate","asc"));return E0(o,u=>{const h=[];u.forEach(f=>h.push({id:f.id,...f.data()})),e(h),r(!1)},u=>{console.error("units 구독 실패",u),r(!1)})},[]);const i=W.useCallback(async(o,l)=>{const u=ar(Qt,Ac,o);await go(u,l,{merge:!1})},[]),s=W.useCallback(async o=>{await w0(ar(Qt,Ac,o))},[]);return{units:t,loading:n,saveUnit:i,deleteUnit:s}}function RE(t,e){const n=new Date(e+"T00:00:00"),r=n.getDay();if(r===0)return null;for(const i of t){if(!i.startDate||!Array.isArray(i.days))continue;const s=new Date(i.startDate+"T00:00:00"),o=Math.floor((n-s)/864e5);if(o<0)continue;const l=Math.floor(o/7);if(r===6){if(l===0)return{unitId:i.id,unitTitle:i.title,dayIndex:-1,isSaturdaySharing:!0,title:"코디네이터(소그룹)와의 나눔",sections:[],groupQuestions:i.groupQuestions??[]};continue}const u=r-1;if(l===0&&u>=0&&u<i.days.length)return{unitId:i.id,unitTitle:i.title,dayIndex:u,isSaturdaySharing:!1,...i.days[u],groupQuestions:i.groupQuestions??[]}}return null}function _y(){return Math.random().toString(36).slice(2,9)}function wy(t){if(!t)return[];if(Array.isArray(t.sections)&&t.sections.length>0)return t.sections;const e=Array.isArray(t.reflectionQuestions)?t.reflectionQuestions:[],n=[];return t.body&&n.push({type:"body",body:t.body,question:null}),e.forEach(r=>{n.push({type:"reflection",body:null,question:r})}),n}function GN({dateKey:t,entry:e,units:n,onSave:r,onDelete:i,onClose:s}){var R,S;const o=RE(n??[],t),l=(o==null?void 0:o.isSaturdaySharing)===!0,[u,h]=W.useState("view"),[f,y]=W.useState([]),[v,k]=W.useState([]),[C,N]=W.useState(""),[O,I]=W.useState(!1),[E,x]=W.useState(!1),b=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA.some(Z=>{var se;return(se=Z.answer)==null?void 0:se.trim()}):!1,F=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA.some(Z=>{var se;return(se=Z.answer)==null?void 0:se.trim()}):!1,j=!!(b||F||(R=e==null?void 0:e.groupSummary)!=null&&R.trim()||(S=e==null?void 0:e.groupSharing)!=null&&S.trim());W.useEffect(()=>{if(h(j?"view":"edit"),x(!1),N((e==null?void 0:e.groupSummary)??""),o){const Z=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA:[];if(k((o.groupQuestions??[]).map((se,be)=>{var Ce,B;return{id:((Ce=Z[be])==null?void 0:Ce.id)??_y(),question:se,answer:((B=Z[be])==null?void 0:B.answer)??""}})),l)y([]);else{const se=wy(o),be=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[];y(se.map((Ce,B)=>{var K,Y;return{id:((K=be[B])==null?void 0:K.id)??_y(),question:Ce.question??"",answer:((Y=be[B])==null?void 0:Y.answer)??""}}))}}else y([]),k([])},[t,e]);const _=async()=>{O||(I(!0),await r(t,{passage:(o==null?void 0:o.title)??"",content:o?`${o.unitTitle} - ${o.title}`:"",sectionQA:f,groupQA:v,groupSummary:C}),I(!1),s())},m=async()=>{if(!E){x(!0);return}I(!0),await i(t),I(!1),s()},w=(e==null?void 0:e.checked)||(e==null?void 0:e.comment),T=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[];Array.isArray(e==null?void 0:e.groupQA)&&e.groupQA;const A=!l&&o?wy(o):[];return l?p.jsxs("div",{className:"px-5 pb-10",children:[p.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[p.jsx("button",{onClick:s,className:"text-faint",children:"‹ 닫기"}),p.jsx("h2",{className:"font-display text-base",children:t}),p.jsx("div",{className:"w-10"})]}),p.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl px-4 py-3 bg-sage/5",children:[p.jsx("p",{className:"text-xs text-sage mb-0.5",children:o.unitTitle}),p.jsx("p",{className:"font-display text-base text-sage",children:"코디네이터(소그룹)와의 나눔"})]}),u==="view"?p.jsxs(p.Fragment,{children:[v.length>0&&p.jsxs("div",{className:"mb-6",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*개인이 생각할 질문"}),p.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"다음의 질문들은 이미 2단원을 공부하면서 생각했던 질문들입니다. 다시 한 번 질문들을 생각하시며 정리해보십시오."}),p.jsx("div",{className:"flex flex-col gap-3",children:v.map((Z,se)=>p.jsxs("div",{className:"border border-sage/30 rounded-xl p-3 bg-sage/5",children:[p.jsxs("p",{className:"text-paper text-sm font-semibold mb-1",children:[se+1,". ",Z.question]}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Z.answer||"-"})]},Z.id??se))})]}),p.jsxs("div",{className:"mb-6",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)와 나눌 생각 정리하기"}),p.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"잠언 1장 1절에서 7절을 읽을 때 다가온 구절(lexio)을 쪽지에 적었을텐데, 그 쪽지묵상 말씀과 함께 몇 번이나 읽으며 묵상했는지, 또한 깨달은 것은 무엇인지를 적고 동시에 내가 대답한 기도(oratio)를 정리하십시오."}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:(e==null?void 0:e.groupSummary)||"-"})]}),p.jsxs("div",{className:"mb-6 border border-sage/20 rounded-xl p-3 bg-sage/5",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)에서 나누기"}),p.jsx("p",{className:"text-xs text-faint/70",children:"정리된 생각을 코디네이터에게 먼저 얘기하고 나누는 시간을 가지십시오."})]}),w&&p.jsxs("div",{className:"mt-2 mb-6 border border-sage/50 rounded-xl p-4 bg-sage/10",children:[p.jsx("p",{className:"text-sage text-sm font-semibold mb-1",children:e!=null&&e.checked?"코디네이터가 확인했어요 🐇":"코디네이터 코멘트"}),(e==null?void 0:e.comment)&&p.jsx("p",{className:"text-paper text-sm leading-relaxed",children:e.comment})]}),p.jsx("button",{onClick:()=>h("edit"),className:"w-full border border-sage text-sage font-semibold py-4 rounded-2xl mb-3",children:"수정하기"}),E?p.jsxs("div",{className:"border border-red-400/40 rounded-xl p-4 text-center",children:[p.jsx("p",{className:"text-sm text-paper mb-3",children:"정말 삭제할까요? 되돌릴 수 없어요."}),p.jsxs("div",{className:"flex gap-2",children:[p.jsx("button",{onClick:()=>x(!1),className:"flex-1 border border-faint text-faint py-2 rounded-xl text-sm",children:"취소"}),p.jsx("button",{onClick:m,disabled:O,className:"flex-1 bg-red-400/80 text-nightDeep py-2 rounded-xl text-sm font-semibold disabled:opacity-60",children:O?"삭제 중...":"삭제하기"})]})]}):p.jsx("button",{onClick:m,className:"w-full text-faint text-sm py-2",children:"이 날짜 기록 삭제"})]}):p.jsxs(p.Fragment,{children:[v.length>0&&p.jsxs("div",{className:"mb-6",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*개인이 생각할 질문"}),p.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"다음의 질문들은 이미 2단원을 공부하면서 생각했던 질문들입니다. 다시 한 번 질문들을 생각하시며 정리해보십시오."}),p.jsx("div",{className:"flex flex-col gap-3",children:v.map((Z,se)=>p.jsxs("div",{className:"border border-sage/30 rounded-xl p-3 bg-sage/5",children:[p.jsxs("p",{className:"text-paper text-sm font-semibold mb-2",children:[se+1,". ",Z.question]}),p.jsx("textarea",{value:Z.answer,onChange:be=>{const Ce=[...v];Ce[se]={...Ce[se],answer:be.target.value},k(Ce)},rows:3,placeholder:"답변을 적어주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]},Z.id))})]}),p.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl p-4 bg-sage/5",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)와 나눌 생각 정리하기"}),p.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"잠언 1장 1절에서 7절을 읽을 때 다가온 구절(lexio)을 쪽지에 적었을텐데, 그 쪽지묵상 말씀과 함께 몇 번이나 읽으며 묵상했는지, 또한 깨달은 것은 무엇인지를 적고 동시에 내가 대답한 기도(oratio)를 정리하십시오."}),p.jsx("textarea",{value:C,onChange:Z=>N(Z.target.value),rows:6,placeholder:"깨닫게 된 것을 정리하고 나눔 후 느낀 점도 함께 적어두세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]}),p.jsxs("div",{className:"mb-6 border border-sage/20 rounded-xl p-3 bg-sage/5",children:[p.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)에서 나누기"}),p.jsx("p",{className:"text-xs text-faint/70",children:"정리된 생각을 코디네이터에게 먼저 얘기하고 나누는 시간을 가지십시오."})]}),p.jsxs("div",{className:"flex gap-3",children:[j&&p.jsx("button",{onClick:()=>h("view"),className:"flex-1 border border-faint text-faint font-semibold py-4 rounded-2xl",children:"취소"}),p.jsx("button",{onClick:_,disabled:O,className:"flex-1 bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:O?"저장 중...":"저장하기"})]})]})]}):p.jsxs("div",{className:"px-5 pb-10",children:[p.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[p.jsx("button",{onClick:s,className:"text-faint",children:"‹ 닫기"}),p.jsx("h2",{className:"font-display text-base",children:t}),p.jsx("div",{className:"w-10"})]}),o?p.jsxs("div",{className:"mb-4 border border-lamp/30 rounded-xl px-4 py-3 bg-lamp/5",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-0.5",children:o.unitTitle}),p.jsx("p",{className:"font-display text-base text-lamp",children:o.title})]}):p.jsx("div",{className:"mb-6 border border-faint/30 rounded-xl p-4 text-center text-faint text-sm",children:"이 날짜에는 등록된 본문이 없어요 (주말이거나 단원 범위 밖)"}),u==="view"?p.jsxs(p.Fragment,{children:[A.map((Z,se)=>{var be;return p.jsxs("div",{children:[Z.body&&p.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Z.body})}),Z.question&&p.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),p.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:Z.question}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:((be=T[se])==null?void 0:be.answer)||"-"})]})]},se)}),w&&p.jsxs("div",{className:"mt-2 mb-6 border border-sage/50 rounded-xl p-4 bg-sage/10",children:[p.jsx("p",{className:"text-sage text-sm font-semibold mb-1",children:e!=null&&e.checked?"코디네이터가 확인했어요 🐇":"코디네이터 코멘트"}),(e==null?void 0:e.comment)&&p.jsx("p",{className:"text-paper text-sm leading-relaxed",children:e.comment})]}),p.jsx("button",{onClick:()=>h("edit"),className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-3",children:"수정하기"}),E?p.jsxs("div",{className:"border border-red-400/40 rounded-xl p-4 text-center",children:[p.jsx("p",{className:"text-sm text-paper mb-3",children:"정말 삭제할까요? 되돌릴 수 없어요."}),p.jsxs("div",{className:"flex gap-2",children:[p.jsx("button",{onClick:()=>x(!1),className:"flex-1 border border-faint text-faint py-2 rounded-xl text-sm",children:"취소"}),p.jsx("button",{onClick:m,disabled:O,className:"flex-1 bg-red-400/80 text-nightDeep py-2 rounded-xl text-sm font-semibold disabled:opacity-60",children:O?"삭제 중...":"삭제하기"})]})]}):p.jsx("button",{onClick:m,className:"w-full text-faint text-sm py-2",children:"이 날짜 기록 삭제"})]}):p.jsxs(p.Fragment,{children:[A.map((Z,se)=>{var be;return p.jsxs("div",{children:[Z.body&&p.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Z.body})}),Z.question&&p.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),p.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:Z.question}),p.jsx("textarea",{value:((be=f[se])==null?void 0:be.answer)??"",onChange:Ce=>{const B=[...f];B[se]={...B[se],answer:Ce.target.value},y(B)},rows:3,placeholder:"답변을 적어주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"})]})]},se)}),p.jsxs("div",{className:"flex gap-3",children:[j&&p.jsx("button",{onClick:()=>h("view"),className:"flex-1 border border-faint text-faint font-semibold py-4 rounded-2xl",children:"취소"}),p.jsx("button",{onClick:_,disabled:O,className:"flex-1 bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:O?"저장 중...":"저장하기"})]})]})]})}function YN({dateKey:t,entry:e,units:n,onCheck:r,onClose:i}){var O;const s=RE(n??[],t),[o,l]=W.useState(""),[u,h]=W.useState(!1);W.useEffect(()=>{l((e==null?void 0:e.comment)??"")},[t,e]);const f=(s==null?void 0:s.sections)??[],y=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[],v=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA:[],k=!!(y.some(I=>{var E;return(E=I.answer)==null?void 0:E.trim()})||v.some(I=>{var E;return(E=I.answer)==null?void 0:E.trim()})||(O=e==null?void 0:e.groupSummary)!=null&&O.trim()),C=async()=>{h(!0),await r(t,!(e!=null&&e.checked),o),h(!1),e!=null&&e.checked||i()},N=async()=>{await r(t,(e==null?void 0:e.checked)??!1,o)};return p.jsxs("div",{className:"px-5 pb-10",children:[p.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[p.jsx("button",{onClick:i,className:"text-faint",children:"‹ 닫기"}),p.jsx("h2",{className:"font-display text-base",children:t}),p.jsx("div",{className:"w-10"})]}),s&&p.jsxs("div",{className:"mb-4 border border-lamp/30 rounded-xl px-4 py-3 bg-lamp/5",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-0.5",children:s.unitTitle}),p.jsx("p",{className:"font-display text-base text-lamp",children:s.title})]}),k?p.jsxs(p.Fragment,{children:[f.map((I,E)=>{var x;return p.jsxs("div",{children:[p.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:I.body})}),I.question&&p.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),p.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:I.question}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:((x=y[E])==null?void 0:x.answer)||"-"})]})]},E)}),v.length>0&&p.jsxs("div",{className:"mb-5",children:[p.jsx("p",{className:"text-xs text-sage mb-2",children:"코디네이터(소그룹)와의 나눔 — 개인 생각 질문"}),p.jsx("div",{className:"flex flex-col gap-3",children:v.map((I,E)=>p.jsxs("div",{className:"border border-sage/40 rounded-xl p-3 bg-sage/5",children:[p.jsx("p",{className:"text-paper text-sm font-semibold mb-1",children:I.question}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:I.answer||"-"})]},I.id??E))})]}),(e==null?void 0:e.groupSummary)&&p.jsxs("div",{className:"mb-5 border border-sage/40 rounded-xl p-3 bg-sage/5",children:[p.jsx("p",{className:"text-xs text-sage mb-1",children:"코디네이터와 나눌 내용 정리"}),p.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:e.groupSummary})]}),p.jsxs("div",{className:"mb-5",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"피드백 코멘트"}),p.jsx("textarea",{value:o,onChange:I=>l(I.target.value),onBlur:N,rows:4,placeholder:"피드백이나 격려를 남겨주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]}),p.jsx("button",{onClick:C,disabled:u,className:`w-full font-semibold py-4 rounded-2xl transition-colors disabled:opacity-60 ${e!=null&&e.checked?"bg-transparent border border-sage text-sage":"bg-sage text-nightDeep"}`,children:u?"처리 중...":e!=null&&e.checked?"확인 취소하기":"확인했어요 🐇"})]}):p.jsx("div",{className:"text-center text-faint py-16",children:p.jsx("p",{children:"아직 작성되지 않았어요."})})]})}function XN({role:t}){const[e,n]=W.useState(t==="writer"?{time:"23:00"}:{mode:"off",time:"21:00",intervalDays:3}),[r,i]=W.useState("idle"),[s,o]=W.useState(!1);W.useEffect(()=>{const h=ar(Qt,"settings",t);gC(h).then(f=>{f.exists()&&n(y=>({...y,...f.data()}))})},[t]);const l=async()=>{await go(ar(Qt,"settings",t),e,{merge:!0}),o(!0),setTimeout(()=>o(!1),1500)},u=async()=>{var h;try{if(await Notification.requestPermission()!=="granted"){i("denied");return}const y=await qN();if(!y){i("unsupported");return}const v=await navigator.serviceWorker.ready,k=await BN(y,{vapidKey:$N,serviceWorkerRegistration:v});k&&(await go(ar(Qt,"fcm_tokens",t),{token:k,updatedAt:Date.now(),uid:((h=Hh.currentUser)==null?void 0:h.uid)??null},{merge:!0}),i("granted"))}catch(f){console.error("알림 등록 실패",f),i("unsupported")}};return p.jsxs("div",{className:"px-5 pb-10",children:[p.jsx("h2",{className:"font-display text-lg mb-6",children:"알림 설정"}),p.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 mb-6",children:[p.jsx("p",{className:"text-sm text-faint mb-3",children:"이 기기로 알림을 받으려면 먼저 푸시 권한을 허용해 주세요. (아이폰은 홈 화면에 추가한 뒤에만 동작해요)"}),p.jsx("button",{onClick:u,className:"w-full bg-lamp text-nightDeep font-semibold py-3 rounded-xl",children:r==="granted"?"알림 켜짐 ✓":"이 기기에서 알림 받기"}),r==="denied"&&p.jsx("p",{className:"text-xs text-red-300 mt-2",children:"알림이 거부되어 있어요. 기기 설정에서 허용해 주세요."}),r==="unsupported"&&p.jsx("p",{className:"text-xs text-red-300 mt-2",children:"이 브라우저/상태에서는 푸시가 지원되지 않아요. 홈 화면에 추가한 뒤 다시 시도해 주세요."})]}),t==="writer"?p.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"매일 알림 시간"}),p.jsx("input",{type:"time",value:e.time,onChange:h=>n({...e,time:h.target.value}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"}),p.jsx("p",{className:"text-xs text-faint mt-3",children:"작성자는 매일 같은 시간에 알림을 받아요."})]}):p.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 flex flex-col gap-4",children:[p.jsxs("div",{children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"알림 방식"}),p.jsx("div",{className:"flex gap-2",children:[{v:"off",label:"안 함"},{v:"daily",label:"매일"},{v:"interval",label:"N일마다"}].map(h=>p.jsx("button",{onClick:()=>n({...e,mode:h.v}),className:`flex-1 py-2 rounded-xl text-sm border ${e.mode===h.v?"bg-sage text-nightDeep border-sage":"border-faint/40 text-faint"}`,children:h.label},h.v))})]}),e.mode!=="off"&&p.jsxs("div",{children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"시간"}),p.jsx("input",{type:"time",value:e.time,onChange:h=>n({...e,time:h.target.value}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"})]}),e.mode==="interval"&&p.jsxs("div",{children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"며칠마다"}),p.jsx("input",{type:"number",min:1,max:30,value:e.intervalDays,onChange:h=>n({...e,intervalDays:Number(h.target.value)}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper w-24"}),p.jsx("span",{className:"text-faint text-sm ml-2",children:"일마다"})]})]}),p.jsx("button",{onClick:l,className:"w-full mt-6 bg-transparent border border-lamp text-lamp font-semibold py-3 rounded-xl",children:s?"저장됨":"설정 저장"})]})}function JN(t){var r;let e=0;const n=new Date;for(;;){const i=Nl(n);if((r=t[i])!=null&&r.content)e+=1,n.setDate(n.getDate()-1);else break}return e}function ZN(t){var u,h;const e=new Date,n=e.getFullYear(),r=e.getMonth(),i=new Date(n,r+1,0).getDate(),s=e.getDate();let o=0,l=0;for(let f=1;f<=s;f++){const y=`${n}-${String(r+1).padStart(2,"0")}-${String(f).padStart(2,"0")}`;(u=t[y])!=null&&u.content&&(o+=1),(h=t[y])!=null&&h.checked&&(l+=1)}return{written:o,checked:l,total:i,soFar:s}}function eb({entries:t}){const e=JN(t),{written:n,checked:r,soFar:i}=ZN(t);return p.jsxs("div",{className:"px-5 pt-6 pb-10",children:[p.jsx("h2",{className:"font-display text-lg mb-6",children:"타고 있는 등불"}),p.jsxs("div",{className:"border border-faint/40 rounded-2xl p-6 mb-4 text-center",children:[p.jsx("p",{className:"text-5xl font-display text-lamp",children:e}),p.jsx("p",{className:"text-faint text-sm mt-1",children:"일째 연속 작성 중"})]}),p.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[p.jsx(Ey,{label:"이번 달 작성",value:`${n} / ${i}일`}),p.jsx(Ey,{label:"이번 달 확인",value:`${r} / ${i}일`})]})]})}function Ey({label:t,value:e}){return p.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 text-center",children:[p.jsx("p",{className:"text-paper text-lg font-display",children:e}),p.jsx("p",{className:"text-faint text-xs mt-1",children:t})]})}function tb(){return Math.random().toString(36).slice(2,9)}function Kt(){return{title:"",body:"",reflectionQuestions:[""]}}function nb(){return{title:"",startDate:"",days:[Kt(),Kt(),Kt(),Kt(),Kt()],groupQuestions:[""]}}function rb({onClose:t}){const{units:e,saveUnit:n,deleteUnit:r}=CE(),[i,s]=W.useState(null),[o,l]=W.useState(null),[u,h]=W.useState(!1),[f,y]=W.useState(null),v=W.useRef(),k=async C=>{var O;const N=(O=C.target.files)==null?void 0:O[0];if(N){h(!0),y(null);try{const I=await N.text(),E=JSON.parse(I),x=Array.isArray(E)?E:[E];for(const b of x){if(!b.id||!b.title||!b.startDate||!Array.isArray(b.days))throw new Error(`필수 필드(id, title, startDate, days) 누락: ${b.title||"?"}`);await n(b.id,{title:b.title,startDate:b.startDate,days:b.days,groupQuestions:b.groupQuestions??[]})}y({ok:!0,text:`${x.length}개 단원을 가져왔어요 ✓`})}catch(I){y({ok:!1,text:`오류: ${I.message}`})}finally{h(!1),C.target.value=""}}};return i?p.jsx(sb,{unit:i,onCancel:()=>s(null),onSaved:()=>s(null),saveUnit:n}):p.jsxs("div",{className:"px-5 pb-10",children:[p.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[p.jsx("button",{onClick:t,className:"text-faint",children:"‹ 닫기"}),p.jsx("h2",{className:"font-display text-base",children:"본문 관리"}),p.jsx("div",{className:"w-10"})]}),p.jsx("button",{onClick:()=>s({...nb(),id:"unit_"+tb()}),className:"w-full bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow mb-3",children:"+ 새 단원 추가"}),p.jsx("button",{onClick:()=>{var C;return(C=v.current)==null?void 0:C.click()},disabled:u,className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-2 disabled:opacity-60",children:u?"가져오는 중...":"📂 JSON으로 단원 가져오기"}),p.jsx("input",{ref:v,type:"file",accept:".json",className:"hidden",onChange:k}),f&&p.jsx("p",{className:`text-sm text-center mb-4 ${f.ok?"text-lamp":"text-red-400"}`,children:f.text}),e.length===0&&p.jsx("p",{className:"text-faint text-sm text-center py-8",children:"등록된 단원이 없어요."}),p.jsx("div",{className:"flex flex-col gap-3 mt-3",children:e.map(C=>p.jsxs("div",{className:"border border-faint/30 rounded-xl p-4",children:[p.jsx("p",{className:"text-paper font-semibold mb-1",children:C.title||"(제목 없음)"}),p.jsxs("p",{className:"text-faint text-xs mb-3",children:["시작일(월요일): ",C.startDate]}),p.jsxs("div",{className:"flex gap-2",children:[p.jsx("button",{onClick:()=>s(C),className:"flex-1 border border-lamp text-lamp text-sm py-2 rounded-xl",children:"수정"}),o===C.id?p.jsx("button",{onClick:async()=>{await r(C.id),l(null)},className:"flex-1 bg-red-400/80 text-nightDeep text-sm py-2 rounded-xl font-semibold",children:"정말 삭제"}):p.jsx("button",{onClick:()=>l(C.id),className:"flex-1 border border-faint text-faint text-sm py-2 rounded-xl",children:"삭제"})]})]},C.id))})]})}const ib=["월요일","화요일","수요일","목요일","금요일"];function sb({unit:t,onCancel:e,onSaved:n,saveUnit:r}){var j;const[i,s]=W.useState(t.title||""),[o,l]=W.useState(t.startDate||""),[u,h]=W.useState(t.days&&t.days.length===5?t.days.map(_=>{var m;return{title:_.title||"",body:_.body||"",reflectionQuestions:(m=_.reflectionQuestions)!=null&&m.length?_.reflectionQuestions:[""]}}):[Kt(),Kt(),Kt(),Kt(),Kt()]),[f,y]=W.useState((j=t.groupQuestions)!=null&&j.length?t.groupQuestions:[""]),[v,k]=W.useState(!1),C=(_,m,w)=>{h(T=>T.map((A,R)=>R===_?{...A,[m]:w}:A))},N=(_,m,w)=>{h(T=>T.map((A,R)=>{if(R!==_)return A;const S=[...A.reflectionQuestions];return S[m]=w,{...A,reflectionQuestions:S}}))},O=_=>{h(m=>m.map((w,T)=>T===_?{...w,reflectionQuestions:[...w.reflectionQuestions,""]}:w))},I=(_,m)=>{h(w=>w.map((T,A)=>A!==_||T.reflectionQuestions.length<=1?T:{...T,reflectionQuestions:T.reflectionQuestions.filter((R,S)=>S!==m)}))},E=(_,m)=>{y(w=>w.map((T,A)=>A===_?m:T))},x=()=>y(_=>[..._,""]),b=_=>{y(m=>m.length>1?m.filter((w,T)=>T!==_):m)},F=async()=>{if(!i.trim()||!o){alert("단원 제목과 시작일(월요일)을 입력해 주세요.");return}k(!0);const _={title:i.trim(),startDate:o,days:u.map(m=>({title:m.title.trim(),body:m.body,reflectionQuestions:m.reflectionQuestions.map(w=>w.trim()).filter(Boolean)})),groupQuestions:f.map(m=>m.trim()).filter(Boolean)};await r(t.id,_),k(!1),n()};return p.jsxs("div",{className:"px-5 pb-10",children:[p.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[p.jsx("button",{onClick:e,className:"text-faint",children:"‹ 취소"}),p.jsx("h2",{className:"font-display text-base",children:"단원 편집"}),p.jsx("div",{className:"w-10"})]}),p.jsx(Ia,{label:"단원 제목",children:p.jsx("input",{value:i,onChange:_=>s(_.target.value),placeholder:"예) 2단원 ○○○",className:"w-full bg-transparent border-b border-faint pb-2 text-paper placeholder:text-faint/60 focus:outline-none focus:border-lamp"})}),p.jsx(Ia,{label:"시작일 (이 단원의 월요일)",children:p.jsx("input",{type:"date",value:o,onChange:_=>l(_.target.value),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"})}),u.map((_,m)=>p.jsxs("div",{className:"mb-6 border border-faint/30 rounded-xl p-4",children:[p.jsxs("p",{className:"text-lamp text-sm font-semibold mb-3",children:[ib[m]," 본문"]}),p.jsx(Ia,{label:"본문 제목",children:p.jsx("input",{value:_.title,onChange:w=>C(m,"title",w.target.value),placeholder:"예) 01. 예수가 모르는 크리스천",className:"w-full bg-transparent border-b border-faint/50 pb-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp"})}),p.jsx(Ia,{label:"본문 내용",children:p.jsx("textarea",{value:_.body,onChange:w=>C(m,"body",w.target.value),rows:8,placeholder:"본문 전체 텍스트를 붙여넣으세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"})}),p.jsxs("div",{className:"mb-2",children:[p.jsxs("div",{className:"flex items-center justify-between mb-2",children:[p.jsx("p",{className:"text-xs text-lampSoft",children:"묵상 질문"}),p.jsx("button",{onClick:()=>O(m),type:"button",className:"text-xs text-lamp border border-lamp/50 rounded-lg px-2 py-1",children:"+ 질문 추가"})]}),p.jsx("div",{className:"flex flex-col gap-2",children:_.reflectionQuestions.map((w,T)=>p.jsxs("div",{className:"flex gap-2 items-start",children:[p.jsx("textarea",{value:w,onChange:A=>N(m,T,A.target.value),rows:2,placeholder:`묵상질문 ${T+1}`,className:"flex-1 bg-night/40 border border-faint/40 rounded-xl p-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"}),_.reflectionQuestions.length>1&&p.jsx("button",{onClick:()=>I(m,T),type:"button",className:"text-xs text-faint underline mt-2",children:"삭제"})]},T))})]})]},m)),p.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl p-4 bg-sage/5",children:[p.jsxs("div",{className:"flex items-center justify-between mb-3",children:[p.jsx("p",{className:"text-sage text-sm font-semibold",children:"코디네이터(소그룹)와 나눔 질문"}),p.jsx("button",{onClick:x,type:"button",className:"text-xs text-sage border border-sage/50 rounded-lg px-2 py-1",children:"+ 질문 추가"})]}),p.jsx("div",{className:"flex flex-col gap-2",children:f.map((_,m)=>p.jsxs("div",{className:"flex gap-2 items-start",children:[p.jsx("textarea",{value:_,onChange:w=>E(m,w.target.value),rows:2,placeholder:`나눔 질문 ${m+1}`,className:"flex-1 bg-night/40 border border-faint/40 rounded-xl p-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"}),f.length>1&&p.jsx("button",{onClick:()=>b(m),type:"button",className:"text-xs text-faint underline mt-2",children:"삭제"})]},m))})]}),p.jsx("button",{onClick:F,disabled:v,className:"w-full bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:v?"저장 중...":"단원 저장하기"})]})}function Ia({label:t,children:e}){return p.jsxs("div",{className:"mb-4",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-2",children:t}),e]})}const ob=[{version:"v1.3",date:"2026-07-04",items:["토요일 코디네이터 나눔 화면 추가","홈 화면 신설 — 캘린더·오늘·등불·설정 바로가기","THE PLAN 클릭 시 홈으로 이동","2단원 말씀의 능력 본문 등록"]},{version:"v1.2",date:"2026-06-22",items:["JSON으로 단원 가져오기 기능 추가","본문 구조 sections 배열 방식으로 개선","묵상 질문 위치 원문 그대로 유지"]},{version:"v1.1",date:"2026-06-10",items:["코디네이터 나눔 필드 토요일에만 표시","단원 관리(UnitManager) 화면 추가","알림 설정 기능 추가"]},{version:"v1.0",date:"2026-06-01",items:["더플랜 앱 최초 출시","캘린더·오늘·등불·설정 탭 구성","1단원 본문 탑재","Firebase 연동 및 코디네이터 확인 기능"]}];function ab(){return p.jsxs("div",{className:"mt-6",children:[p.jsx("p",{className:"text-xs text-lampSoft mb-4 tracking-widest",children:"업데이트 내역"}),p.jsx("div",{className:"flex flex-col gap-4",children:ob.map((t,e)=>p.jsxs("div",{className:`border rounded-2xl p-4 ${e===0?"border-lamp/40 bg-lamp/5":"border-faint/20 bg-night/30"}`,children:[p.jsxs("div",{className:"flex items-center justify-between mb-3",children:[p.jsxs("div",{className:"flex items-center gap-2",children:[p.jsx("span",{className:`text-sm font-semibold font-display ${e===0?"text-lamp":"text-faint"}`,children:t.version}),e===0&&p.jsx("span",{className:"text-xs bg-lamp text-nightDeep px-2 py-0.5 rounded-full font-semibold",children:"최신"})]}),p.jsx("span",{className:"text-xs text-faint/60",children:t.date})]}),p.jsx("ul",{className:"flex flex-col gap-1.5",children:t.items.map((n,r)=>p.jsxs("li",{className:"flex items-start gap-2",children:[p.jsx("span",{className:`mt-1 text-xs ${e===0?"text-lamp":"text-faint/40"}`,children:"·"}),p.jsx("span",{className:`text-sm leading-relaxed ${e===0?"text-paper":"text-faint/70"}`,children:n})]},r))})]},t.version))})]})}const lb=[{id:"unit1",title:"1단원 일상의 믿음",startDate:"2026-06-22",days:[{title:"01. 예수가 모르는 크리스천",sections:[{body:`"그 때에 천국은 마치 등을 들고 신랑을 맞으러 나간 열 처녀와 같다 하리니"(마25:1)
...
수도자의 열심 단계에서 우리가 추구할 수련은 기도와 말씀에 집중하지만 이같은 삶이 일상이 되도록 이끄는데 있습니다.`,question:"이제 본격적으로 기도와 말씀을 훈련할텐데 어떤 다짐을 갖고 있는지 적어보십시오."}]}],groupQuestions:["만일 주님이 오늘 이 땅에 오셔서 나를 만난다면 알아보시며 반가워하실 것 같습니까?","'전에 하던 대로' 다니엘의 신앙을 볼 때 나의 일상, 늘 하는 것은 어떤 모습입니까? 나의 일상 생활 중 24시간 예수님이 곁에 있다고 생각하고 자신의 삶을 평가해보십시오.","한 주간동안 공부하면 하나님을 '아버지'라고 몇 번이나 부르신 것 같습니까?","나에게 성경 말씀은 무엇입니까? 매일 먹는 밥입니까? 지난 한 주간 몇 일이나 큐티를 하셨습니까?","이 훈련을 시작하면서 새롭게 다짐하게 된 기도와 말씀의 루틴이 있다면 적어보십시오."]}],Ty="qt_role",Iy="qt_install_seen";function ub({onTabSelect:t,onTodaySelect:e}){return p.jsxs("div",{className:"flex flex-col min-h-[calc(100vh-6rem)] px-5",children:[p.jsxs("div",{className:"mt-4 mb-6 flex flex-col md:flex-row md:items-stretch gap-4",children:[p.jsxs("div",{className:"rounded-2xl overflow-hidden border border-lamp/20 md:flex-1",style:{position:"relative",height:"52vw",maxHeight:"320px",minHeight:"160px",background:"linear-gradient(135deg, #1a1f35 0%, #0d1526 50%, #101828 100%)"},children:[p.jsx("img",{src:"./home-image.jpeg",alt:"더플랜",style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center center",opacity:.85},onError:n=>{n.target.style.display="none"}}),p.jsxs("div",{className:"md:hidden absolute bottom-3 left-0 right-0 text-center",children:[p.jsx("p",{className:"font-display text-lampSoft text-base drop-shadow",children:"말씀과 함께하는 하루"}),p.jsx("p",{className:"text-faint/80 text-xs tracking-wider",children:"· THE PLAN ·"})]})]}),p.jsxs("div",{className:"md:flex-1 flex flex-col justify-between gap-3",children:[p.jsxs("div",{className:"hidden md:block text-center py-2",children:[p.jsx("p",{className:"font-display text-lampSoft text-lg mb-0.5",children:"말씀과 함께하는 하루"}),p.jsx("p",{className:"text-faint text-xs tracking-wider",children:"· THE PLAN ·"})]}),p.jsxs("div",{className:"grid grid-cols-2 gap-3 md:flex-1",children:[p.jsxs("button",{onClick:()=>t("calendar"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[p.jsx("span",{className:"text-2xl",children:"📅"}),p.jsx("span",{className:"text-lamp font-semibold text-sm",children:"캘린더"}),p.jsx("span",{className:"text-faint text-xs",children:"기록 보기"})]}),p.jsxs("button",{onClick:e,className:"flex flex-col items-center justify-center gap-1.5 border border-lamp rounded-2xl py-5 bg-lamp/10 shadow-glow active:bg-lamp/20",children:[p.jsx("span",{className:"text-2xl",children:"✍️"}),p.jsx("span",{className:"text-lamp font-semibold text-sm",children:"오늘"}),p.jsx("span",{className:"text-faint text-xs",children:"오늘 큐티 작성"})]}),p.jsxs("button",{onClick:()=>t("stats"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[p.jsx("span",{className:"text-2xl",children:"🕯️"}),p.jsx("span",{className:"text-lamp font-semibold text-sm",children:"등불"}),p.jsx("span",{className:"text-faint text-xs",children:"연속 기록"})]}),p.jsxs("button",{onClick:()=>t("settings"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[p.jsx("span",{className:"text-2xl",children:"⚙️"}),p.jsx("span",{className:"text-lamp font-semibold text-sm",children:"설정"}),p.jsx("span",{className:"text-faint text-xs",children:"알림·단원 관리"})]})]})]})]}),p.jsx(ab,{}),p.jsx("div",{className:"h-8"})]})}function cb(){const[t,e]=W.useState(()=>localStorage.getItem(Ty)),[n,r]=W.useState(()=>localStorage.getItem(Iy)==="1"),[i,s]=W.useState("home"),[o,l]=W.useState(null),[u,h]=W.useState(!1),[f,y]=W.useState(!1),{entries:v,saveEntry:k,setCheck:C,deleteEntry:N}=WN(),{units:O}=CE(),I=[...lb,...O];W.useEffect(()=>{HN(()=>y(!0))},[]);const E=_=>{localStorage.setItem(Ty,_),e(_)},x=()=>{localStorage.setItem(Iy,"1"),r(!0)},b=()=>{l(null),h(!1),s("home")},F=_=>{l(null),h(!1),s(_)},j=()=>{h(!1),l(Nl()),s("calendar")};return t?n?f?p.jsxs("div",{className:"min-h-screen pb-24",children:[p.jsxs("div",{className:"px-5 pt-6 flex items-center justify-between",children:[p.jsx("button",{onClick:b,className:"font-display text-lampSoft text-sm tracking-widest",children:"THE PLAN"}),p.jsx("span",{className:"text-xs text-faint",children:t==="writer"?"작성자":"코디네이터"})]}),u?p.jsx(rb,{onClose:()=>h(!1)}):o?t==="writer"?p.jsx(GN,{dateKey:o,entry:v[o],units:I,onSave:k,onDelete:N,onClose:()=>l(null)}):p.jsx(YN,{dateKey:o,entry:v[o],units:I,onCheck:C,onClose:()=>l(null)}):p.jsxs(p.Fragment,{children:[i==="home"&&p.jsx(ub,{onTabSelect:F,onTodaySelect:j}),i==="calendar"&&p.jsx(QN,{entries:v,onSelectDate:l}),i==="stats"&&p.jsx(eb,{entries:v}),i==="settings"&&p.jsxs("div",{className:"px-5 pb-6",children:[p.jsx("button",{onClick:()=>h(!0),className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-6",children:"📖 본문 관리 (단원 추가/수정)"}),p.jsx(XN,{role:t})]})]}),p.jsxs("div",{className:"fixed bottom-0 left-0 right-0 bg-nightDeep border-t border-faint/20 flex",children:[p.jsx("button",{onClick:()=>F("home"),className:`flex-1 py-4 text-sm ${i==="home"&&!o&&!u?"text-lamp":"text-faint"}`,children:"홈"}),p.jsx("button",{onClick:()=>F("calendar"),className:`flex-1 py-4 text-sm ${i==="calendar"&&!o?"text-lamp":"text-faint"}`,children:"캘린더"}),p.jsx("button",{onClick:j,className:`flex-1 py-4 text-sm ${o===Nl()?"text-lamp":"text-faint"}`,children:"오늘"}),p.jsx("button",{onClick:()=>F("stats"),className:`flex-1 py-4 text-sm ${i==="stats"&&!o?"text-lamp":"text-faint"}`,children:"등불"}),p.jsx("button",{onClick:()=>F("settings"),className:`flex-1 py-4 text-sm ${i==="settings"&&!o?"text-lamp":"text-faint"}`,children:"설정"})]})]}):p.jsx("div",{className:"min-h-screen flex items-center justify-center text-faint",children:p.jsx("p",{children:"연결 중..."})}):p.jsx(jS,{onDone:x}):p.jsx(LS,{onSelect:E})}kc.createRoot(document.getElementById("root")).render(p.jsx(IT.StrictMode,{children:p.jsx(cb,{})}));
