    ...
    <div className="flex flex-col min-h-[calc(100vh-6rem)] px-5">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button
          ...
          className="flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10"
        >
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1.5 border border-lamp rounded-2xl py-5 bg-lamp/10 shadow-glow active:bg-lamp/20"
        >
    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-nightDeep border-t border-faint/20 flex">
        <button
          ...
          className={`flex-1 py-4 text-sm ${tab === 'home' && !selectedDate && !showUnitManager ? 'text-lamp' : 'text-faint'}`}
        >
          홈
        </button>
        <button
