 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,K){var X=B.length;B.push(K);e:for(;0<X;){var ve=X-1>>>1,ce=B[ve];if(0<i(ce,K))B[ve]=K,B[X]=ce,X=ve;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var K=B[0],X=B.pop();if(X!==K){B[0]=X;e:for(var ve=0,ce=B.length,xe=ce>>>1;ve<xe;){var on=2*(ve+1)-1,an=B[on],ln=on+1,un=B[ln];if(0>i(an,X))ln<ce&&0>i(un,an)?(B[ve]=un,B[ln]=X,ve=ln):(B[ve]=an,B[on]=X,ve=on);else if(ln<ce&&0>i(un,X))B[ve]=un,B[ln]=X,ve=ln;else break e}}return K}function i(B,K){var X=B.sortIndex-K.sortIndex;return X!==0?X:B.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,y=null,v=3,k=!1,R=!1,P=!1,O=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,E=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(B){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=B)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function b(B){if(P=!1,A(B),!R)if(n(u)!==null)R=!0,be(F);else{var K=n(h);K!==null&&Ce(b,K.startTime-B)}}function F(B,K){R=!1,P&&(P=!1,I(p),p=-1),k=!0;var X=v;try{for(A(K),y=n(u);y!==null&&(!(y.expirationTime>K)||B&&!x());){var ve=y.callback;if(typeof ve=="function"){y.callback=null,v=y.priorityLevel;var ce=ve(y.expirationTime<=K);K=t.unstable_now(),typeof ce=="function"?y.callback=ce:y===n(u)&&r(u),A(K)}else r(u);y=n(u)}if(y!==null)var xe=!0;else{var on=n(h);on!==null&&Ce(b,on.startTime-K),xe=!1}return xe}finally{y=null,v=X,k=!1}}var M=!1,_=null,p=-1,w=5,T=-1;function x(){return!(t.unstable_now()-T<w)}function C(){if(_!==null){var B=t.unstable_now();T=B;var K=!0;try{K=_(!0,B)}finally{K?S():(M=!1,_=null)}}else M=!1}var S;if(typeof E=="function")S=function(){E(C)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,se=Y.port2;Y.port1.onmessage=C,S=function(){se.postMessage(null)}}else S=function(){O(C,0)};function be(B){_=B,M||(M=!0,S())}function Ce(B,K){p=O(function(){B(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){R||k||(R=!0,be(F))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return v},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(v){case 1:case 2:case 3:var K=3;break;default:K=v}var X=v;v=K;try{return B()}finally{v=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,K){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var X=v;v=B;try{return K()}finally{v=X}},t.unstable_scheduleCallback=function(B,K,X){var ve=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?ve+X:ve):X=ve,B){case 1:var ce=-1;break;case 2:ce=250;break;case 5:ce=1073741823;break;case 4:ce=1e4;break;default:ce=5e3}return ce=X+ce,B={id:f++,callback:K,priorityLevel:B,startTime:X,expirationTime:ce,sortIndex:-1},X>ve?(B.sortIndex=X,e(h,B),n(u)===null&&B===n(h)&&(P?(I(p),p=-1):P=!0,Ce(b,X-ve))):(B.sortIndex=ce,e(u,B),R||k||(R=!0,be(F))),B},t.unstable_shouldYield=x,t.unstable_wrapCallback=function(B){var K=v;return function(){var X=v;v=K;try{return B.apply(this,arguments)}finally{v=X}}}})(My);Ly.exports=My;var PT=Ly.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new Ud("@firebase/app"),Px="@firebase/app-compat",Nx="@firebase/analytics-compat",bx="@firebase/analytics",Dx="@firebase/app-check-compat",Ox="@firebase/app-check",Vx="@firebase/auth",Lx="@firebase/auth-compat",Mx="@firebase/database",jx="@firebase/data-connect",Fx="@firebase/database-compat",Ux="@firebase/functions",Bx="@firebase/functions-compat",zx="@firebase/installations",$x="@firebase/installations-compat",qx="@firebase/messaging",Hx="@firebase/messaging-compat",Wx="@firebase/performance",Kx="@firebase/performance-compat",Qx="@firebase/remote-config",Gx="@firebase/remote-config-compat",Yx="@firebase/storage",Xx="@firebase/storage-compat",Jx="@firebase/firestore",Zx="@firebase/vertexai-preview",eA="@firebase/firestore-compat",tA="firebase",nA="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aA="firebase-heartbeat-database",lA=1,ao="firebase-heartbeat-store";let pc=null;function K_(){return pc||(pc=Gl(aA,lA,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ao)}catch(n){console.warn(n)}}}}).catch(t=>{throw ir.create("idb-open",{originalErrorMessage:t.message})})),pc}async function uA(t){try{const n=(await K_()).transaction(ao),r=await n.objectStore(ao).get(Q_(t));return await n.done,r}catch(e){if(e instanceof sn)Cn.warn(e.message);else{const n=ir.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Cn.warn(n.message)}}}async function rg(t,e){try{const r=(await K_()).transaction(ao,"readwrite");await r.objectStore(ao).put(e,Q_(t)),await r.done}catch(n){if(n instanceof sn)Cn.warn(n.message);else{const r=ir.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Cn.warn(r.message)}}}function Q_(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var br,G_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,p){function w(){}w.prototype=p.prototype,_.D=p.prototype,_.prototype=new w,_.prototype.constructor=_,_.C=function(T,x,C){for(var S=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)S[Y-2]=arguments[Y];return p.prototype[x].apply(T,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(_,p,w){w||(w=0);var T=Array(16);if(typeof p=="string")for(var x=0;16>x;++x)T[x]=p.charCodeAt(w++)|p.charCodeAt(w++)<<8|p.charCodeAt(w++)<<16|p.charCodeAt(w++)<<24;else for(x=0;16>x;++x)T[x]=p[w++]|p[w++]<<8|p[w++]<<16|p[w++]<<24;p=_.g[0],w=_.g[1],x=_.g[2];var C=_.g[3],S=p+(C^w&(x^C))+T[0]+3614090360&4294967295;p=w+(S<<7&4294967295|S>>>25),S=C+(x^p&(w^x))+T[1]+3905402710&4294967295,C=p+(S<<12&4294967295|S>>>20),S=x+(w^C&(p^w))+T[2]+606105819&4294967295,x=C+(S<<17&4294967295|S>>>15),S=w+(p^x&(C^p))+T[3]+3250441966&4294967295,w=x+(S<<22&4294967295|S>>>10),S=p+(C^w&(x^C))+T[4]+4118548399&4294967295,p=w+(S<<7&4294967295|S>>>25),S=C+(x^p&(w^x))+T[5]+1200080426&4294967295,C=p+(S<<12&4294967295|S>>>20),S=x+(w^C&(p^w))+T[6]+2821735955&4294967295,x=C+(S<<17&4294967295|S>>>15),S=w+(p^x&(C^p))+T[7]+4249261313&4294967295,w=x+(S<<22&4294967295|S>>>10),S=p+(C^w&(x^C))+T[8]+1770035416&4294967295,p=w+(S<<7&4294967295|S>>>25),S=C+(x^p&(w^x))+T[9]+2336552879&4294967295,C=p+(S<<12&4294967295|S>>>20),S=x+(w^C&(p^w))+T[10]+4294925233&4294967295,x=C+(S<<17&4294967295|S>>>15),S=w+(p^x&(C^p))+T[11]+2304563134&4294967295,w=x+(S<<22&4294967295|S>>>10),S=p+(C^w&(x^C))+T[12]+1804603682&4294967295,p=w+(S<<7&4294967295|S>>>25),S=C+(x^p&(w^x))+T[13]+4254626195&4294967295,C=p+(S<<12&4294967295|S>>>20),S=x+(w^C&(p^w))+T[14]+2792965006&4294967295,x=C+(S<<17&4294967295|S>>>15),S=w+(p^x&(C^p))+T[15]+1236535329&4294967295,w=x+(S<<22&4294967295|S>>>10),S=p+(x^C&(w^x))+T[1]+4129170786&4294967295,p=w+(S<<5&4294967295|S>>>27),S=C+(w^x&(p^w))+T[6]+3225465664&4294967295,C=p+(S<<9&4294967295|S>>>23),S=x+(p^w&(C^p))+T[11]+643717713&4294967295,x=C+(S<<14&4294967295|S>>>18),S=w+(C^p&(x^C))+T[0]+3921069994&4294967295,w=x+(S<<20&4294967295|S>>>12),S=p+(x^C&(w^x))+T[5]+3593408605&4294967295,p=w+(S<<5&4294967295|S>>>27),S=C+(w^x&(p^w))+T[10]+38016083&4294967295,C=p+(S<<9&4294967295|S>>>23),S=x+(p^w&(C^p))+T[15]+3634488961&4294967295,x=C+(S<<14&4294967295|S>>>18),S=w+(C^p&(x^C))+T[4]+3889429448&4294967295,w=x+(S<<20&4294967295|S>>>12),S=p+(x^C&(w^x))+T[9]+568446438&4294967295,p=w+(S<<5&4294967295|S>>>27),S=C+(w^x&(p^w))+T[14]+3275163606&4294967295,C=p+(S<<9&4294967295|S>>>23),S=x+(p^w&(C^p))+T[3]+4107603335&4294967295,x=C+(S<<14&4294967295|S>>>18),S=w+(C^p&(x^C))+T[8]+1163531501&4294967295,w=x+(S<<20&4294967295|S>>>12),S=p+(x^C&(w^x))+T[13]+2850285829&4294967295,p=w+(S<<5&4294967295|S>>>27),S=C+(w^x&(p^w))+T[2]+4243563512&4294967295,C=p+(S<<9&4294967295|S>>>23),S=x+(p^w&(C^p))+T[7]+1735328473&4294967295,x=C+(S<<14&4294967295|S>>>18),S=w+(C^p&(x^C))+T[12]+2368359562&4294967295,w=x+(S<<20&4294967295|S>>>12),S=p+(w^x^C)+T[5]+4294588738&4294967295,p=w+(S<<4&4294967295|S>>>28),S=C+(p^w^x)+T[8]+2272392833&4294967295,C=p+(S<<11&4294967295|S>>>21),S=x+(C^p^w)+T[11]+1839030562&4294967295,x=C+(S<<16&4294967295|S>>>16),S=w+(x^C^p)+T[14]+4259657740&4294967295,w=x+(S<<23&4294967295|S>>>9),S=p+(w^x^C)+T[1]+2763975236&4294967295,p=w+(S<<4&4294967295|S>>>28),S=C+(p^w^x)+T[4]+1272893353&4294967295,C=p+(S<<11&4294967295|S>>>21),S=x+(C^p^w)+T[7]+4139469664&4294967295,x=C+(S<<16&4294967295|S>>>16),S=w+(x^C^p)+T[10]+3200236656&4294967295,w=x+(S<<23&4294967295|S>>>9),S=p+(w^x^C)+T[13]+681279174&4294967295,p=w+(S<<4&4294967295|S>>>28),S=C+(p^w^x)+T[0]+3936430074&4294967295,C=p+(S<<11&4294967295|S>>>21),S=x+(C^p^w)+T[3]+3572445317&4294967295,x=C+(S<<16&4294967295|S>>>16),S=w+(x^C^p)+T[6]+76029189&4294967295,w=x+(S<<23&4294967295|S>>>9),S=p+(w^x^C)+T[9]+3654602809&4294967295,p=w+(S<<4&4294967295|S>>>28),S=C+(p^w^x)+T[12]+3873151461&4294967295,C=p+(S<<11&4294967295|S>>>21),S=x+(C^p^w)+T[15]+530742520&4294967295,x=C+(S<<16&4294967295|S>>>16),S=w+(x^C^p)+T[2]+3299628645&4294967295,w=x+(S<<23&4294967295|S>>>9),S=p+(x^(w|~C))+T[0]+4096336452&4294967295,p=w+(S<<6&4294967295|S>>>26),S=C+(w^(p|~x))+T[7]+1126891415&4294967295,C=p+(S<<10&4294967295|S>>>22),S=x+(p^(C|~w))+T[14]+2878612391&4294967295,x=C+(S<<15&4294967295|S>>>17),S=w+(C^(x|~p))+T[5]+4237533241&4294967295,w=x+(S<<21&4294967295|S>>>11),S=p+(x^(w|~C))+T[12]+1700485571&4294967295,p=w+(S<<6&4294967295|S>>>26),S=C+(w^(p|~x))+T[3]+2399980690&4294967295,C=p+(S<<10&4294967295|S>>>22),S=x+(p^(C|~w))+T[10]+4293915773&4294967295,x=C+(S<<15&4294967295|S>>>17),S=w+(C^(x|~p))+T[1]+2240044497&4294967295,w=x+(S<<21&4294967295|S>>>11),S=p+(x^(w|~C))+T[8]+1873313359&4294967295,p=w+(S<<6&4294967295|S>>>26),S=C+(w^(p|~x))+T[15]+4264355552&4294967295,C=p+(S<<10&4294967295|S>>>22),S=x+(p^(C|~w))+T[6]+2734768916&4294967295,x=C+(S<<15&4294967295|S>>>17),S=w+(C^(x|~p))+T[13]+1309151649&4294967295,w=x+(S<<21&4294967295|S>>>11),S=p+(x^(w|~C))+T[4]+4149444226&4294967295,p=w+(S<<6&4294967295|S>>>26),S=C+(w^(p|~x))+T[11]+3174756917&4294967295,C=p+(S<<10&4294967295|S>>>22),S=x+(p^(C|~w))+T[2]+718787259&4294967295,x=C+(S<<15&4294967295|S>>>17),S=w+(C^(x|~p))+T[9]+3951481745&4294967295,_.g[0]=_.g[0]+p&4294967295,_.g[1]=_.g[1]+(x+(S<<21&4294967295|S>>>11))&4294967295,_.g[2]=_.g[2]+x&4294967295,_.g[3]=_.g[3]+C&4294967295}r.prototype.u=function(_,p){p===void 0&&(p=_.length);for(var w=p-this.blockSize,T=this.B,x=this.h,C=0;C<p;){if(x==0)for(;C<=w;)i(this,_,C),C+=this.blockSize;if(typeof _=="string"){for(;C<p;)if(T[x++]=_.charCodeAt(C++),x==this.blockSize){i(this,T),x=0;break}}else for(;C<p;)if(T[x++]=_[C++],x==this.blockSize){i(this,T),x=0;break}}this.h=x,this.o+=p},r.prototype.v=function(){var _=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);_[0]=128;for(var p=1;p<_.length-8;++p)_[p]=0;var w=8*this.o;for(p=_.length-8;p<_.length;++p)_[p]=w&255,w/=256;for(this.u(_),_=Array(16),p=w=0;4>p;++p)for(var T=0;32>T;T+=8)_[w++]=this.g[p]>>>T&255;return _};function s(_,p){var w=l;return Object.prototype.hasOwnProperty.call(w,_)?w[_]:w[_]=p(_)}function o(_,p){this.h=p;for(var w=[],T=!0,x=_.length-1;0<=x;x--){var C=_[x]|0;T&&C==p||(w[x]=C,T=!1)}this.g=w}var l={};function u(_){return-128<=_&&128>_?s(_,function(p){return new o([p|0],0>p?-1:0)}):new o([_|0],0>_?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return y;if(0>_)return O(h(-_));for(var p=[],w=1,T=0;_>=w;T++)p[T]=_/w|0,w*=4294967296;return new o(p,0)}function f(_,p){if(_.length==0)throw Error("number format error: empty string");if(p=p||10,2>p||36<p)throw Error("radix out of range: "+p);if(_.charAt(0)=="-")return O(f(_.substring(1),p));if(0<=_.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=h(Math.pow(p,8)),T=y,x=0;x<_.length;x+=8){var C=Math.min(8,_.length-x),S=parseInt(_.substring(x,x+C),p);8>C?(C=h(Math.pow(p,C)),T=T.j(C).add(h(S))):(T=T.j(w),T=T.add(h(S)))}return T}var y=u(0),v=u(1),k=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-O(this).m();for(var _=0,p=1,w=0;w<this.g.length;w++){var T=this.i(w);_+=(0<=T?T:4294967296+T)*p,p*=4294967296}return _},t.toString=function(_){if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(R(this))return"0";if(P(this))return"-"+O(this).toString(_);for(var p=h(Math.pow(_,6)),w=this,T="";;){var x=b(w,p).g;w=I(w,x.j(p));var C=((0<w.g.length?w.g[0]:w.h)>>>0).toString(_);if(w=x,R(w))return C+T;for(;6>C.length;)C="0"+C;T=C+T}},t.i=function(_){return 0>_?0:_<this.g.length?this.g[_]:this.h};function R(_){if(_.h!=0)return!1;for(var p=0;p<_.g.length;p++)if(_.g[p]!=0)return!1;return!0}function P(_){return _.h==-1}t.l=function(_){return _=I(this,_),P(_)?-1:R(_)?0:1};function O(_){for(var p=_.g.length,w=[],T=0;T<p;T++)w[T]=~_.g[T];return new o(w,~_.h).add(v)}t.abs=function(){return P(this)?O(this):this},t.add=function(_){for(var p=Math.max(this.g.length,_.g.length),w=[],T=0,x=0;x<=p;x++){var C=T+(this.i(x)&65535)+(_.i(x)&65535),S=(C>>>16)+(this.i(x)>>>16)+(_.i(x)>>>16);T=S>>>16,C&=65535,S&=65535,w[x]=S<<16|C}return new o(w,w[w.length-1]&-2147483648?-1:0)};function I(_,p){return _.add(O(p))}t.j=function(_){if(R(this)||R(_))return y;if(P(this))return P(_)?O(this).j(O(_)):O(O(this).j(_));if(P(_))return O(this.j(O(_)));if(0>this.l(k)&&0>_.l(k))return h(this.m()*_.m());for(var p=this.g.length+_.g.length,w=[],T=0;T<2*p;T++)w[T]=0;for(T=0;T<this.g.length;T++)for(var x=0;x<_.g.length;x++){var C=this.i(T)>>>16,S=this.i(T)&65535,Y=_.i(x)>>>16,se=_.i(x)&65535;w[2*T+2*x]+=S*se,E(w,2*T+2*x),w[2*T+2*x+1]+=C*se,E(w,2*T+2*x+1),w[2*T+2*x+1]+=S*Y,E(w,2*T+2*x+1),w[2*T+2*x+2]+=C*Y,E(w,2*T+2*x+2)}for(T=0;T<p;T++)w[T]=w[2*T+1]<<16|w[2*T];for(T=p;T<2*p;T++)w[T]=0;return new o(w,0)};function E(_,p){for(;(_[p]&65535)!=_[p];)_[p+1]+=_[p]>>>16,_[p]&=65535,p++}function A(_,p){this.g=_,this.h=p}function b(_,p){if(R(p))throw Error("division by zero");if(R(_))return new A(y,y);if(P(_))return p=b(O(_),p),new A(O(p.g),O(p.h));if(P(p))return p=b(_,O(p)),new A(O(p.g),p.h);if(30<_.g.length){if(P(_)||P(p))throw Error("slowDivide_ only works with positive integers.");for(var w=v,T=p;0>=T.l(_);)w=F(w),T=F(T);var x=M(w,1),C=M(T,1);for(T=M(T,2),w=M(w,2);!R(T);){var S=C.add(T);0>=S.l(_)&&(x=x.add(w),C=S),T=M(T,1),w=M(w,1)}return p=I(_,x.j(p)),new A(x,p)}for(x=y;0<=_.l(p);){for(w=Math.max(1,Math.floor(_.m()/p.m())),T=Math.ceil(Math.log(w)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),C=h(w),S=C.j(p);P(S)||0<S.l(_);)w-=T,C=h(w),S=C.j(p);R(C)&&(C=v),x=x.add(C),_=I(_,S)}return new A(x,_)}t.A=function(_){return b(this,_).h},t.and=function(_){for(var p=Math.max(this.g.length,_.g.length),w=[],T=0;T<p;T++)w[T]=this.i(T)&_.i(T);return new o(w,this.h&_.h)},t.or=function(_){for(var p=Math.max(this.g.length,_.g.length),w=[],T=0;T<p;T++)w[T]=this.i(T)|_.i(T);return new o(w,this.h|_.h)},t.xor=function(_){for(var p=Math.max(this.g.length,_.g.length),w=[],T=0;T<p;T++)w[T]=this.i(T)^_.i(T);return new o(w,this.h^_.h)};function F(_){for(var p=_.g.length+1,w=[],T=0;T<p;T++)w[T]=_.i(T)<<1|_.i(T-1)>>>31;return new o(w,_.h)}function M(_,p){var w=p>>5;p%=32;for(var T=_.g.length-w,x=[],C=0;C<T;C++)x[C]=0<p?_.i(C+w)>>>p|_.i(C+w+1)<<32-p:_.i(C+w);return new o(x,_.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,G_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,br=o}).apply(typeof og<"u"?og:typeof self<"u"?self:typeof window<"u"?window:{});var ya=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Y_,xs,X_,Ma,xh,J_,Z_,ew;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,c,d){return a==Array.prototype||a==Object.prototype||(a[c]=d.value),a};function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof ya=="object"&&ya];for(var c=0;c<a.length;++c){var d=a[c];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function i(a,c){if(c)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var N=a[g];if(!(N in d))break e;d=d[N]}a=a[a.length-1],g=d[a],c=c(g),c!=g&&c!=null&&e(d,a,{configurable:!0,writable:!0,value:c})}}function s(a,c){a instanceof String&&(a+="");var d=0,g=!1,N={next:function(){if(!g&&d<a.length){var D=d++;return{value:c(D,a[D]),done:!1}}return g=!0,{done:!0,value:void 0}}};return N[Symbol.iterator]=function(){return N},N}i("Array.prototype.values",function(a){return a||function(){return s(this,function(c,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},l=this||self;function u(a){var c=typeof a;return c=c!="object"?c:a?Array.isArray(a)?"array":c:"null",c=="array"||c=="object"&&typeof a.length=="number"}function h(a){var c=typeof a;return c=="object"&&a!=null||c=="function"}function f(a,c,d){return a.call.apply(a.bind,arguments)}function y(a,c,d){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var N=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(N,g),a.apply(c,N)}}return function(){return a.apply(c,arguments)}}function v(a,c,d){return v=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:y,v.apply(null,arguments)}function k(a,c){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function R(a,c){function d(){}d.prototype=c.prototype,a.aa=c.prototype,a.prototype=new d,a.prototype.constructor=a,a.Qb=function(g,N,D){for(var U=Array(arguments.length-2),he=2;he<arguments.length;he++)U[he-2]=arguments[he];return c.prototype[N].apply(g,U)}}function P(a){const c=a.length;if(0<c){const d=Array(c);for(let g=0;g<c;g++)d[g]=a[g];return d}return[]}function O(a,c){for(let d=1;d<arguments.length;d++){const g=arguments[d];if(u(g)){const N=a.length||0,D=g.length||0;a.length=N+D;for(let U=0;U<D;U++)a[N+U]=g[U]}else a.push(g)}}class I{constructor(c,d){this.i=c,this.j=d,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function E(a){return/^[\s\xa0]*$/.test(a)}function A(){var a=l.navigator;return a&&(a=a.userAgent)?a:""}function b(a){return b[" "](a),a}b[" "]=function(){};var F=A().indexOf("Gecko")!=-1&&!(A().toLowerCase().indexOf("webkit")!=-1&&A().indexOf("Edge")==-1)&&!(A().indexOf("Trident")!=-1||A().indexOf("MSIE")!=-1)&&A().indexOf("Edge")==-1;function M(a,c,d){for(const g in a)c.call(d,a[g],g,a)}function _(a,c){for(const d in a)c.call(void 0,a[d],d,a)}function p(a){const c={};for(const d in a)c[d]=a[d];return c}const w="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function T(a,c){let d,g;for(let N=1;N<arguments.length;N++){g=arguments[N];for(d in g)a[d]=g[d];for(let D=0;D<w.length;D++)d=w[D],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function x(a){var c=1;a=a.split(":");const d=[];for(;0<c&&a.length;)d.push(a.shift()),c--;return a.length&&d.push(a.join(":")),d}function C(a){l.setTimeout(()=>{throw a},0)}function S(){var a=K;let c=null;return a.g&&(c=a.g,a.g=a.g.next,a.g||(a.h=null),c.next=null),c}class Y{constructor(){this.h=this.g=null}add(c,d){const g=se.get();g.set(c,d),this.h?this.h.next=g:this.g=g,this.h=g}}var se=new I(()=>new be,a=>a.reset());class be{constructor(){this.next=this.g=this.h=null}set(c,d){this.h=c,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let Ce,B=!1,K=new Y,X=()=>{const a=l.Promise.resolve(void 0);Ce=()=>{a.then(ve)}};var ve=()=>{for(var a;a=S();){try{a.h.call(a.g)}catch(d){C(d)}var c=se;c.j(a),100>c.h&&(c.h++,a.next=c.g,c.g=a)}B=!1};function ce(){this.s=this.s,this.C=this.C}ce.prototype.s=!1,ce.prototype.ma=function(){this.s||(this.s=!0,this.N())},ce.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function xe(a,c){this.type=a,this.g=this.target=c,this.defaultPrevented=!1}xe.prototype.h=function(){this.defaultPrevented=!0};var on=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var a=!1,c=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};l.addEventListener("test",d,c),l.removeEventListener("test",d,c)}catch{}return a}();function an(a,c){if(xe.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=c,c=a.relatedTarget){if(F){e:{try{b(c.nodeName);var N=!0;break e}catch{}N=!1}N||(c=null)}}else d=="mouseover"?c=a.fromElement:d=="mouseout"&&(c=a.toElement);this.relatedTarget=c,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:ln[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&an.aa.h.call(this)}}R(an,xe);var ln={2:"touch",3:"pen",4:"mouse"};an.prototype.h=function(){an.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var un="closure_listenable_"+(1e6*Math.random()|0),PE=0;function NE(a,c,d,g,N){this.listener=a,this.proxy=null,this.src=c,this.type=d,this.capture=!!g,this.ha=N,this.key=++PE,this.da=this.fa=!1}function Lo(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Mo(a){this.src=a,this.g={},this.h=0}Mo.prototype.add=function(a,c,d,g,N){var D=a.toString();a=this.g[D],a||(a=this.g[D]=[],this.h++);var U=mu(a,c,g,N);return-1<U?(c=a[U],d||(c.fa=!1)):(c=new NE(c,this.src,D,!!g,N),c.fa=d,a.push(c)),c};function pu(a,c){var d=c.type;if(d in a.g){var g=a.g[d],N=Array.prototype.indexOf.call(g,c,void 0),D;(D=0<=N)&&Array.prototype.splice.call(g,N,1),D&&(Lo(c),a.g[d].length==0&&(delete a.g[d],a.h--))}}function mu(a,c,d,g){for(var N=0;N<a.length;++N){var D=a[N];if(!D.da&&D.listener==c&&D.capture==!!d&&D.ha==g)return N}return-1}var gu="closure_lm_"+(1e6*Math.random()|0),yu={};function zf(a,c,d,g,N){if(Array.isArray(c)){for(var D=0;D<c.length;D++)zf(a,c[D],d,g,N);return null}return d=Hf(d),a&&a[un]?a.K(c,d,h(g)?!!g.capture:!1,N):bE(a,c,d,!1,g,N)}function bE(a,c,d,g,N,D){if(!c)throw Error("Invalid event type");var U=h(N)?!!N.capture:!!N,he=_u(a);if(he||(a[gu]=he=new Mo(a)),d=he.add(c,d,g,U,D),d.proxy)return d;if(g=DE(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)on||(N=U),N===void 0&&(N=!1),a.addEventListener(c.toString(),g,N);else if(a.attachEvent)a.attachEvent(qf(c.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function DE(){function a(d){return c.call(a.src,a.listener,d)}const c=OE;return a}function $f(a,c,d,g,N){if(Array.isArray(c))for(var D=0;D<c.length;D++)$f(a,c[D],d,g,N);else g=h(g)?!!g.capture:!!g,d=Hf(d),a&&a[un]?(a=a.i,c=String(c).toString(),c in a.g&&(D=a.g[c],d=mu(D,d,g,N),-1<d&&(Lo(D[d]),Array.prototype.splice.call(D,d,1),D.length==0&&(delete a.g[c],a.h--)))):a&&(a=_u(a))&&(c=a.g[c.toString()],a=-1,c&&(a=mu(c,d,g,N)),(d=-1<a?c[a]:null)&&vu(d))}function vu(a){if(typeof a!="number"&&a&&!a.da){var c=a.src;if(c&&c[un])pu(c.i,a);else{var d=a.type,g=a.proxy;c.removeEventListener?c.removeEventListener(d,g,a.capture):c.detachEvent?c.detachEvent(qf(d),g):c.addListener&&c.removeListener&&c.removeListener(g),(d=_u(c))?(pu(d,a),d.h==0&&(d.src=null,c[gu]=null)):Lo(a)}}}function qf(a){return a in yu?yu[a]:yu[a]="on"+a}function OE(a,c){if(a.da)a=!0;else{c=new an(c,this);var d=a.listener,g=a.ha||a.src;a.fa&&vu(a),a=d.call(g,c)}return a}function _u(a){return a=a[gu],a instanceof Mo?a:null}var wu="__closure_events_fn_"+(1e9*Math.random()>>>0);function Hf(a){return typeof a=="function"?a:(a[wu]||(a[wu]=function(c){return a.handleEvent(c)}),a[wu])}function Ke(){ce.call(this),this.i=new Mo(this),this.M=this,this.F=null}R(Ke,ce),Ke.prototype[un]=!0,Ke.prototype.removeEventListener=function(a,c,d,g){$f(this,a,c,d,g)};function st(a,c){var d,g=a.F;if(g)for(d=[];g;g=g.F)d.push(g);if(a=a.M,g=c.type||c,typeof c=="string")c=new xe(c,a);else if(c instanceof xe)c.target=c.target||a;else{var N=c;c=new xe(g,a),T(c,N)}if(N=!0,d)for(var D=d.length-1;0<=D;D--){var U=c.g=d[D];N=jo(U,g,!0,c)&&N}if(U=c.g=a,N=jo(U,g,!0,c)&&N,N=jo(U,g,!1,c)&&N,d)for(D=0;D<d.length;D++)U=c.g=d[D],N=jo(U,g,!1,c)&&N}Ke.prototype.N=function(){if(Ke.aa.N.call(this),this.i){var a=this.i,c;for(c in a.g){for(var d=a.g[c],g=0;g<d.length;g++)Lo(d[g]);delete a.g[c],a.h--}}this.F=null},Ke.prototype.K=function(a,c,d,g){return this.i.add(String(a),c,!1,d,g)},Ke.prototype.L=function(a,c,d,g){return this.i.add(String(a),c,!0,d,g)};function jo(a,c,d,g){if(c=a.i.g[String(c)],!c)return!0;c=c.concat();for(var N=!0,D=0;D<c.length;++D){var U=c[D];if(U&&!U.da&&U.capture==d){var he=U.listener,Fe=U.ha||U.src;U.fa&&pu(a.i,U),N=he.call(Fe,g)!==!1&&N}}return N&&!g.defaultPrevented}function Wf(a,c,d){if(typeof a=="function")d&&(a=v(a,d));else if(a&&typeof a.handleEvent=="function")a=v(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:l.setTimeout(a,c||0)}function Kf(a){a.g=Wf(()=>{a.g=null,a.i&&(a.i=!1,Kf(a))},a.l);const c=a.h;a.h=null,a.m.apply(null,c)}class VE extends ce{constructor(c,d){super(),this.m=c,this.l=d,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Kf(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Zi(a){ce.call(this),this.h=a,this.g={}}R(Zi,ce);var Qf=[];function Gf(a){M(a.g,function(c,d){this.g.hasOwnProperty(d)&&vu(c)},a),a.g={}}Zi.prototype.N=function(){Zi.aa.N.call(this),Gf(this)},Zi.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Eu=l.JSON.stringify,LE=l.JSON.parse,ME=class{stringify(a){return l.JSON.stringify(a,void 0)}parse(a){return l.JSON.parse(a,void 0)}};function Tu(){}Tu.prototype.h=null;function Yf(a){return a.h||(a.h=a.i())}function Xf(){}var es={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Iu(){xe.call(this,"d")}R(Iu,xe);function Su(){xe.call(this,"c")}R(Su,xe);var vr={},Jf=null;function Fo(){return Jf=Jf||new Ke}vr.La="serverreachability";function Zf(a){xe.call(this,vr.La,a)}R(Zf,xe);function ts(a){const c=Fo();st(c,new Zf(c))}vr.STAT_EVENT="statevent";function ep(a,c){xe.call(this,vr.STAT_EVENT,a),this.stat=c}R(ep,xe);function ot(a){const c=Fo();st(c,new ep(c,a))}vr.Ma="timingevent";function tp(a,c){xe.call(this,vr.Ma,a),this.size=c}R(tp,xe);function ns(a,c){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){a()},c)}function rs(){this.g=!0}rs.prototype.xa=function(){this.g=!1};function jE(a,c,d,g,N,D){a.info(function(){if(a.g)if(D)for(var U="",he=D.split("&"),Fe=0;Fe<he.length;Fe++){var oe=he[Fe].split("=");if(1<oe.length){var Qe=oe[0];oe=oe[1];var Ge=Qe.split("_");U=2<=Ge.length&&Ge[1]=="type"?U+(Qe+"="+oe+"&"):U+(Qe+"=redacted&")}}else U=null;else U=D;return"XMLHTTP REQ ("+g+") [attempt "+N+"]: "+c+`
`+d+`
`+U})}function FE(a,c,d,g,N,D,U){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+N+"]: "+c+`
`+d+`
`+D+" "+U})}function Yr(a,c,d,g){a.info(function(){return"XMLHTTP TEXT ("+c+"): "+BE(a,d)+(g?" "+g:"")})}function UE(a,c){a.info(function(){return"TIMEOUT: "+c})}rs.prototype.info=function(){};function BE(a,c){if(!a.g)return c;if(!c)return null;try{var d=JSON.parse(c);if(d){for(a=0;a<d.length;a++)if(Array.isArray(d[a])){var g=d[a];if(!(2>g.length)){var N=g[1];if(Array.isArray(N)&&!(1>N.length)){var D=N[0];if(D!="noop"&&D!="stop"&&D!="close")for(var U=1;U<N.length;U++)N[U]=""}}}}return Eu(d)}catch{return c}}var Uo={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},np={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},xu;function Bo(){}R(Bo,Tu),Bo.prototype.g=function(){return new XMLHttpRequest},Bo.prototype.i=function(){return{}},xu=new Bo;function On(a,c,d,g){this.j=a,this.i=c,this.l=d,this.R=g||1,this.U=new Zi(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new rp}function rp(){this.i=null,this.g="",this.h=!1}var ip={},Au={};function ku(a,c,d){a.L=1,a.v=Ho(cn(c)),a.m=d,a.P=!0,sp(a,null)}function sp(a,c){a.F=Date.now(),zo(a),a.A=cn(a.v);var d=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),_p(d.i,"t",g),a.C=0,d=a.j.J,a.h=new rp,a.g=Mp(a.j,d?c:null,!a.m),0<a.O&&(a.M=new VE(v(a.Y,a,a.g),a.O)),c=a.U,d=a.g,g=a.ca;var N="readystatechange";Array.isArray(N)||(N&&(Qf[0]=N.toString()),N=Qf);for(var D=0;D<N.length;D++){var U=zf(d,N[D],g||c.handleEvent,!1,c.h||c);if(!U)break;c.g[U.key]=U}c=a.H?p(a.H):{},a.m?(a.u||(a.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,c)):(a.u="GET",a.g.ea(a.A,a.u,null,c)),ts(),jE(a.i,a.u,a.A,a.l,a.R,a.m)}On.prototype.ca=function(a){a=a.target;const c=this.M;c&&hn(a)==3?c.j():this.Y(a)},On.prototype.Y=function(a){try{if(a==this.g)e:{const Ge=hn(this.g);var c=this.g.Ba();const Zr=this.g.Z();if(!(3>Ge)&&(Ge!=3||this.g&&(this.h.h||this.g.oa()||Ap(this.g)))){this.J||Ge!=4||c==7||(c==8||0>=Zr?ts(3):ts(2)),Cu(this);var d=this.g.Z();this.X=d;t:if(op(this)){var g=Ap(this.g);a="";var N=g.length,D=hn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){_r(this),is(this);var U="";break t}this.h.i=new l.TextDecoder}for(c=0;c<N;c++)this.h.h=!0,a+=this.h.i.decode(g[c],{stream:!(D&&c==N-1)});g.length=0,this.h.g+=a,this.C=0,U=this.h.g}else U=this.g.oa();if(this.o=d==200,FE(this.i,this.u,this.A,this.l,this.R,Ge,d),this.o){if(this.T&&!this.K){t:{if(this.g){var he,Fe=this.g;if((he=Fe.g?Fe.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!E(he)){var oe=he;break t}}oe=null}if(d=oe)Yr(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ru(this,d);else{this.o=!1,this.s=3,ot(12),_r(this),is(this);break e}}if(this.P){d=!0;let Dt;for(;!this.J&&this.C<U.length;)if(Dt=zE(this,U),Dt==Au){Ge==4&&(this.s=4,ot(14),d=!1),Yr(this.i,this.l,null,"[Incomplete Response]");break}else if(Dt==ip){this.s=4,ot(15),Yr(this.i,this.l,U,"[Invalid Chunk]"),d=!1;break}else Yr(this.i,this.l,Dt,null),Ru(this,Dt);if(op(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Ge!=4||U.length!=0||this.h.h||(this.s=1,ot(16),d=!1),this.o=this.o&&d,!d)Yr(this.i,this.l,U,"[Invalid Chunked Response]"),_r(this),is(this);else if(0<U.length&&!this.W){this.W=!0;var Qe=this.j;Qe.g==this&&Qe.ba&&!Qe.M&&(Qe.j.info("Great, no buffering proxy detected. Bytes received: "+U.length),Vu(Qe),Qe.M=!0,ot(11))}}else Yr(this.i,this.l,U,null),Ru(this,U);Ge==4&&_r(this),this.o&&!this.J&&(Ge==4?Dp(this.j,this):(this.o=!1,zo(this)))}else sT(this.g),d==400&&0<U.indexOf("Unknown SID")?(this.s=3,ot(12)):(this.s=0,ot(13)),_r(this),is(this)}}}catch{}finally{}};function op(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function zE(a,c){var d=a.C,g=c.indexOf(`
`,d);return g==-1?Au:(d=Number(c.substring(d,g)),isNaN(d)?ip:(g+=1,g+d>c.length?Au:(c=c.slice(g,g+d),a.C=g+d,c)))}On.prototype.cancel=function(){this.J=!0,_r(this)};function zo(a){a.S=Date.now()+a.I,ap(a,a.I)}function ap(a,c){if(a.B!=null)throw Error("WatchDog timer not null");a.B=ns(v(a.ba,a),c)}function Cu(a){a.B&&(l.clearTimeout(a.B),a.B=null)}On.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(UE(this.i,this.A),this.L!=2&&(ts(),ot(17)),_r(this),this.s=2,is(this)):ap(this,this.S-a)};function is(a){a.j.G==0||a.J||Dp(a.j,a)}function _r(a){Cu(a);var c=a.M;c&&typeof c.ma=="function"&&c.ma(),a.M=null,Gf(a.U),a.g&&(c=a.g,a.g=null,c.abort(),c.ma())}function Ru(a,c){try{var d=a.j;if(d.G!=0&&(d.g==a||Pu(d.h,a))){if(!a.K&&Pu(d.h,a)&&d.G==3){try{var g=d.Da.g.parse(c)}catch{g=null}if(Array.isArray(g)&&g.length==3){var N=g;if(N[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<a.F)Xo(d),Go(d);else break e;Ou(d),ot(18)}}else d.za=N[1],0<d.za-d.T&&37500>N[2]&&d.F&&d.v==0&&!d.C&&(d.C=ns(v(d.Za,d),6e3));if(1>=cp(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else Er(d,11)}else if((a.K||d.g==a)&&Xo(d),!E(c))for(N=d.Da.g.parse(c),c=0;c<N.length;c++){let oe=N[c];if(d.T=oe[0],oe=oe[1],d.G==2)if(oe[0]=="c"){d.K=oe[1],d.ia=oe[2];const Qe=oe[3];Qe!=null&&(d.la=Qe,d.j.info("VER="+d.la));const Ge=oe[4];Ge!=null&&(d.Aa=Ge,d.j.info("SVER="+d.Aa));const Zr=oe[5];Zr!=null&&typeof Zr=="number"&&0<Zr&&(g=1.5*Zr,d.L=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const Dt=a.g;if(Dt){const Zo=Dt.g?Dt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Zo){var D=g.h;D.g||Zo.indexOf("spdy")==-1&&Zo.indexOf("quic")==-1&&Zo.indexOf("h2")==-1||(D.j=D.l,D.g=new Set,D.h&&(Nu(D,D.h),D.h=null))}if(g.D){const Lu=Dt.g?Dt.g.getResponseHeader("X-HTTP-Session-Id"):null;Lu&&(g.ya=Lu,fe(g.I,g.D,Lu))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-a.F,d.j.info("Handshake RTT: "+d.R+"ms")),g=d;var U=a;if(g.qa=Lp(g,g.J?g.ia:null,g.W),U.K){hp(g.h,U);var he=U,Fe=g.L;Fe&&(he.I=Fe),he.B&&(Cu(he),zo(he)),g.g=U}else Np(g);0<d.i.length&&Yo(d)}else oe[0]!="stop"&&oe[0]!="close"||Er(d,7);else d.G==3&&(oe[0]=="stop"||oe[0]=="close"?oe[0]=="stop"?Er(d,7):Du(d):oe[0]!="noop"&&d.l&&d.l.ta(oe),d.v=0)}}ts(4)}catch{}}var $E=class{constructor(a,c){this.g=a,this.map=c}};function lp(a){this.l=a||10,l.PerformanceNavigationTiming?(a=l.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function up(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function cp(a){return a.h?1:a.g?a.g.size:0}function Pu(a,c){return a.h?a.h==c:a.g?a.g.has(c):!1}function Nu(a,c){a.g?a.g.add(c):a.h=c}function hp(a,c){a.h&&a.h==c?a.h=null:a.g&&a.g.has(c)&&a.g.delete(c)}lp.prototype.cancel=function(){if(this.i=dp(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function dp(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let c=a.i;for(const d of a.g.values())c=c.concat(d.D);return c}return P(a.i)}function qE(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(u(a)){for(var c=[],d=a.length,g=0;g<d;g++)c.push(a[g]);return c}c=[],d=0;for(g in a)c[d++]=a[g];return c}function HE(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(u(a)||typeof a=="string"){var c=[];a=a.length;for(var d=0;d<a;d++)c.push(d);return c}c=[],d=0;for(const g in a)c[d++]=g;return c}}}function fp(a,c){if(a.forEach&&typeof a.forEach=="function")a.forEach(c,void 0);else if(u(a)||typeof a=="string")Array.prototype.forEach.call(a,c,void 0);else for(var d=HE(a),g=qE(a),N=g.length,D=0;D<N;D++)c.call(void 0,g[D],d&&d[D],a)}var pp=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function WE(a,c){if(a){a=a.split("&");for(var d=0;d<a.length;d++){var g=a[d].indexOf("="),N=null;if(0<=g){var D=a[d].substring(0,g);N=a[d].substring(g+1)}else D=a[d];c(D,N?decodeURIComponent(N.replace(/\+/g," ")):"")}}}function wr(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof wr){this.h=a.h,$o(this,a.j),this.o=a.o,this.g=a.g,qo(this,a.s),this.l=a.l;var c=a.i,d=new as;d.i=c.i,c.g&&(d.g=new Map(c.g),d.h=c.h),mp(this,d),this.m=a.m}else a&&(c=String(a).match(pp))?(this.h=!1,$o(this,c[1]||"",!0),this.o=ss(c[2]||""),this.g=ss(c[3]||"",!0),qo(this,c[4]),this.l=ss(c[5]||"",!0),mp(this,c[6]||"",!0),this.m=ss(c[7]||"")):(this.h=!1,this.i=new as(null,this.h))}wr.prototype.toString=function(){var a=[],c=this.j;c&&a.push(os(c,gp,!0),":");var d=this.g;return(d||c=="file")&&(a.push("//"),(c=this.o)&&a.push(os(c,gp,!0),"@"),a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&a.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(os(d,d.charAt(0)=="/"?GE:QE,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",os(d,XE)),a.join("")};function cn(a){return new wr(a)}function $o(a,c,d){a.j=d?ss(c,!0):c,a.j&&(a.j=a.j.replace(/:$/,""))}function qo(a,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);a.s=c}else a.s=null}function mp(a,c,d){c instanceof as?(a.i=c,JE(a.i,a.h)):(d||(c=os(c,YE)),a.i=new as(c,a.h))}function fe(a,c,d){a.i.set(c,d)}function Ho(a){return fe(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function ss(a,c){return a?c?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function os(a,c,d){return typeof a=="string"?(a=encodeURI(a).replace(c,KE),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function KE(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var gp=/[#\/\?@]/g,QE=/[#\?:]/g,GE=/[#\?]/g,YE=/[#\?@]/g,XE=/#/g;function as(a,c){this.h=this.g=null,this.i=a||null,this.j=!!c}function Vn(a){a.g||(a.g=new Map,a.h=0,a.i&&WE(a.i,function(c,d){a.add(decodeURIComponent(c.replace(/\+/g," ")),d)}))}t=as.prototype,t.add=function(a,c){Vn(this),this.i=null,a=Xr(this,a);var d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(c),this.h+=1,this};function yp(a,c){Vn(a),c=Xr(a,c),a.g.has(c)&&(a.i=null,a.h-=a.g.get(c).length,a.g.delete(c))}function vp(a,c){return Vn(a),c=Xr(a,c),a.g.has(c)}t.forEach=function(a,c){Vn(this),this.g.forEach(function(d,g){d.forEach(function(N){a.call(c,N,g,this)},this)},this)},t.na=function(){Vn(this);const a=Array.from(this.g.values()),c=Array.from(this.g.keys()),d=[];for(let g=0;g<c.length;g++){const N=a[g];for(let D=0;D<N.length;D++)d.push(c[g])}return d},t.V=function(a){Vn(this);let c=[];if(typeof a=="string")vp(this,a)&&(c=c.concat(this.g.get(Xr(this,a))));else{a=Array.from(this.g.values());for(let d=0;d<a.length;d++)c=c.concat(a[d])}return c},t.set=function(a,c){return Vn(this),this.i=null,a=Xr(this,a),vp(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[c]),this.h+=1,this},t.get=function(a,c){return a?(a=this.V(a),0<a.length?String(a[0]):c):c};function _p(a,c,d){yp(a,c),0<d.length&&(a.i=null,a.g.set(Xr(a,c),P(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],c=Array.from(this.g.keys());for(var d=0;d<c.length;d++){var g=c[d];const D=encodeURIComponent(String(g)),U=this.V(g);for(g=0;g<U.length;g++){var N=D;U[g]!==""&&(N+="="+encodeURIComponent(String(U[g]))),a.push(N)}}return this.i=a.join("&")};function Xr(a,c){return c=String(c),a.j&&(c=c.toLowerCase()),c}function JE(a,c){c&&!a.j&&(Vn(a),a.i=null,a.g.forEach(function(d,g){var N=g.toLowerCase();g!=N&&(yp(this,g),_p(this,N,d))},a)),a.j=c}function ZE(a,c){const d=new rs;if(l.Image){const g=new Image;g.onload=k(Ln,d,"TestLoadImage: loaded",!0,c,g),g.onerror=k(Ln,d,"TestLoadImage: error",!1,c,g),g.onabort=k(Ln,d,"TestLoadImage: abort",!1,c,g),g.ontimeout=k(Ln,d,"TestLoadImage: timeout",!1,c,g),l.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else c(!1)}function eT(a,c){const d=new rs,g=new AbortController,N=setTimeout(()=>{g.abort(),Ln(d,"TestPingServer: timeout",!1,c)},1e4);fetch(a,{signal:g.signal}).then(D=>{clearTimeout(N),D.ok?Ln(d,"TestPingServer: ok",!0,c):Ln(d,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(N),Ln(d,"TestPingServer: error",!1,c)})}function Ln(a,c,d,g,N){try{N&&(N.onload=null,N.onerror=null,N.onabort=null,N.ontimeout=null),g(d)}catch{}}function tT(){this.g=new ME}function nT(a,c,d){const g=d||"";try{fp(a,function(N,D){let U=N;h(N)&&(U=Eu(N)),c.push(g+D+"="+encodeURIComponent(U))})}catch(N){throw c.push(g+"type="+encodeURIComponent("_badmap")),N}}function Wo(a){this.l=a.Ub||null,this.j=a.eb||!1}R(Wo,Tu),Wo.prototype.g=function(){return new Ko(this.l,this.j)},Wo.prototype.i=function(a){return function(){return a}}({});function Ko(a,c){Ke.call(this),this.D=a,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}R(Ko,Ke),t=Ko.prototype,t.open=function(a,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=c,this.readyState=1,us(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(c.body=a),(this.D||l).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,ls(this)),this.readyState=0},t.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,us(this)),this.g&&(this.readyState=3,us(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;wp(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function wp(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}t.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var c=a.value?a.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!a.done}))&&(this.response=this.responseText+=c)}a.done?ls(this):us(this),this.readyState==3&&wp(this)}},t.Ra=function(a){this.g&&(this.response=this.responseText=a,ls(this))},t.Qa=function(a){this.g&&(this.response=a,ls(this))},t.ga=function(){this.g&&ls(this)};function ls(a){a.readyState=4,a.l=null,a.j=null,a.v=null,us(a)}t.setRequestHeader=function(a,c){this.u.append(a,c)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],c=this.h.entries();for(var d=c.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=c.next();return a.join(`\r
`)};function us(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Ko.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Ep(a){let c="";return M(a,function(d,g){c+=g,c+=":",c+=d,c+=`\r
`}),c}function bu(a,c,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=Ep(d),typeof a=="string"?d!=null&&encodeURIComponent(String(d)):fe(a,c,d))}function Ie(a){Ke.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}R(Ie,Ke);var rT=/^https?$/i,iT=["POST","PUT"];t=Ie.prototype,t.Ha=function(a){this.J=a},t.ea=function(a,c,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);c=c?c.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():xu.g(),this.v=this.o?Yf(this.o):Yf(xu),this.g.onreadystatechange=v(this.Ea,this);try{this.B=!0,this.g.open(c,String(a),!0),this.B=!1}catch(D){Tp(this,D);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var N in g)d.set(N,g[N]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const D of g.keys())d.set(D,g.get(D));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(D=>D.toLowerCase()=="content-type"),N=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(iT,c,void 0))||g||N||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[D,U]of d)this.g.setRequestHeader(D,U);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{xp(this),this.u=!0,this.g.send(a),this.u=!1}catch(D){Tp(this,D)}};function Tp(a,c){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=c,a.m=5,Ip(a),Qo(a)}function Ip(a){a.A||(a.A=!0,st(a,"complete"),st(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,st(this,"complete"),st(this,"abort"),Qo(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Qo(this,!0)),Ie.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Sp(this):this.bb())},t.bb=function(){Sp(this)};function Sp(a){if(a.h&&typeof o<"u"&&(!a.v[1]||hn(a)!=4||a.Z()!=2)){if(a.u&&hn(a)==4)Wf(a.Ea,0,a);else if(st(a,"readystatechange"),hn(a)==4){a.h=!1;try{const U=a.Z();e:switch(U){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var d;if(!(d=c)){var g;if(g=U===0){var N=String(a.D).match(pp)[1]||null;!N&&l.self&&l.self.location&&(N=l.self.location.protocol.slice(0,-1)),g=!rT.test(N?N.toLowerCase():"")}d=g}if(d)st(a,"complete"),st(a,"success");else{a.m=6;try{var D=2<hn(a)?a.g.statusText:""}catch{D=""}a.l=D+" ["+a.Z()+"]",Ip(a)}}finally{Qo(a)}}}}function Qo(a,c){if(a.g){xp(a);const d=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,c||st(a,"ready");try{d.onreadystatechange=g}catch{}}}function xp(a){a.I&&(l.clearTimeout(a.I),a.I=null)}t.isActive=function(){return!!this.g};function hn(a){return a.g?a.g.readyState:0}t.Z=function(){try{return 2<hn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(a){if(this.g){var c=this.g.responseText;return a&&c.indexOf(a)==0&&(c=c.substring(a.length)),LE(c)}};function Ap(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function sT(a){const c={};a=(a.g&&2<=hn(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(E(a[g]))continue;var d=x(a[g]);const N=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const D=c[N]||[];c[N]=D,D.push(d)}_(c,function(g){return g.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function cs(a,c,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||c}function kp(a){this.Aa=0,this.i=[],this.j=new rs,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=cs("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=cs("baseRetryDelayMs",5e3,a),this.cb=cs("retryDelaySeedMs",1e4,a),this.Wa=cs("forwardChannelMaxRetries",2,a),this.wa=cs("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new lp(a&&a.concurrentRequestLimit),this.Da=new tT,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=kp.prototype,t.la=8,t.G=1,t.connect=function(a,c,d,g){ot(0),this.W=a,this.H=c||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.I=Lp(this,null,this.W),Yo(this)};function Du(a){if(Cp(a),a.G==3){var c=a.U++,d=cn(a.I);if(fe(d,"SID",a.K),fe(d,"RID",c),fe(d,"TYPE","terminate"),hs(a,d),c=new On(a,a.j,c),c.L=2,c.v=Ho(cn(d)),d=!1,l.navigator&&l.navigator.sendBeacon)try{d=l.navigator.sendBeacon(c.v.toString(),"")}catch{}!d&&l.Image&&(new Image().src=c.v,d=!0),d||(c.g=Mp(c.j,null),c.g.ea(c.v)),c.F=Date.now(),zo(c)}Vp(a)}function Go(a){a.g&&(Vu(a),a.g.cancel(),a.g=null)}function Cp(a){Go(a),a.u&&(l.clearTimeout(a.u),a.u=null),Xo(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function Yo(a){if(!up(a.h)&&!a.s){a.s=!0;var c=a.Ga;Ce||X(),B||(Ce(),B=!0),K.add(c,a),a.B=0}}function oT(a,c){return cp(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=c.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=ns(v(a.Ga,a,c),Op(a,a.B)),a.B++,!0)}t.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const N=new On(this,this.j,a);let D=this.o;if(this.S&&(D?(D=p(D),T(D,this.S)):D=this.S),this.m!==null||this.O||(N.H=D,D=null),this.P)e:{for(var c=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(c+=g,4096<c){c=d;break e}if(c===4096||d===this.i.length-1){c=d+1;break e}}c=1e3}else c=1e3;c=Pp(this,N,c),d=cn(this.I),fe(d,"RID",a),fe(d,"CVER",22),this.D&&fe(d,"X-HTTP-Session-Id",this.D),hs(this,d),D&&(this.O?c="headers="+encodeURIComponent(String(Ep(D)))+"&"+c:this.m&&bu(d,this.m,D)),Nu(this.h,N),this.Ua&&fe(d,"TYPE","init"),this.P?(fe(d,"$req",c),fe(d,"SID","null"),N.T=!0,ku(N,d,null)):ku(N,d,c),this.G=2}}else this.G==3&&(a?Rp(this,a):this.i.length==0||up(this.h)||Rp(this))};function Rp(a,c){var d;c?d=c.l:d=a.U++;const g=cn(a.I);fe(g,"SID",a.K),fe(g,"RID",d),fe(g,"AID",a.T),hs(a,g),a.m&&a.o&&bu(g,a.m,a.o),d=new On(a,a.j,d,a.B+1),a.m===null&&(d.H=a.o),c&&(a.i=c.D.concat(a.i)),c=Pp(a,d,1e3),d.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Nu(a.h,d),ku(d,g,c)}function hs(a,c){a.H&&M(a.H,function(d,g){fe(c,g,d)}),a.l&&fp({},function(d,g){fe(c,g,d)})}function Pp(a,c,d){d=Math.min(a.i.length,d);var g=a.l?v(a.l.Na,a.l,a):null;e:{var N=a.i;let D=-1;for(;;){const U=["count="+d];D==-1?0<d?(D=N[0].g,U.push("ofs="+D)):D=0:U.push("ofs="+D);let he=!0;for(let Fe=0;Fe<d;Fe++){let oe=N[Fe].g;const Qe=N[Fe].map;if(oe-=D,0>oe)D=Math.max(0,N[Fe].g-100),he=!1;else try{nT(Qe,U,"req"+oe+"_")}catch{g&&g(Qe)}}if(he){g=U.join("&");break e}}}return a=a.i.splice(0,d),c.D=a,g}function Np(a){if(!a.g&&!a.u){a.Y=1;var c=a.Fa;Ce||X(),B||(Ce(),B=!0),K.add(c,a),a.v=0}}function Ou(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=ns(v(a.Fa,a),Op(a,a.v)),a.v++,!0)}t.Fa=function(){if(this.u=null,bp(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=ns(v(this.ab,this),a)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ot(10),Go(this),bp(this))};function Vu(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function bp(a){a.g=new On(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var c=cn(a.qa);fe(c,"RID","rpc"),fe(c,"SID",a.K),fe(c,"AID",a.T),fe(c,"CI",a.F?"0":"1"),!a.F&&a.ja&&fe(c,"TO",a.ja),fe(c,"TYPE","xmlhttp"),hs(a,c),a.m&&a.o&&bu(c,a.m,a.o),a.L&&(a.g.I=a.L);var d=a.g;a=a.ia,d.L=1,d.v=Ho(cn(c)),d.m=null,d.P=!0,sp(d,a)}t.Za=function(){this.C!=null&&(this.C=null,Go(this),Ou(this),ot(19))};function Xo(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function Dp(a,c){var d=null;if(a.g==c){Xo(a),Vu(a),a.g=null;var g=2}else if(Pu(a.h,c))d=c.D,hp(a.h,c),g=1;else return;if(a.G!=0){if(c.o)if(g==1){d=c.m?c.m.length:0,c=Date.now()-c.F;var N=a.B;g=Fo(),st(g,new tp(g,d)),Yo(a)}else Np(a);else if(N=c.s,N==3||N==0&&0<c.X||!(g==1&&oT(a,c)||g==2&&Ou(a)))switch(d&&0<d.length&&(c=a.h,c.i=c.i.concat(d)),N){case 1:Er(a,5);break;case 4:Er(a,10);break;case 3:Er(a,6);break;default:Er(a,2)}}}function Op(a,c){let d=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(d*=2),d*c}function Er(a,c){if(a.j.info("Error code "+c),c==2){var d=v(a.fb,a),g=a.Xa;const N=!g;g=new wr(g||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||$o(g,"https"),Ho(g),N?ZE(g.toString(),d):eT(g.toString(),d)}else ot(2);a.G=0,a.l&&a.l.sa(c),Vp(a),Cp(a)}t.fb=function(a){a?(this.j.info("Successfully pinged google.com"),ot(2)):(this.j.info("Failed to ping google.com"),ot(1))};function Vp(a){if(a.G=0,a.ka=[],a.l){const c=dp(a.h);(c.length!=0||a.i.length!=0)&&(O(a.ka,c),O(a.ka,a.i),a.h.i.length=0,P(a.i),a.i.length=0),a.l.ra()}}function Lp(a,c,d){var g=d instanceof wr?cn(d):new wr(d);if(g.g!="")c&&(g.g=c+"."+g.g),qo(g,g.s);else{var N=l.location;g=N.protocol,c=c?c+"."+N.hostname:N.hostname,N=+N.port;var D=new wr(null);g&&$o(D,g),c&&(D.g=c),N&&qo(D,N),d&&(D.l=d),g=D}return d=a.D,c=a.ya,d&&c&&fe(g,d,c),fe(g,"VER",a.la),hs(a,g),g}function Mp(a,c,d){if(c&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=a.Ca&&!a.pa?new Ie(new Wo({eb:d})):new Ie(a.pa),c.Ha(a.J),c}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function jp(){}t=jp.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Jo(){}Jo.prototype.g=function(a,c){return new vt(a,c)};function vt(a,c){Ke.call(this),this.g=new kp(c),this.l=a,this.h=c&&c.messageUrlParams||null,a=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(a?a["X-WebChannel-Content-Type"]=c.messageContentType:a={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(a?a["X-WebChannel-Client-Profile"]=c.va:a={"X-WebChannel-Client-Profile":c.va}),this.g.S=a,(a=c&&c.Sb)&&!E(a)&&(this.g.m=a),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!E(c)&&(this.g.D=c,a=this.h,a!==null&&c in a&&(a=this.h,c in a&&delete a[c])),this.j=new Jr(this)}R(vt,Ke),vt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},vt.prototype.close=function(){Du(this.g)},vt.prototype.o=function(a){var c=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.u&&(d={},d.__data__=Eu(a),a=d);c.i.push(new $E(c.Ya++,a)),c.G==3&&Yo(c)},vt.prototype.N=function(){this.g.l=null,delete this.j,Du(this.g),delete this.g,vt.aa.N.call(this)};function Fp(a){Iu.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var c=a.__sm__;if(c){e:{for(const d in c){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,c=c!==null&&a in c?c[a]:void 0),this.data=c}else this.data=a}R(Fp,Iu);function Up(){Su.call(this),this.status=1}R(Up,Su);function Jr(a){this.g=a}R(Jr,jp),Jr.prototype.ua=function(){st(this.g,"a")},Jr.prototype.ta=function(a){st(this.g,new Fp(a))},Jr.prototype.sa=function(a){st(this.g,new Up)},Jr.prototype.ra=function(){st(this.g,"b")},Jo.prototype.createWebChannel=Jo.prototype.g,vt.prototype.send=vt.prototype.o,vt.prototype.open=vt.prototype.m,vt.prototype.close=vt.prototype.close,ew=function(){return new Jo},Z_=function(){return Fo()},J_=vr,xh={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Uo.NO_ERROR=0,Uo.TIMEOUT=8,Uo.HTTP_ERROR=6,Ma=Uo,np.COMPLETE="complete",X_=np,Xf.EventType=es,es.OPEN="a",es.CLOSE="b",es.ERROR="c",es.MESSAGE="d",Ke.prototype.listen=Ke.prototype.K,xs=Xf,Ie.prototype.listenOnce=Ie.prototype.L,Ie.prototype.getLastError=Ie.prototype.Ka,Ie.prototype.getLastErrorCode=Ie.prototype.Ba,Ie.prototype.getStatus=Ie.prototype.Z,Ie.prototype.getResponseJson=Ie.prototype.Oa,Ie.prototype.getResponseText=Ie.prototype.oa,Ie.prototype.send=Ie.prototype.ea,Ie.prototype.setWithCredentials=Ie.prototype.Ha,Y_=Ie}).apply(typeof ya<"u"?ya:typeof self<"u"?self:typeof window<"u"?window:{});const ag="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(t="Unexpected state"){const e=`FIRESTORE (${Ki}) INTERNAL ASSERTION FAILED: `+t;throw Rn(e),new Error(e)}function ue(t,e){t||G()}function Z(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ko(t){if(t.code!==V.FAILED_PRECONDITION||t.message!==CA)throw t;q("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new iw("Invalid base64 string: "+s):s}}(e);return new We(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new We(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ae(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}We.EMPTY_BYTE_STRING=new We("");const bA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function dr(t){if(ue(!!t),typeof t=="string"){let e=0;const n=bA.exec(t);if(ue(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ae(t.seconds),nanos:Ae(t.nanos)}}function Ae(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Fr(t){return typeof t=="string"?We.fromBase64String(t):We.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hd(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Wd(t){const e=t.mapValue.fields.__previous_value__;return Hd(e)?Wd(e):e}function uo(t){const e=dr(t.mapValue.fields.__local_write_time__.timestampValue);return new Ve(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $k{constructor(){this.sessionToken=We.EMPTY_BYTE_STRING}getSessionToken(e){return L.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,L.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="WebChannelConnection";class c1 extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+n.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(n,r,i,s,o){const l=gc(),u=this.xo(n,r.toUriEncodedString());q("RestConnection",`Sending RPC '${n}' ${l}:`,u,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,s,o),this.No(n,u,h,i).then(f=>(q("RestConnection",`Received RPC '${n}' ${l}: `,f),f),f=>{throw Oi("RestConnection",`RPC '${n}' ${l} failed with error: `,f,"url: ",u,"request:",i),f})}Lo(n,r,i,s,o,l){return this.Mo(n,r,i,s,o)}Oo(n,r,i){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ki}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,o)=>n[o]=s),i&&i.headers.forEach((s,o)=>n[o]=s)}xo(n,r){const i=l1[n];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,n,r,i){const s=gc();return new Promise((o,l)=>{const u=new Y_;u.setWithCredentials(!0),u.listenOnce(X_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Ma.NO_ERROR:const f=u.getResponseJson();q(Je,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(f)),o(f);break;case Ma.TIMEOUT:q(Je,`RPC '${e}' ${s} timed out`),l(new $(V.DEADLINE_EXCEEDED,"Request time out"));break;case Ma.HTTP_ERROR:const y=u.getStatus();if(q(Je,`RPC '${e}' ${s} failed with status:`,y,"response text:",u.getResponseText()),y>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const k=v==null?void 0:v.error;if(k&&k.status&&k.message){const R=function(O){const I=O.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(I)>=0?I:V.UNKNOWN}(k.status);l(new $(R,k.message))}else l(new $(V.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new $(V.UNAVAILABLE,"Connection failed."));break;default:G()}}finally{q(Je,`RPC '${e}' ${s} completed.`)}});const h=JSON.stringify(i);q(Je,`RPC '${e}' ${s} sending request:`,i),u.send(n,"POST",h,r,15)})}Bo(e,n,r){const i=gc(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=ew(),l=Z_(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const f=s.join("");q(Je,`Creating RPC '${e}' stream ${i}: ${f}`,u);const y=o.createWebChannel(f,u);let v=!1,k=!1;const R=new u1({Io:O=>{k?q(Je,`Not sending because RPC '${e}' stream ${i} is closed:`,O):(v||(q(Je,`Opening RPC '${e}' stream ${i} transport.`),y.open(),v=!0),q(Je,`RPC '${e}' stream ${i} sending:`,O),y.send(O))},To:()=>y.close()}),P=(O,I,E)=>{O.listen(I,A=>{try{E(A)}catch(b){setTimeout(()=>{throw b},0)}})};return P(y,xs.EventType.OPEN,()=>{k||(q(Je,`RPC '${e}' stream ${i} transport opened.`),R.yo())}),P(y,xs.EventType.CLOSE,()=>{k||(k=!0,q(Je,`RPC '${e}' stream ${i} transport closed`),R.So())}),P(y,xs.EventType.ERROR,O=>{k||(k=!0,Oi(Je,`RPC '${e}' stream ${i} transport errored:`,O),R.So(new $(V.UNAVAILABLE,"The operation could not be completed")))}),P(y,xs.EventType.MESSAGE,O=>{var I;if(!k){const E=O.data[0];ue(!!E);const A=E,b=A.error||((I=A[0])===null||I===void 0?void 0:I.error);if(b){q(Je,`RPC '${e}' stream ${i} received error:`,b);const F=b.status;let M=function(w){const T=Re[w];if(T!==void 0)return xw(T)}(F),_=b.message;M===void 0&&(M=V.INTERNAL,_="Unknown error status: "+F+" with message "+b.message),k=!0,R.So(new $(M,_)),y.close()}else q(Je,`RPC '${e}' stream ${i} received:`,E),R.bo(E)}}),P(l,J_.STAT_EVENT,O=>{O.stat===xh.PROXY?q(Je,`RPC '${e}' stream ${i} detected buffering proxy`):O.stat===xh.NOPROXY&&q(Je,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{R.wo()},0),R}}function yc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class m1{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(o=>{r.enqueueAndForget(async()=>{Qr(this)&&(q("RemoteStore","Restarting streams for network reachability change."),await async function(u){const h=Z(u);h.L_.add(4),await No(h),h.q_.set("Unknown"),h.L_.delete(4),await iu(h)}(this))})}),this.q_=new p1(r,i)}}async function iu(t){if(Qr(t))for(const e of t.B_)await e(!0)}async function No(t){for(const e of t.B_)await e(!1)}function Fw(t,e){const n=Z(t);n.N_.has(e.targetId)||(n.N_.set(e.targetId,e),lf(n)?af(n):Xi(n).r_()&&of(n,e))}function sf(t,e){const n=Z(t),r=Xi(n);n.N_.delete(e),r.r_()&&Uw(n,e),n.N_.size===0&&(r.r_()?r.o_():Qr(n)&&n.q_.set("Unknown"))}function of(t,e){if(t.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(J.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}Xi(t).A_(e)}function Uw(t,e){t.Q_.xe(e),Xi(t).R_(e)}function af(t){t.Q_=new gk({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>t.N_.get(e)||null,tt:()=>t.datastore.serializer.databaseId}),Xi(t).start(),t.q_.v_()}function lf(t){return Qr(t)&&!Xi(t).n_()&&t.N_.size>0}function Qr(t){return Z(t).L_.size===0}function Bw(t){t.Q_=void 0}async function g1(t){t.q_.set("Online")}async function y1(t){t.N_.forEach((e,n)=>{of(t,e)})}async function v1(t,e){Bw(t),lf(t)?(t.q_.M_(e),af(t)):t.q_.set("Unknown")}async function _1(t,e,n){if(t.q_.set("Online"),e instanceof kw&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const l of s.targetIds)i.N_.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.N_.delete(l),i.Q_.removeTarget(l))}(t,e)}catch(r){q("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Il(t,r)}else if(e instanceof Ua?t.Q_.Ke(e):e instanceof Aw?t.Q_.He(e):t.Q_.We(e),!n.isEqual(J.min()))try{const r=await Lw(t.localStore);n.compareTo(r)>=0&&await function(s,o){const l=s.Q_.rt(o);return l.targetChanges.forEach((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.N_.get(h);f&&s.N_.set(h,f.withResumeToken(u.resumeToken,o))}}),l.targetMismatches.forEach((u,h)=>{const f=s.N_.get(u);if(!f)return;s.N_.set(u,f.withResumeToken(We.EMPTY_BYTE_STRING,f.snapshotVersion)),Uw(s,u);const y=new Gn(f.target,u,h,f.sequenceNumber);of(s,y)}),s.remoteSyncer.applyRemoteEvent(l)}(t,n)}catch(r){q("RemoteStore","Failed to raise snapshot:",r),await Il(t,r)}}async function Il(t,e,n){if(!Co(e))throw e;t.L_.add(1),await No(t),t.q_.set("Offline"),n||(n=()=>Lw(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{q("RemoteStore","Retrying IndexedDB access"),await n(),t.L_.delete(1),await iu(t)})}function zw(t,e){return e().catch(n=>Il(t,n,e))}async function su(t){const e=Z(t),n=fr(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;w1(e);)try{const i=await r1(e.localStore,r);if(i===null){e.O_.length===0&&n.o_();break}r=i.batchId,E1(e,i)}catch(i){await Il(e,i)}$w(e)&&qw(e)}function w1(t){return Qr(t)&&t.O_.length<10}function E1(t,e){t.O_.push(e);const n=fr(t);n.r_()&&n.V_&&n.m_(e.mutations)}function $w(t){return Qr(t)&&!fr(t).n_()&&t.O_.length>0}function qw(t){fr(t).start()}async function T1(t){fr(t).p_()}async function I1(t){const e=fr(t);for(const n of t.O_)e.m_(n.mutations)}async function S1(t,e,n){const r=t.O_.shift(),i=Jd.from(r,e,n);await zw(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await su(t)}async function x1(t,e){e&&fr(t).V_&&await async function(r,i){if(function(o){return fk(o)&&o!==V.ABORTED}(i.code)){const s=r.O_.shift();fr(r).s_(),await zw(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await su(r)}}(t,e),$w(t)&&qw(t)}async function bg(t,e){const n=Z(t);n.asyncQueue.verifyOperationInProgress(),q("RemoteStore","RemoteStore received new credentials");const r=Qr(n);n.L_.add(3),await No(n),r&&n.q_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.L_.delete(3),await iu(n)}async function A1(t,e){const n=Z(t);e?(n.L_.delete(2),await iu(n)):e||(n.L_.add(2),await No(n),n.q_.set("Unknown"))}function Xi(t){return t.K_||(t.K_=function(n,r,i){const s=Z(n);return s.w_(),new h1(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{Eo:g1.bind(null,t),Ro:y1.bind(null,t),mo:v1.bind(null,t),d_:_1.bind(null,t)}),t.B_.push(async e=>{e?(t.K_.s_(),lf(t)?af(t):t.q_.set("Unknown")):(await t.K_.stop(),Bw(t))})),t.K_}function fr(t){return t.U_||(t.U_=function(n,r,i){const s=Z(n);return s.w_(),new d1(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(t.datastore,t.asyncQueue,{Eo:()=>Promise.resolve(),Ro:T1.bind(null,t),mo:x1.bind(null,t),f_:I1.bind(null,t),g_:S1.bind(null,t)}),t.B_.push(async e=>{e?(t.U_.s_(),await su(t)):(await t.U_.stop(),t.O_.length>0&&(q("RemoteStore",`Stopping write stream with ${t.O_.length} pending writes`),t.O_=[]))})),t.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $a(t,e,n){return`firebase:${t}:${e}:${n}`}class xi{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=$a(this.userKey,i.apiKey,s),this.fullPersistenceKey=$a("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?_n._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new xi(wn(Xg),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||wn(Xg);const o=$a(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const y=_n._fromJSON(e,f);h!==s&&(l=y),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new xi(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new xi(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z0(t,e=[]){let n;switch(t){case"Browser":n=Jg(rt());break;case"Worker":n=`${Jg(rt())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Wi}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tR(t,e,n=!1){const{auth:r}=t;if(yn(r.app))return Promise.reject(lr(r));const i="reauthenticate";try{const s=await vo(t,W0(r,i,e,t),n);Q(s.idToken,r,"internal-error");const o=Rf(s.idToken);Q(o,r,"internal-error");const{sub:l}=o;return Q(t.uid===l,r,"user-mismatch"),pr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Nn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qR=new Do(5e3,15e3),HR="__/auth/iframe",WR="emulator/auth/iframe",KR={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},QR=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function GR(t){const e=t.config;Q(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Cf(e,WR):`https://${t.config.authDomain}/${HR}`,r={apiKey:e.apiKey,appName:t.name,v:Wi},i=QR.get(t.config.apiHost);i&&(r.eid=i);const s=t._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Ao(r).slice(1)}`}async function YR(t){const e=await $R(t),n=tn().gapi;return Q(n,t,"internal-error"),e.open({where:document.body,url:GR(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:KR,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=en(t,"network-request-failed"),l=tn().setTimeout(()=>{s(o)},qR.get());function u(){tn().clearTimeout(l),i(r)}r.ping(u).then(u,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iP="__/auth/handler",sP="emulator/auth/handler",oP=encodeURIComponent("fac");async function ay(t,e,n,r,i,s){Q(t.config.authDomain,t,"auth-domain-config-required"),Q(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Wi,eventId:i};if(e instanceof H0){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",ox(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,y]of Object.entries({}))o[f]=y}if(e instanceof Oo){const f=e.getScopes().filter(y=>y!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${oP}=${encodeURIComponent(u)}`:"";return`${aP(t)}?${Ao(l).slice(1)}${h}`}function aP({config:t}){return t.emulator?Cf(t,sP):`https://${t.authDomain}/${iP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wE="installations",ZP="installations-internal",eN=t=>{const e=t.getProvider("app").getImmediate(),n=JP(e),r=Hi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},tN=t=>{const e=t.getProvider("app").getImmediate(),n=Hi(e,wE).getImmediate();return{getId:()=>GP(n),getToken:i=>YP(n,i)}};function nN(){nn(new zt(wE,eN,"PUBLIC")),nn(new zt(ZP,tN,"PRIVATE"))}nN();Pt(rE,Of);Pt(rE,Of,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UN(t=zd()){return kE().then(e=>{if(!e)throw ct.create("unsupported-browser")},e=>{throw ct.create("indexed-db-unsupported")}),Hi(it(t),"messaging").getImmediate()}async function BN(t,e){return t=it(t),AE(t,e)}FN();const zN={apiKey:"AIzaSyACbnHcH9OPbZurDjWf8m1cazFOSSadYKE",authDomain:"deungbul-qt.firebaseapp.com",projectId:"deungbul-qt",storageBucket:"deungbul-qt.firebasestorage.app",messagingSenderId:"1048157032708",appId:"1:1048157032708:web:46aab740a361a9f5ebc051",measurementId:"G-GQXXJHHKL7"},$N="BCm1sLB19B--eH-e3FgGQhaxwZlWeoF7oA7Fa2V3FWZWE44quYgHDyugQNux5hIe7U7qhRSvRvLEERpojWaXqEo",Bf=W_(zN),Qt=eC(Bf),Hh=gP(Bf);let Ta=null;async function qN(){return Ta||(await kE().catch(()=>!1)?(Ta=UN(Bf),Ta):null)}function HN(t){sR(Hh,e=>{e?t(e):ZC(Hh).catch(n=>console.error("익명 로그인 실패",n))})}const Ia="qt_entries";function $s(t=new Date){const e=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${e}-${n}-${r}`}function WN(){const[t,e]=H.useState({}),[n,r]=H.useState(!0);H.useEffect(()=>{const l=m0(o0(Qt,Ia),g0("date","desc"));return E0(l,h=>{const f={};h.forEach(y=>{f[y.id]=y.data()}),e(f),r(!1)},h=>{console.error("entries 구독 실패",h),r(!1)})},[]);const i=H.useCallback(async(l,u)=>{const h=ar(Qt,Ia,l);await yo(h,{date:l,...u,writtenAt:Kg()},{merge:!0})},[]),s=H.useCallback(async(l,u,h)=>{const f=ar(Qt,Ia,l);await yo(f,{date:l,checked:u,comment:h??"",checkedAt:Kg()},{merge:!0})},[]),o=H.useCallback(async l=>{const u=ar(Qt,Ia,l);await w0(u)},[]);return{entries:t,loading:n,saveEntry:i,setCheck:s,deleteEntry:o}}const KN=["일","월","화","수","목","금","토"];function QN({entries:t,onSelectDate:e}){const[n,r]=H.useState(new Date),i=n.getFullYear(),s=n.getMonth(),l=new Date(i,s,1).getDay(),u=new Date(i,s+1,0).getDate(),h=$s(),f=[];for(let v=0;v<l;v++)f.push(null);for(let v=1;v<=u;v++)f.push(v);const y=v=>{r(new Date(i,s+v,1))};return m.jsxs("div",{className:"px-4 pt-4",children:[m.jsxs("div",{className:"flex items-center justify-between mb-4",children:[m.jsx("button",{onClick:()=>y(-1),className:"text-faint text-xl px-3 py-1",children:"‹"}),m.jsxs("h2",{className:"font-display text-lg",children:[i,"년 ",s+1,"월"]}),m.jsx("button",{onClick:()=>y(1),className:"text-faint text-xl px-3 py-1",children:"›"})]}),m.jsx("div",{className:"grid grid-cols-7 gap-1 mb-2",children:KN.map(v=>m.jsx("div",{className:"text-center text-xs text-faint py-1",children:v},v))}),m.jsx("div",{className:"grid grid-cols-7 gap-1",children:f.map((v,k)=>{var M,_,p,w;if(v===null)return m.jsx("div",{},`empty-${k}`);const R=`${i}-${String(s+1).padStart(2,"0")}-${String(v).padStart(2,"0")}`,P=t[R],O=Array.isArray(P==null?void 0:P.checkQuestions)?P.checkQuestions.some(T=>{var x,C;return((x=T.question)==null?void 0:x.trim())||((C=T.answer)==null?void 0:C.trim())}):!1,I=Array.isArray(P==null?void 0:P.passageQA)?P.passageQA.some(T=>{var x;return(x=T.answer)==null?void 0:x.trim()}):!1,E=Array.isArray(P==null?void 0:P.groupQA)?P.groupQA.some(T=>{var x;return(x=T.answer)==null?void 0:x.trim()}):!1,A=!!((M=P==null?void 0:P.passage)!=null&&M.trim()||(_=P==null?void 0:P.content)!=null&&_.trim()||(p=P==null?void 0:P.application)!=null&&p.trim()||(w=P==null?void 0:P.prayer)!=null&&w.trim()||O||I||E),b=!!(P!=null&&P.checked),F=R===h;return m.jsxs("button",{onClick:()=>e(R),className:"flex flex-col items-center gap-0.5 py-1",children:[m.jsx("div",{className:["lamp-dot",b?"is-checked":A?"is-written":""].join(" "),style:F?{outline:"2px solid rgba(247,241,226,0.6)",outlineOffset:"2px"}:{},children:b&&m.jsx("span",{className:"rabbit-icon",children:"🐇"})}),m.jsx("span",{className:`text-[10px] ${F?"text-paper font-semibold":"text-faint"}`,children:v})]},R)})}),m.jsxs("div",{className:"flex gap-5 mt-6 text-xs text-faint justify-center pb-2",children:[m.jsxs("div",{className:"flex items-center gap-2",children:[m.jsx("div",{style:{width:18,height:18,borderRadius:"50%",border:"1.5px solid #D9CFB8"}}),m.jsx("span",{children:"미작성"})]}),m.jsxs("div",{className:"flex items-center gap-2",children:[m.jsx("div",{style:{width:18,height:18,borderRadius:"50%",background:"radial-gradient(circle, #fff5c0 0%, #E8A33D 60%, #F2C879 100%)",boxShadow:"0 0 8px 2px rgba(232,163,61,0.5)"}}),m.jsx("span",{children:"보름달 (작성)"})]}),m.jsxs("div",{className:"flex items-center gap-2",children:[m.jsx("div",{style:{width:22,height:22,borderRadius:"50%",background:"radial-gradient(circle, #fff5c0 0%, #E8A33D 60%, #F2C879 100%)",boxShadow:"0 0 8px 2px rgba(232,163,61,0.5)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13},children:m.jsx("span",{style:{filter:"brightness(0) saturate(100%)"},children:"🐇"})}),m.jsx("span",{children:"코디네이터 확인"})]})]})]})}const Ac="units";function CE(){const[t,e]=H.useState([]),[n,r]=H.useState(!0);H.useEffect(()=>{const o=m0(o0(Qt,Ac),g0("startDate","asc"));return E0(o,u=>{const h=[];u.forEach(f=>h.push({id:f.id,...f.data()})),e(h),r(!1)},u=>{console.error("units 구독 실패",u),r(!1)})},[]);const i=H.useCallback(async(o,l)=>{const u=ar(Qt,Ac,o);await yo(u,l,{merge:!1})},[]),s=H.useCallback(async o=>{await w0(ar(Qt,Ac,o))},[]);return{units:t,loading:n,saveUnit:i,deleteUnit:s}}function RE(t,e){const n=new Date(e+"T00:00:00"),r=n.getDay();if(r===0)return null;for(const i of t){if(!i.startDate||!Array.isArray(i.days))continue;const s=new Date(i.startDate+"T00:00:00"),o=Math.floor((n-s)/864e5);if(o<0)continue;const l=Math.floor(o/7);if(r===6){if(l===0)return{unitId:i.id,unitTitle:i.title,dayIndex:-1,isSaturdaySharing:!0,title:"코디네이터(소그룹)와의 나눔",sections:[],groupQuestions:i.groupQuestions??[]};continue}const u=r-1;if(l===0&&u>=0&&u<i.days.length)return{unitId:i.id,unitTitle:i.title,dayIndex:u,isSaturdaySharing:!1,...i.days[u],groupQuestions:i.groupQuestions??[]}}return null}function _y(){return Math.random().toString(36).slice(2,9)}function wy(t){if(!t)return[];if(Array.isArray(t.sections)&&t.sections.length>0)return t.sections;const e=Array.isArray(t.reflectionQuestions)?t.reflectionQuestions:[],n=[];return t.body&&n.push({type:"body",body:t.body,question:null}),e.forEach(r=>{n.push({type:"reflection",body:null,question:r})}),n}function GN({dateKey:t,entry:e,units:n,onSave:r,onDelete:i,onClose:s}){var C,S;const o=RE(n??[],t),l=(o==null?void 0:o.isSaturdaySharing)===!0,[u,h]=H.useState("view"),[f,y]=H.useState([]),[v,k]=H.useState([]),[R,P]=H.useState(""),[O,I]=H.useState(!1),[E,A]=H.useState(!1),b=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA.some(Y=>{var se;return(se=Y.answer)==null?void 0:se.trim()}):!1,F=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA.some(Y=>{var se;return(se=Y.answer)==null?void 0:se.trim()}):!1,M=!!(b||F||(C=e==null?void 0:e.groupSummary)!=null&&C.trim()||(S=e==null?void 0:e.groupSharing)!=null&&S.trim());H.useEffect(()=>{if(h(M?"view":"edit"),A(!1),P((e==null?void 0:e.groupSummary)??""),o){const Y=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA:[];if(k((o.groupQuestions??[]).map((se,be)=>{var Ce,B;return{id:((Ce=Y[be])==null?void 0:Ce.id)??_y(),question:se,answer:((B=Y[be])==null?void 0:B.answer)??""}})),l)y([]);else{const se=wy(o),be=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[];y(se.map((Ce,B)=>{var K,X;return{id:((K=be[B])==null?void 0:K.id)??_y(),question:Ce.question??"",answer:((X=be[B])==null?void 0:X.answer)??""}}))}}else y([]),k([])},[t,e]);const _=async()=>{O||(I(!0),await r(t,{passage:(o==null?void 0:o.title)??"",content:o?`${o.unitTitle} - ${o.title}`:"",sectionQA:f,groupQA:v,groupSummary:R}),I(!1),s())},p=async()=>{if(!E){A(!0);return}I(!0),await i(t),I(!1),s()},w=(e==null?void 0:e.checked)||(e==null?void 0:e.comment),T=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[];Array.isArray(e==null?void 0:e.groupQA)&&e.groupQA;const x=!l&&o?wy(o):[];return l?m.jsxs("div",{className:"px-5 pb-10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[m.jsx("button",{onClick:s,className:"text-faint",children:"‹ 닫기"}),m.jsx("h2",{className:"font-display text-base",children:t}),m.jsx("div",{className:"w-10"})]}),m.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl px-4 py-3 bg-sage/5",children:[m.jsx("p",{className:"text-xs text-sage mb-0.5",children:o.unitTitle}),m.jsx("p",{className:"font-display text-base text-sage",children:"코디네이터(소그룹)와의 나눔"})]}),u==="view"?m.jsxs(m.Fragment,{children:[v.length>0&&m.jsxs("div",{className:"mb-6",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*개인이 생각할 질문"}),m.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"다음의 질문들은 이미 2단원을 공부하면서 생각했던 질문들입니다. 다시 한 번 질문들을 생각하시며 정리해보십시오."}),m.jsx("div",{className:"flex flex-col gap-3",children:v.map((Y,se)=>m.jsxs("div",{className:"border border-sage/30 rounded-xl p-3 bg-sage/5",children:[m.jsxs("p",{className:"text-paper text-sm font-semibold mb-1",children:[se+1,". ",Y.question]}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Y.answer||"-"})]},Y.id??se))})]}),m.jsxs("div",{className:"mb-6",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)와 나눌 생각 정리하기"}),m.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"잠언 1장 1절에서 7절을 읽을 때 다가온 구절(lexio)을 쪽지에 적었을텐데, 그 쪽지묵상 말씀과 함께 몇 번이나 읽으며 묵상했는지, 또한 깨달은 것은 무엇인지를 적고 동시에 내가 대답한 기도(oratio)를 정리하십시오."}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:(e==null?void 0:e.groupSummary)||"-"})]}),m.jsxs("div",{className:"mb-6 border border-sage/20 rounded-xl p-3 bg-sage/5",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)에서 나누기"}),m.jsx("p",{className:"text-xs text-faint/70",children:"정리된 생각을 코디네이터에게 먼저 얘기하고 나누는 시간을 가지십시오."})]}),w&&m.jsxs("div",{className:"mt-2 mb-6 border border-sage/50 rounded-xl p-4 bg-sage/10",children:[m.jsx("p",{className:"text-sage text-sm font-semibold mb-1",children:e!=null&&e.checked?"코디네이터가 확인했어요 🐇":"코디네이터 코멘트"}),(e==null?void 0:e.comment)&&m.jsx("p",{className:"text-paper text-sm leading-relaxed",children:e.comment})]}),m.jsx("button",{onClick:()=>h("edit"),className:"w-full border border-sage text-sage font-semibold py-4 rounded-2xl mb-3",children:"수정하기"}),E?m.jsxs("div",{className:"border border-red-400/40 rounded-xl p-4 text-center",children:[m.jsx("p",{className:"text-sm text-paper mb-3",children:"정말 삭제할까요? 되돌릴 수 없어요."}),m.jsxs("div",{className:"flex gap-2",children:[m.jsx("button",{onClick:()=>A(!1),className:"flex-1 border border-faint text-faint py-2 rounded-xl text-sm",children:"취소"}),m.jsx("button",{onClick:p,disabled:O,className:"flex-1 bg-red-400/80 text-nightDeep py-2 rounded-xl text-sm font-semibold disabled:opacity-60",children:O?"삭제 중...":"삭제하기"})]})]}):m.jsx("button",{onClick:p,className:"w-full text-faint text-sm py-2",children:"이 날짜 기록 삭제"})]}):m.jsxs(m.Fragment,{children:[v.length>0&&m.jsxs("div",{className:"mb-6",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*개인이 생각할 질문"}),m.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"다음의 질문들은 이미 2단원을 공부하면서 생각했던 질문들입니다. 다시 한 번 질문들을 생각하시며 정리해보십시오."}),m.jsx("div",{className:"flex flex-col gap-3",children:v.map((Y,se)=>m.jsxs("div",{className:"border border-sage/30 rounded-xl p-3 bg-sage/5",children:[m.jsxs("p",{className:"text-paper text-sm font-semibold mb-2",children:[se+1,". ",Y.question]}),m.jsx("textarea",{value:Y.answer,onChange:be=>{const Ce=[...v];Ce[se]={...Ce[se],answer:be.target.value},k(Ce)},rows:3,placeholder:"답변을 적어주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]},Y.id))})]}),m.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl p-4 bg-sage/5",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)와 나눌 생각 정리하기"}),m.jsx("p",{className:"text-xs text-faint/70 mb-3",children:"잠언 1장 1절에서 7절을 읽을 때 다가온 구절(lexio)을 쪽지에 적었을텐데, 그 쪽지묵상 말씀과 함께 몇 번이나 읽으며 묵상했는지, 또한 깨달은 것은 무엇인지를 적고 동시에 내가 대답한 기도(oratio)를 정리하십시오."}),m.jsx("textarea",{value:R,onChange:Y=>P(Y.target.value),rows:6,placeholder:"깨닫게 된 것을 정리하고 나눔 후 느낀 점도 함께 적어두세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]}),m.jsxs("div",{className:"mb-6 border border-sage/20 rounded-xl p-3 bg-sage/5",children:[m.jsx("p",{className:"text-xs text-sage font-semibold mb-1",children:"*코디네이터(소그룹)에서 나누기"}),m.jsx("p",{className:"text-xs text-faint/70",children:"정리된 생각을 코디네이터에게 먼저 얘기하고 나누는 시간을 가지십시오."})]}),m.jsxs("div",{className:"flex gap-3",children:[M&&m.jsx("button",{onClick:()=>h("view"),className:"flex-1 border border-faint text-faint font-semibold py-4 rounded-2xl",children:"취소"}),m.jsx("button",{onClick:_,disabled:O,className:"flex-1 bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:O?"저장 중...":"저장하기"})]})]})]}):m.jsxs("div",{className:"px-5 pb-10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[m.jsx("button",{onClick:s,className:"text-faint",children:"‹ 닫기"}),m.jsx("h2",{className:"font-display text-base",children:t}),m.jsx("div",{className:"w-10"})]}),o?m.jsxs("div",{className:"mb-4 border border-lamp/30 rounded-xl px-4 py-3 bg-lamp/5",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-0.5",children:o.unitTitle}),m.jsx("p",{className:"font-display text-base text-lamp",children:o.title})]}):m.jsx("div",{className:"mb-6 border border-faint/30 rounded-xl p-4 text-center text-faint text-sm",children:"이 날짜에는 등록된 본문이 없어요 (주말이거나 단원 범위 밖)"}),u==="view"?m.jsxs(m.Fragment,{children:[x.map((Y,se)=>{var be;return m.jsxs("div",{children:[Y.body&&m.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Y.body})}),Y.question&&m.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),m.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:Y.question}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:((be=T[se])==null?void 0:be.answer)||"-"})]})]},se)}),w&&m.jsxs("div",{className:"mt-2 mb-6 border border-sage/50 rounded-xl p-4 bg-sage/10",children:[m.jsx("p",{className:"text-sage text-sm font-semibold mb-1",children:e!=null&&e.checked?"코디네이터가 확인했어요 🐇":"코디네이터 코멘트"}),(e==null?void 0:e.comment)&&m.jsx("p",{className:"text-paper text-sm leading-relaxed",children:e.comment})]}),m.jsx("button",{onClick:()=>h("edit"),className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-3",children:"수정하기"}),E?m.jsxs("div",{className:"border border-red-400/40 rounded-xl p-4 text-center",children:[m.jsx("p",{className:"text-sm text-paper mb-3",children:"정말 삭제할까요? 되돌릴 수 없어요."}),m.jsxs("div",{className:"flex gap-2",children:[m.jsx("button",{onClick:()=>A(!1),className:"flex-1 border border-faint text-faint py-2 rounded-xl text-sm",children:"취소"}),m.jsx("button",{onClick:p,disabled:O,className:"flex-1 bg-red-400/80 text-nightDeep py-2 rounded-xl text-sm font-semibold disabled:opacity-60",children:O?"삭제 중...":"삭제하기"})]})]}):m.jsx("button",{onClick:p,className:"w-full text-faint text-sm py-2",children:"이 날짜 기록 삭제"})]}):m.jsxs(m.Fragment,{children:[x.map((Y,se)=>{var be;return m.jsxs("div",{children:[Y.body&&m.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:Y.body})}),Y.question&&m.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),m.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:Y.question}),m.jsx("textarea",{value:((be=f[se])==null?void 0:be.answer)??"",onChange:Ce=>{const B=[...f];B[se]={...B[se],answer:Ce.target.value},y(B)},rows:3,placeholder:"답변을 적어주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"})]})]},se)}),m.jsxs("div",{className:"flex gap-3",children:[M&&m.jsx("button",{onClick:()=>h("view"),className:"flex-1 border border-faint text-faint font-semibold py-4 rounded-2xl",children:"취소"}),m.jsx("button",{onClick:_,disabled:O,className:"flex-1 bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:O?"저장 중...":"저장하기"})]})]})]})}function YN({dateKey:t,entry:e,units:n,onCheck:r,onClose:i}){var O;const s=RE(n??[],t),[o,l]=H.useState(""),[u,h]=H.useState(!1);H.useEffect(()=>{l((e==null?void 0:e.comment)??"")},[t,e]);const f=Array.isArray(s==null?void 0:s.sections)?s.sections:[],y=Array.isArray(e==null?void 0:e.sectionQA)?e.sectionQA:[],v=Array.isArray(e==null?void 0:e.groupQA)?e.groupQA:[],k=!!(y.some(I=>{var E;return(E=I.answer)==null?void 0:E.trim()})||v.some(I=>{var E;return(E=I.answer)==null?void 0:E.trim()})||(O=e==null?void 0:e.groupSummary)!=null&&O.trim()),R=async()=>{h(!0),await r(t,!(e!=null&&e.checked),o),h(!1),e!=null&&e.checked||i()},P=async()=>{await r(t,(e==null?void 0:e.checked)??!1,o)};return m.jsxs("div",{className:"px-5 pb-10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[m.jsx("button",{onClick:i,className:"text-faint",children:"‹ 닫기"}),m.jsx("h2",{className:"font-display text-base",children:t}),m.jsx("div",{className:"w-10"})]}),s&&m.jsxs("div",{className:"mb-4 border border-lamp/30 rounded-xl px-4 py-3 bg-lamp/5",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-0.5",children:s.unitTitle}),m.jsx("p",{className:"font-display text-base text-lamp",children:s.title})]}),k?m.jsxs(m.Fragment,{children:[f.map((I,E)=>{var A;return m.jsxs("div",{children:[m.jsx("div",{className:"mb-4 border border-lamp/20 rounded-xl p-4 bg-lamp/5",children:m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:I.body})}),I.question&&m.jsxs("div",{className:"mb-5 border border-faint/40 rounded-xl p-3",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-1",children:"묵상 질문"}),m.jsx("p",{className:"text-paper text-sm font-semibold mb-2",children:I.question}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:((A=y[E])==null?void 0:A.answer)||"-"})]})]},E)}),v.length>0&&m.jsxs("div",{className:"mb-5",children:[m.jsx("p",{className:"text-xs text-sage mb-2",children:"코디네이터(소그룹)와의 나눔 — 개인 생각 질문"}),m.jsx("div",{className:"flex flex-col gap-3",children:v.map((I,E)=>m.jsxs("div",{className:"border border-sage/40 rounded-xl p-3 bg-sage/5",children:[m.jsx("p",{className:"text-paper text-sm font-semibold mb-1",children:I.question}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:I.answer||"-"})]},I.id??E))})]}),(e==null?void 0:e.groupSummary)&&m.jsxs("div",{className:"mb-5 border border-sage/40 rounded-xl p-3 bg-sage/5",children:[m.jsx("p",{className:"text-xs text-sage mb-1",children:"코디네이터와 나눌 내용 정리"}),m.jsx("p",{className:"text-paper text-sm leading-relaxed whitespace-pre-wrap",children:e.groupSummary})]}),m.jsxs("div",{className:"mb-5",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"피드백 코멘트"}),m.jsx("textarea",{value:o,onChange:I=>l(I.target.value),onBlur:P,rows:4,placeholder:"피드백이나 격려를 남겨주세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"})]}),m.jsx("button",{onClick:R,disabled:u,className:`w-full font-semibold py-4 rounded-2xl transition-colors disabled:opacity-60 ${e!=null&&e.checked?"bg-transparent border border-sage text-sage":"bg-sage text-nightDeep"}`,children:u?"처리 중...":e!=null&&e.checked?"확인 취소하기":"확인했어요 🐇"})]}):m.jsx("div",{className:"text-center text-faint py-16",children:m.jsx("p",{children:"아직 작성되지 않았어요."})})]})}function XN({role:t}){const[e,n]=H.useState(t==="writer"?{time:"23:00"}:{mode:"off",time:"21:00",intervalDays:3}),[r,i]=H.useState("idle"),[s,o]=H.useState(!1);H.useEffect(()=>{const h=ar(Qt,"settings",t);gC(h).then(f=>{f.exists()&&n(y=>({...y,...f.data()}))})},[t]);const l=async()=>{await yo(ar(Qt,"settings",t),e,{merge:!0}),o(!0),setTimeout(()=>o(!1),1500)},u=async()=>{var h;try{if(await Notification.requestPermission()!=="granted"){i("denied");return}const y=await qN();if(!y){i("unsupported");return}const v=await navigator.serviceWorker.ready,k=await BN(y,{vapidKey:$N,serviceWorkerRegistration:v});k&&(await yo(ar(Qt,"fcm_tokens",t),{token:k,updatedAt:Date.now(),uid:((h=Hh.currentUser)==null?void 0:h.uid)??null},{merge:!0}),i("granted"))}catch(f){console.error("알림 등록 실패",f),i("unsupported")}};return m.jsxs("div",{className:"px-5 pb-10",children:[m.jsx("h2",{className:"font-display text-lg mb-6",children:"알림 설정"}),m.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 mb-6",children:[m.jsx("p",{className:"text-sm text-faint mb-3",children:"이 기기로 알림을 받으려면 먼저 푸시 권한을 허용해 주세요. (아이폰은 홈 화면에 추가한 뒤에만 동작해요)"}),m.jsx("button",{onClick:u,className:"w-full bg-lamp text-nightDeep font-semibold py-3 rounded-xl",children:r==="granted"?"알림 켜짐 ✓":"이 기기에서 알림 받기"}),r==="denied"&&m.jsx("p",{className:"text-xs text-red-300 mt-2",children:"알림이 거부되어 있어요. 기기 설정에서 허용해 주세요."}),r==="unsupported"&&m.jsx("p",{className:"text-xs text-red-300 mt-2",children:"이 브라우저/상태에서는 푸시가 지원되지 않아요. 홈 화면에 추가한 뒤 다시 시도해 주세요."})]}),t==="writer"?m.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"매일 알림 시간"}),m.jsx("input",{type:"time",value:e.time,onChange:h=>n({...e,time:h.target.value}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"}),m.jsx("p",{className:"text-xs text-faint mt-3",children:"작성자는 매일 같은 시간에 알림을 받아요."})]}):m.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 flex flex-col gap-4",children:[m.jsxs("div",{children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"알림 방식"}),m.jsx("div",{className:"flex gap-2",children:[{v:"off",label:"안 함"},{v:"daily",label:"매일"},{v:"interval",label:"N일마다"}].map(h=>m.jsx("button",{onClick:()=>n({...e,mode:h.v}),className:`flex-1 py-2 rounded-xl text-sm border ${e.mode===h.v?"bg-sage text-nightDeep border-sage":"border-faint/40 text-faint"}`,children:h.label},h.v))})]}),e.mode!=="off"&&m.jsxs("div",{children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"시간"}),m.jsx("input",{type:"time",value:e.time,onChange:h=>n({...e,time:h.target.value}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"})]}),e.mode==="interval"&&m.jsxs("div",{children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:"며칠마다"}),m.jsx("input",{type:"number",min:1,max:30,value:e.intervalDays,onChange:h=>n({...e,intervalDays:Number(h.target.value)}),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper w-24"}),m.jsx("span",{className:"text-faint text-sm ml-2",children:"일마다"})]})]}),m.jsx("button",{onClick:l,className:"w-full mt-6 bg-transparent border border-lamp text-lamp font-semibold py-3 rounded-xl",children:s?"저장됨":"설정 저장"})]})}function JN(t){var r;let e=0;const n=new Date;for(;;){const i=$s(n);if((r=t[i])!=null&&r.content)e+=1,n.setDate(n.getDate()-1);else break}return e}function ZN(t){var u,h;const e=new Date,n=e.getFullYear(),r=e.getMonth(),i=new Date(n,r+1,0).getDate(),s=e.getDate();let o=0,l=0;for(let f=1;f<=s;f++){const y=`${n}-${String(r+1).padStart(2,"0")}-${String(f).padStart(2,"0")}`;(u=t[y])!=null&&u.content&&(o+=1),(h=t[y])!=null&&h.checked&&(l+=1)}return{written:o,checked:l,total:i,soFar:s}}function eb({entries:t}){const e=JN(t),{written:n,checked:r,soFar:i}=ZN(t);return m.jsxs("div",{className:"px-5 pt-6 pb-10",children:[m.jsx("h2",{className:"font-display text-lg mb-6",children:"타고 있는 등불"}),m.jsxs("div",{className:"border border-faint/40 rounded-2xl p-6 mb-4 text-center",children:[m.jsx("p",{className:"text-5xl font-display text-lamp",children:e}),m.jsx("p",{className:"text-faint text-sm mt-1",children:"일째 연속 작성 중"})]}),m.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[m.jsx(Ey,{label:"이번 달 작성",value:`${n} / ${i}일`}),m.jsx(Ey,{label:"이번 달 확인",value:`${r} / ${i}일`})]})]})}function Ey({label:t,value:e}){return m.jsxs("div",{className:"border border-faint/40 rounded-2xl p-4 text-center",children:[m.jsx("p",{className:"text-paper text-lg font-display",children:e}),m.jsx("p",{className:"text-faint text-xs mt-1",children:t})]})}function tb(){return Math.random().toString(36).slice(2,9)}function Kt(){return{title:"",body:"",reflectionQuestions:[""]}}function nb(){return{title:"",startDate:"",days:[Kt(),Kt(),Kt(),Kt(),Kt()],groupQuestions:[""]}}function rb({onClose:t}){const{units:e,saveUnit:n,deleteUnit:r}=CE(),[i,s]=H.useState(null),[o,l]=H.useState(null),[u,h]=H.useState(!1),[f,y]=H.useState(null),v=H.useRef(),k=async R=>{var O;const P=(O=R.target.files)==null?void 0:O[0];if(P){h(!0),y(null);try{const I=await P.text(),E=JSON.parse(I),A=Array.isArray(E)?E:[E];for(const b of A){if(!b.id||!b.title||!b.startDate||!Array.isArray(b.days))throw new Error(`필수 필드(id, title, startDate, days) 누락: ${b.title||"?"}`);await n(b.id,{title:b.title,startDate:b.startDate,days:b.days,groupQuestions:b.groupQuestions??[]})}y({ok:!0,text:`${A.length}개 단원을 가져왔어요 ✓`})}catch(I){y({ok:!1,text:`오류: ${I.message}`})}finally{h(!1),R.target.value=""}}};return i?m.jsx(sb,{unit:i,onCancel:()=>s(null),onSaved:()=>s(null),saveUnit:n}):m.jsxs("div",{className:"px-5 pb-10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[m.jsx("button",{onClick:t,className:"text-faint",children:"‹ 닫기"}),m.jsx("h2",{className:"font-display text-base",children:"본문 관리"}),m.jsx("div",{className:"w-10"})]}),m.jsx("button",{onClick:()=>s({...nb(),id:"unit_"+tb()}),className:"w-full bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow mb-3",children:"+ 새 단원 추가"}),m.jsx("button",{onClick:()=>{var R;return(R=v.current)==null?void 0:R.click()},disabled:u,className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-2 disabled:opacity-60",children:u?"가져오는 중...":"📂 JSON으로 단원 가져오기"}),m.jsx("input",{ref:v,type:"file",accept:".json",className:"hidden",onChange:k}),f&&m.jsx("p",{className:`text-sm text-center mb-4 ${f.ok?"text-lamp":"text-red-400"}`,children:f.text}),e.length===0&&m.jsx("p",{className:"text-faint text-sm text-center py-8",children:"등록된 단원이 없어요."}),m.jsx("div",{className:"flex flex-col gap-3 mt-3",children:e.map(R=>m.jsxs("div",{className:"border border-faint/30 rounded-xl p-4",children:[m.jsx("p",{className:"text-paper font-semibold mb-1",children:R.title||"(제목 없음)"}),m.jsxs("p",{className:"text-faint text-xs mb-3",children:["시작일(월요일): ",R.startDate]}),m.jsxs("div",{className:"flex gap-2",children:[m.jsx("button",{onClick:()=>s(R),className:"flex-1 border border-lamp text-lamp text-sm py-2 rounded-xl",children:"수정"}),o===R.id?m.jsx("button",{onClick:async()=>{await r(R.id),l(null)},className:"flex-1 bg-red-400/80 text-nightDeep text-sm py-2 rounded-xl font-semibold",children:"정말 삭제"}):m.jsx("button",{onClick:()=>l(R.id),className:"flex-1 border border-faint text-faint text-sm py-2 rounded-xl",children:"삭제"})]})]},R.id))})]})}const ib=["월요일","화요일","수요일","목요일","금요일"];function sb({unit:t,onCancel:e,onSaved:n,saveUnit:r}){var M;const[i,s]=H.useState(t.title||""),[o,l]=H.useState(t.startDate||""),[u,h]=H.useState(t.days&&t.days.length===5?t.days.map(_=>{var p;return{title:_.title||"",body:_.body||"",reflectionQuestions:(p=_.reflectionQuestions)!=null&&p.length?_.reflectionQuestions:[""]}}):[Kt(),Kt(),Kt(),Kt(),Kt()]),[f,y]=H.useState((M=t.groupQuestions)!=null&&M.length?t.groupQuestions:[""]),[v,k]=H.useState(!1),R=(_,p,w)=>{h(T=>T.map((x,C)=>C===_?{...x,[p]:w}:x))},P=(_,p,w)=>{h(T=>T.map((x,C)=>{if(C!==_)return x;const S=[...x.reflectionQuestions];return S[p]=w,{...x,reflectionQuestions:S}}))},O=_=>{h(p=>p.map((w,T)=>T===_?{...w,reflectionQuestions:[...w.reflectionQuestions,""]}:w))},I=(_,p)=>{h(w=>w.map((T,x)=>x!==_||T.reflectionQuestions.length<=1?T:{...T,reflectionQuestions:T.reflectionQuestions.filter((C,S)=>S!==p)}))},E=(_,p)=>{y(w=>w.map((T,x)=>x===_?p:T))},A=()=>y(_=>[..._,""]),b=_=>{y(p=>p.length>1?p.filter((w,T)=>T!==_):p)},F=async()=>{if(!i.trim()||!o){alert("단원 제목과 시작일(월요일)을 입력해 주세요.");return}k(!0);const _={title:i.trim(),startDate:o,days:u.map(p=>({title:p.title.trim(),body:p.body,reflectionQuestions:p.reflectionQuestions.map(w=>w.trim()).filter(Boolean)})),groupQuestions:f.map(p=>p.trim()).filter(Boolean)};await r(t.id,_),k(!1),n()};return m.jsxs("div",{className:"px-5 pb-10",children:[m.jsxs("div",{className:"flex items-center justify-between mb-5 pt-6",children:[m.jsx("button",{onClick:e,className:"text-faint",children:"‹ 취소"}),m.jsx("h2",{className:"font-display text-base",children:"단원 편집"}),m.jsx("div",{className:"w-10"})]}),m.jsx(Sa,{label:"단원 제목",children:m.jsx("input",{value:i,onChange:_=>s(_.target.value),placeholder:"예) 2단원 ○○○",className:"w-full bg-transparent border-b border-faint pb-2 text-paper placeholder:text-faint/60 focus:outline-none focus:border-lamp"})}),m.jsx(Sa,{label:"시작일 (이 단원의 월요일)",children:m.jsx("input",{type:"date",value:o,onChange:_=>l(_.target.value),className:"bg-night/40 border border-faint/40 rounded-xl px-4 py-3 text-paper"})}),u.map((_,p)=>m.jsxs("div",{className:"mb-6 border border-faint/30 rounded-xl p-4",children:[m.jsxs("p",{className:"text-lamp text-sm font-semibold mb-3",children:[ib[p]," 본문"]}),m.jsx(Sa,{label:"본문 제목",children:m.jsx("input",{value:_.title,onChange:w=>R(p,"title",w.target.value),placeholder:"예) 01. 예수가 모르는 크리스천",className:"w-full bg-transparent border-b border-faint/50 pb-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp"})}),m.jsx(Sa,{label:"본문 내용",children:m.jsx("textarea",{value:_.body,onChange:w=>R(p,"body",w.target.value),rows:8,placeholder:"본문 전체 텍스트를 붙여넣으세요",className:"w-full bg-night/40 border border-faint/40 rounded-xl p-3 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"})}),m.jsxs("div",{className:"mb-2",children:[m.jsxs("div",{className:"flex items-center justify-between mb-2",children:[m.jsx("p",{className:"text-xs text-lampSoft",children:"묵상 질문"}),m.jsx("button",{onClick:()=>O(p),type:"button",className:"text-xs text-lamp border border-lamp/50 rounded-lg px-2 py-1",children:"+ 질문 추가"})]}),m.jsx("div",{className:"flex flex-col gap-2",children:_.reflectionQuestions.map((w,T)=>m.jsxs("div",{className:"flex gap-2 items-start",children:[m.jsx("textarea",{value:w,onChange:x=>P(p,T,x.target.value),rows:2,placeholder:`묵상질문 ${T+1}`,className:"flex-1 bg-night/40 border border-faint/40 rounded-xl p-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-lamp resize-none"}),_.reflectionQuestions.length>1&&m.jsx("button",{onClick:()=>I(p,T),type:"button",className:"text-xs text-faint underline mt-2",children:"삭제"})]},T))})]})]},p)),m.jsxs("div",{className:"mb-6 border border-sage/40 rounded-xl p-4 bg-sage/5",children:[m.jsxs("div",{className:"flex items-center justify-between mb-3",children:[m.jsx("p",{className:"text-sage text-sm font-semibold",children:"코디네이터(소그룹)와 나눔 질문"}),m.jsx("button",{onClick:A,type:"button",className:"text-xs text-sage border border-sage/50 rounded-lg px-2 py-1",children:"+ 질문 추가"})]}),m.jsx("div",{className:"flex flex-col gap-2",children:f.map((_,p)=>m.jsxs("div",{className:"flex gap-2 items-start",children:[m.jsx("textarea",{value:_,onChange:w=>E(p,w.target.value),rows:2,placeholder:`나눔 질문 ${p+1}`,className:"flex-1 bg-night/40 border border-faint/40 rounded-xl p-2 text-paper text-sm placeholder:text-faint/60 focus:outline-none focus:border-sage resize-none"}),f.length>1&&m.jsx("button",{onClick:()=>b(p),type:"button",className:"text-xs text-faint underline mt-2",children:"삭제"})]},p))})]}),m.jsx("button",{onClick:F,disabled:v,className:"w-full bg-lamp text-nightDeep font-semibold py-4 rounded-2xl shadow-glow disabled:opacity-60",children:v?"저장 중...":"단원 저장하기"})]})}function Sa({label:t,children:e}){return m.jsxs("div",{className:"mb-4",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-2",children:t}),e]})}const ob=[{version:"v1.4",date:"2026-07-12",items:["뒤로가기 버튼 앱 내부 네비게이션 적용","3단원 말씀 사건 본문 등록"]},{version:"v1.3",date:"2026-07-04",items:["토요일 코디네이터 나눔 화면 추가","홈 화면 신설 — 캘린더·오늘·등불·설정 바로가기","THE PLAN 클릭 시 홈으로 이동","JSON으로 단원 가져오기 기능 추가"]},{version:"v1.0",date:"2026-06-01",items:["더플랜 앱 최초 출시","캘린더·오늘·등불·설정 탭 구성","1단원 본문 탑재","Firebase 연동 및 코디네이터 확인 기능"]}];function ab({units:t=[]}){const n=[...[...t].filter(r=>r.startDate&&r.title).sort((r,i)=>r.startDate>i.startDate?-1:1).map(r=>({version:r.title,date:r.startDate,items:[`${r.title} 본문 등록`],isUnit:!0})),...ob].sort((r,i)=>r.date>i.date?-1:1);return m.jsxs("div",{className:"mt-6",children:[m.jsx("p",{className:"text-xs text-lampSoft mb-4 tracking-widest",children:"업데이트 내역"}),m.jsx("div",{className:"flex flex-col gap-4",children:n.map((r,i)=>m.jsxs("div",{className:`border rounded-2xl p-4 ${i===0?r.isUnit?"border-sage/40 bg-sage/5":"border-lamp/40 bg-lamp/5":"border-faint/20 bg-night/30"}`,children:[m.jsxs("div",{className:"flex items-center justify-between mb-3",children:[m.jsxs("div",{className:"flex items-center gap-2",children:[m.jsxs("span",{className:`text-sm font-semibold font-display ${i===0?r.isUnit?"text-sage":"text-lamp":"text-faint"}`,children:[r.isUnit?"📖":"🔧"," ",r.version]}),i===0&&m.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full font-semibold ${r.isUnit?"bg-sage text-nightDeep":"bg-lamp text-nightDeep"}`,children:"최신"})]}),m.jsx("span",{className:"text-xs text-faint/60",children:r.date})]}),m.jsx("ul",{className:"flex flex-col gap-1.5",children:r.items.map((s,o)=>m.jsxs("li",{className:"flex items-start gap-2",children:[m.jsx("span",{className:`mt-1 text-xs ${i===0?r.isUnit?"text-sage":"text-lamp":"text-faint/40"}`,children:"·"}),m.jsx("span",{className:`text-sm leading-relaxed ${i===0?"text-paper":"text-faint/70"}`,children:s})]},o))})]},`${r.version}-${r.date}`))})]})}const lb=[{id:"unit1",title:"1단원 일상의 믿음",startDate:"2026-06-22",days:[{title:"01. 예수가 모르는 크리스천",sections:[{body:`"그 때에 천국은 마치 등을 들고 신랑을 맞으러 나간 열 처녀와 같다 하리니"(마25:1)
...
수도자의 열심 단계에서 우리가 추구할 수련은 기도와 말씀에 집중하지만 이같은 삶이 일상이 되도록 이끄는데 있습니다.`,question:"이제 본격적으로 기도와 말씀을 훈련할텐데 어떤 다짐을 갖고 있는지 적어보십시오."}]}],groupQuestions:["만일 주님이 오늘 이 땅에 오셔서 나를 만난다면 알아보시며 반가워하실 것 같습니까?","'전에 하던 대로' 다니엘의 신앙을 볼 때 나의 일상, 늘 하는 것은 어떤 모습입니까? 나의 일상 생활 중 24시간 예수님이 곁에 있다고 생각하고 자신의 삶을 평가해보십시오.","한 주간동안 공부하면 하나님을 '아버지'라고 몇 번이나 부르신 것 같습니까?","나에게 성경 말씀은 무엇입니까? 매일 먹는 밥입니까? 지난 한 주간 몇 일이나 큐티를 하셨습니까?","이 훈련을 시작하면서 새롭게 다짐하게 된 기도와 말씀의 루틴이 있다면 적어보십시오."]}],Ty="qt_role",Iy="qt_install_seen";function ub({onTabSelect:t,onTodaySelect:e,units:n=[]}){return m.jsxs("div",{className:"flex flex-col min-h-[calc(100vh-6rem)] px-5",children:[m.jsxs("div",{className:"mt-4 mb-4 rounded-2xl overflow-hidden border border-lamp/20 relative",children:[m.jsx("img",{src:"./home-image.jpeg",alt:"더플랜",style:{width:"100%",height:"auto",display:"block",opacity:.9,maxHeight:"400px",objectFit:"contain"},onError:r=>{r.target.style.display="none",r.target.parentElement.style.height="160px",r.target.parentElement.style.background="linear-gradient(135deg, #1a1f35 0%, #0d1526 50%, #101828 100%)"}}),m.jsxs("div",{className:"absolute bottom-3 left-0 right-0 text-center",children:[m.jsx("p",{className:"font-display text-lampSoft text-base drop-shadow",children:"말씀과 함께하는 하루"}),m.jsx("p",{className:"text-faint/80 text-xs tracking-wider",children:"· THE PLAN ·"})]})]}),m.jsxs("div",{className:"grid grid-cols-2 gap-3 mb-6",children:[m.jsxs("button",{onClick:()=>t("calendar"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"📅"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"캘린더"}),m.jsx("span",{className:"text-faint text-xs",children:"기록 보기"})]}),m.jsxs("button",{onClick:e,className:"flex flex-col items-center justify-center gap-1.5 border border-lamp rounded-2xl py-5 bg-lamp/10 shadow-glow active:bg-lamp/20",children:[m.jsx("span",{className:"text-2xl",children:"✍️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"오늘"}),m.jsx("span",{className:"text-faint text-xs",children:"오늘 큐티 작성"})]}),m.jsxs("button",{onClick:()=>t("stats"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"🕯️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"등불"}),m.jsx("span",{className:"text-faint text-xs",children:"연속 기록"})]}),m.jsxs("button",{onClick:()=>t("settings"),className:"flex flex-col items-center justify-center gap-1.5 border border-lamp/30 rounded-2xl py-5 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"⚙️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"설정"}),m.jsx("span",{className:"text-faint text-xs",children:"알림·단원 관리"})]})]}),m.jsx(ab,{units:n}),m.jsx("div",{className:"h-8"})]})}function cb(){const[t,e]=H.useState(()=>localStorage.getItem(Ty)),[n,r]=H.useState(()=>localStorage.getItem(Iy)==="1"),[i,s]=H.useState("home"),[o,l]=H.useState(null),[u,h]=H.useState(!1),[f,y]=H.useState(!1),{entries:v,saveEntry:k,setCheck:R,deleteEntry:P}=WN(),{units:O}=CE(),I=[...lb,...O];H.useEffect(()=>{HN(()=>y(!0))},[]);const E=C=>{window.history.pushState(C,"")};H.useEffect(()=>{const C=S=>{const Y=S.state;if(!Y){l(null),h(!1),s("home");return}s(Y.tab??"home"),l(Y.selectedDate??null),h(Y.showUnitManager??!1)};return window.addEventListener("popstate",C),window.history.replaceState({tab:"home",selectedDate:null,showUnitManager:!1},""),()=>window.removeEventListener("popstate",C)},[]);const A=C=>{localStorage.setItem(Ty,C),e(C)},b=()=>{localStorage.setItem(Iy,"1"),r(!0)},F=()=>{l(null),h(!1),s("home"),E({tab:"home",selectedDate:null,showUnitManager:!1})},M=C=>{l(null),h(!1),s(C),E({tab:C,selectedDate:null,showUnitManager:!1})},_=()=>{h(!1),l($s()),s("calendar"),E({tab:"calendar",selectedDate:$s(),showUnitManager:!1})},p=C=>{l(C),E({tab:i,selectedDate:C,showUnitManager:!1})},w=()=>{l(null),E({tab:i,selectedDate:null,showUnitManager:!1})},T=()=>{h(!0),E({tab:i,selectedDate:null,showUnitManager:!0})},x=()=>{h(!1),E({tab:i,selectedDate:null,showUnitManager:!1})};return t?n?f?m.jsxs("div",{className:"min-h-screen pb-24",children:[m.jsxs("div",{className:"px-5 pt-6 flex items-center justify-between",children:[m.jsx("button",{onClick:F,className:"font-display text-lampSoft text-sm tracking-widest",children:"THE PLAN"}),m.jsx("span",{className:"text-xs text-faint",children:t==="writer"?"작성자":"코디네이터"})]}),u?m.jsx(rb,{onClose:x}):o?t==="writer"?m.jsx(GN,{dateKey:o,entry:v[o],units:I,onSave:k,onDelete:P,onClose:w}):m.jsx(YN,{dateKey:o,entry:v[o],units:I,onCheck:R,onClose:w}):m.jsxs(m.Fragment,{children:[i==="home"&&m.jsx(ub,{onTabSelect:M,onTodaySelect:_,units:O}),i==="calendar"&&m.jsx(QN,{entries:v,onSelectDate:p}),i==="stats"&&m.jsx(eb,{entries:v}),i==="settings"&&m.jsxs("div",{className:"px-5 pb-6",children:[m.jsx("button",{onClick:T,className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-6",children:"📖 본문 관리 (단원 추가/수정)"}),m.jsx(XN,{role:t})]})]}),m.jsxs("div",{className:"fixed bottom-0 left-0 right-0 bg-nightDeep border-t border-faint/20 flex",children:[m.jsx("button",{onClick:()=>M("home"),className:`flex-1 py-4 text-sm ${i==="home"&&!o&&!u?"text-lamp":"text-faint"}`,children:"홈"}),m.jsx("button",{onClick:()=>M("calendar"),className:`flex-1 py-4 text-sm ${i==="calendar"&&!o?"text-lamp":"text-faint"}`,children:"캘린더"}),m.jsx("button",{onClick:_,className:`flex-1 py-4 text-sm ${o===$s()?"text-lamp":"text-faint"}`,children:"오늘"}),m.jsx("button",{onClick:()=>M("stats"),className:`flex-1 py-4 text-sm ${i==="stats"&&!o?"text-lamp":"text-faint"}`,children:"등불"}),m.jsx("button",{onClick:()=>M("settings"),className:`flex-1 py-4 text-sm ${i==="settings"&&!o?"text-lamp":"text-faint"}`,children:"설정"})]})]}):m.jsx("div",{className:"min-h-screen flex items-center justify-center text-faint",children:m.jsx("p",{children:"연결 중..."})}):m.jsx(jS,{onDone:b}):m.jsx(LS,{onSelect:A})}kc.createRoot(document.getElementById("root")).render(m.jsx(IT.StrictMode,{children:m.jsx(cb,{})}));
