...
수도자의 열심 단계에서 우리가 추구할 수련은 기도와 말씀에 집중하지만 이같은 삶이 일상이 되도록 이끄는데 있습니다.`,question:"이제 본격적으로 기도와 말씀을 훈련할텐데 어떤 다짐을 갖고 있는지 적어보십시오."}]}],groupQuestions:["만일 주님이 오늘 이 땅에 오셔서 나를 만난다면 알아보시며 반가워하실 것 같습니까?","'전에 하던 대로' 다니엘의 신앙을 볼 때 나의 일상, 늘 하는 것은 어떤 모습입니까? 나의 일상 생활 중 24시간 예수님이 곁에 있다고 생각하고 자신의 삶을 평가해보십시오.","한 주간동안 공부하면 하나님을 '아버지'라고 몇 번이나 부르신 것 같습니까?","나에게 성경 말씀은 무엇입니까? 매일 먹는 밥입니까? 지난 한 주간 몇 일이나 큐티를 하셨습니까?","이 훈련을 시작하면서 새롭게 다짐하게 된 기도와 말씀의 루틴이 있다면 적어보십시오."]}],Ty="qt_role",Iy="qt_install_seen";function ub({onTabSelect:t,onTodaySelect:e}){return m.jsxs("div",{className:"flex flex-col min-h-[calc(100vh-6rem)] px-5",children:[m.jsx("div",{className:"mt-4 mb-6 rounded-2xl overflow-hidden border border-lamp/20 bg-night/60",style:{height:"40vw",maxHeight:"260px",minHeight:"160px"},children:m.jsx("img",{src:"./home-image.jpg",alt:"더플랜",className:"w-full h-full object-cover opacity-80",onError:n=>{n.target.style.display="none",n.target.parentElement.style.background="linear-gradient(135deg, #1a1f35 0%, #0d1526 50%, #101828 100%)",n.target.parentElement.innerHTML=`
              <div style="width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;">
                <p style="font-family:serif;color:#c8a96e;letter-spacing:0.2em;font-size:1.1rem;">더플랜</p>
                <p style="color:#4a5568;font-size:0.7rem;letter-spacing:0.3em;">· THE PLAN ·</p>
              </div>
            `}})}),m.jsxs("div",{className:"mb-8 text-center",children:[m.jsx("p",{className:"font-display text-lampSoft text-lg mb-1",children:"말씀과 함께하는 하루"}),m.jsx("p",{className:"text-faint text-xs tracking-wider",children:"· THE PLAN ·"})]}),m.jsxs("div",{className:"grid grid-cols-2 gap-3 mb-4",children:[m.jsxs("button",{onClick:()=>t("calendar"),className:"flex flex-col items-center justify-center gap-2 border border-lamp/30 rounded-2xl py-7 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"📅"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"캘린더"}),m.jsx("span",{className:"text-faint text-xs",children:"기록 보기"})]}),m.jsxs("button",{onClick:e,className:"flex flex-col items-center justify-center gap-2 border border-lamp rounded-2xl py-7 bg-lamp/10 shadow-glow active:bg-lamp/20",children:[m.jsx("span",{className:"text-2xl",children:"✍️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"오늘"}),m.jsx("span",{className:"text-faint text-xs",children:"오늘 큐티 작성"})]}),m.jsxs("button",{onClick:()=>t("stats"),className:"flex flex-col items-center justify-center gap-2 border border-lamp/30 rounded-2xl py-7 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"🕯️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"등불"}),m.jsx("span",{className:"text-faint text-xs",children:"연속 기록"})]}),m.jsxs("button",{onClick:()=>t("settings"),className:"flex flex-col items-center justify-center gap-2 border border-lamp/30 rounded-2xl py-7 bg-lamp/5 active:bg-lamp/10",children:[m.jsx("span",{className:"text-2xl",children:"⚙️"}),m.jsx("span",{className:"text-lamp font-semibold text-sm",children:"설정"}),m.jsx("span",{className:"text-faint text-xs",children:"알림·단원 관리"})]})]})]})}function cb(){const[t,e]=W.useState(()=>localStorage.getItem(Ty)),[n,r]=W.useState(()=>localStorage.getItem(Iy)==="1"),[i,s]=W.useState("home"),[o,l]=W.useState(null),[u,h]=W.useState(!1),[f,y]=W.useState(!1),{entries:v,saveEntry:k,setCheck:C,deleteEntry:N}=WN(),{units:O}=CE(),I=[...lb,...O];W.useEffect(()=>{HN(()=>y(!0))},[]);const E=_=>{localStorage.setItem(Ty,_),e(_)},x=()=>{localStorage.setItem(Iy,"1"),r(!0)},b=()=>{l(null),h(!1),s("home")},F=_=>{l(null),h(!1),s(_)},j=()=>{h(!1),l(Nl()),s("calendar")};return t?n?f?m.jsxs("div",{className:"min-h-screen pb-24",children:[m.jsxs("div",{className:"px-5 pt-6 flex items-center justify-between",children:[m.jsx("button",{onClick:b,className:"font-display text-lampSoft text-sm tracking-widest",children:"THE PLAN"}),m.jsx("span",{className:"text-xs text-faint",children:t==="writer"?"작성자":"코디네이터"})]}),u?m.jsx(rb,{onClose:()=>h(!1)}):o?t==="writer"?m.jsx(GN,{dateKey:o,entry:v[o],units:I,onSave:k,onDelete:N,onClose:()=>l(null)}):m.jsx(YN,{dateKey:o,entry:v[o],units:I,onCheck:C,onClose:()=>l(null)}):m.jsxs(m.Fragment,{children:[i==="home"&&m.jsx(ub,{onTabSelect:F,onTodaySelect:j}),i==="calendar"&&m.jsx(QN,{entries:v,onSelectDate:l}),i==="stats"&&m.jsx(eb,{entries:v}),i==="settings"&&m.jsxs("div",{className:"px-5 pb-6",children:[m.jsx("button",{onClick:()=>h(!0),className:"w-full border border-lamp text-lamp font-semibold py-4 rounded-2xl mb-6",children:"📖 본문 관리 (단원 추가/수정)"}),m.jsx(XN,{role:t}),m.jsx(ab,{})]})]}),m.jsxs("div",{className:"fixed bottom-0 left-0 right-0 bg-nightDeep border-t border-faint/20 flex",children:[m.jsx("button",{onClick:()=>F("home"),className:`flex-1 py-4 text-sm ${i==="home"&&!o?"text-lamp":"text-faint"}`,children:"홈"}),m.jsx("button",{onClick:()=>F("calendar"),className:`flex-1 py-4 text-sm ${i==="calendar"&&!o?"text-lamp":"text-faint"}`,children:"캘린더"}),m.jsx("button",{onClick:j,className:`flex-1 py-4 text-sm ${o===Nl()?"text-lamp":"text-faint"}`,children:"오늘"}),m.jsx("button",{onClick:()=>F("stats"),className:`flex-1 py-4 text-sm ${i==="stats"&&!o?"text-lamp":"text-faint"}`,children:"등불"}),m.jsx("button",{onClick:()=>F("settings"),className:`flex-1 py-4 text-sm ${i==="settings"&&!o?"text-lamp":"text-faint"}`,children:"설정"})]})]}):m.jsx("div",{className:"min-h-screen flex items-center justify-center text-faint",children:m.jsx("p",{children:"연결 중..."})}):m.jsx(jS,{onDone:x}):m.jsx(LS,{onSelect:E})}kc.createRoot(document.getElementById("root")).render(m.jsx(IT.StrictMode,{children:m.jsx(cb,{})}));
