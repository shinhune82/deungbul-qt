...
수도자의 열심 단계에서 우리가 추구할 수련은 기도와 말씀에 집중하지만 이같은 삶이 일상이 되도록 이끄는데 있습니다.`,question:"이제 본격적으로 기도와 말씀을 훈련할텐데 어떤 다짐을 갖고 있는지 적어보십시오."}]}],groupQuestions:["만일 주님이 오늘 이 땅에 오셔서 나를 만난다면 알아보시며 반가워하실 것 같습니까?","'전에 하던 대로' 다니엘의 신앙을 볼 때 나의 일상, 늘 하는 것은 어떤 모습입니까? 나의 일상 생활 중 24시간 예수님이 곁에 있다고 생각하고 자신의 삶을 평가해보십시오.","한 주간동안 공부하면 하나님을 '아버지'라고 몇 번이나 부르신 것 같습니까?","나에게 성경 말씀은 무엇입니까? 매일 먹는 밥입니까? 지난 한 주간 몇 일이나 큐티를 하셨습니까?","이 훈련을 시작하면서 새롭게 다짐하게 된 기도와 말씀의 루틴이 있다면 적어보십시오."]}],Ty="qt_role",Iy="qt_install_seen";function ub({onTabSelect:t,onTodaySelect:e}){return m.jsxs("div",{className:"flex flex-col min-h-[calc(100vh-6rem)] px-5",children:[m.jsx("div",{className:"mt-4 mb-6 rounded-2xl overflow-hidden border border-lamp/20 bg-night/60",style:{height:"40vw",maxHeight:"260px",minHeight:"160px"},children:m.jsx("img",{src:"./home-image.jpeg",alt:"더플랜",className:"w-full h-full object-cover opacity-80",onError:n=>{n.target.style.display="none",n.target.parentElement.style.background="linear-gradient(135deg, #1a1f35 0%, #0d1526 50%, #101828 100%)",n.target.parentElement.innerHTML=`
