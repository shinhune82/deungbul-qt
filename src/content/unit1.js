// 단원 본문 데이터
// sections 배열로 본문과 묵상질문을 교차 배치합니다.
// 각 section: { body: "본문", question: "묵상질문" } 또는 { body: "본문" } (질문 없는 마지막 단락)
...
기름이 고갈되어서는 안됩니다. 그러니까 밤 중에 거한 채로 돌아설 수 없을정도로 죄와 불신앙이 라이프스타일이 되어서는 안됩니다. "그 날과 그 때"를 만났을 때 신랑과 아무런 관계가 없는 존재, 예수 그리스도가 알지 못하는 존재가 되어 있어서는 안됩니다. 다시 말해서 신랑이 모르는 존재, 예수가 모르는 크리스천이 될 수도 있다는 사실을 기억해야 합니다.`,
            question: '주님이 자신을 알아보리라 생각하십니까? 주님이 아실 것 같은 크리스천이라고 생각이 드십니까?'
          },
          {
            body: `기도는 점점 힘들어지고 정말 한 번의 기도조차 힘듭니다. 죄를 범하되 그 죄에 거하는 시간과 방임의 시간이 길어지며 돌아설지라도 여전히 그 죄의 끈을 붙잡은 채 주님 앞에 나오는 것이 일상이 되어 있습니다. 분명 교회에서 무슨 봉사도 하고 무슨 직분도 있지만 아무도 보지 않을 때 스스로 크리스천이라고 말하기가 부끄럽습니다. 그렇다면 정말 위험한 상황입니다. 이제 주님의 경고를 심각하게 들어야 할 것입니다.
...
만일 이 음성이 들린다면 그래서 자신의 상태를 심각하게 생각하며 이 시간 주님 앞에 무릎을 꿇고 그 음성에 청종하려 한다면 아직 희망이 있는 때입니다. 그러나 어느 날 이같은 소리가 전혀 들리지 않으며 그저 껍데기만 교회를 다니는 사람, 그것도 사회적 체면이나 멤버쉽 정도가 된 채 죄와 더러움에 방치하고 "밤 중"을 살고 있게 된다면 끝난 상태입니다. 그러므로 지금 깨어 있어야 합니다. 더 무너지고 모든 것이 소멸되기 전에 말입니다.`,
            question: '지금 자신의 상태를 심각하게 생각하고 있다면 다행입니다. 앞으로의 수련은 큰 도움이 될 것입니다. 그 다짐의 기도를 쓰신 후 그 자리에 무릎을 꿇고 주님께 그 기도를 드려보십시오.'
          }
        ]
      },
      {
...
"너는 내게 부르짖으라 내가 네게 응답하겠고 네가 알지 못하는 크고 비밀한 일을 네게 보이리라"(렘33:3)`,
            question: '기도는 힘이 들고 말씀묵상은 졸리는 일이며 예배조차 늘 신경써야만 지킬 수 있는 사람이라면 얼마나 억울한 일입니까? 그 기도에 크고 비밀한 일을 보는 사건이 있을지 모르며 혹 보여주신다고 해도 알아채릴 수 있겠습니까? 일상이 예배가 아니라 일상이 세상의 삶뿐이라면 그렇지 않겠습니까? 억울하지 않겠습니까?'
          }
        ]
      },
      {
...
어떤 의미에서 하나님을 아버지라고 부를 수 있다면 이미 기도의 전부입니다. 아버지라고 부르는 것만으로 충분합니다. 관계가 기도의 응답이기 때문입니다.`,
            question: '하나님을 아버지라고 부를 수 있습니까? 자신의 어머니나 아버지를 부르듯이 하나님을 \'아빠 아버지\'라고 부를 수 있습니까? 한번 불러보십시오. 자연스럽습니까?'
          },
          {
            body: `기도훈련의 시작은 하나님을 아버지라고 부를 수 있는 영적 관계의 회복에 있습니다. 그것이 기도의 전부이기 때문입니다.`,
            question: '준비되셨습니까? 어떤 기대를 가지고 계십니까?'
          }
        ]
      },
      {
...
"주의 말씀은 내 발에 등이요 내 길에 빛이니이다 주의 의로운 규례들을 지키기로 맹세하고 굳게 정하였나이다"(시119:105-106)`,
            question: '나에게 성경 말씀은 무엇입니까? 매일 먹는 밥입니까? 그래서 매일 큐티를 하는 것이 자연스럽습니까?'
          },
          {
            body: `하루 하루를 사는 동안 말씀이 살아서 우리를 인도하고 격려합니다. 언제나 말씀이 스스로 일하시고 우리를 살리기 때문입니다. 또한 우리에게 길을 보이시고 이끄시기 때문입니다.`,
            question: '하루 하루를 사는 동안 내가 묵상했던 말씀이 살아서 나를 인도하고 격려하였던 경험이 있습니까? 이같은 질문 앞에 어떤 생각이 드십니까?'
          }
        ]
      },
      {
...
수도자의 열심 단계에서 우리가 추구할 수련은 기도와 말씀에 집중하지만 이같은 삶이 일상이 되도록 이끄는데 있습니다.`,
            question: '이제 본격적으로 기도와 말씀을 훈련할텐데 어떤 다짐을 갖고 있는지 적어보십시오.'
          }
        ]
      }
    ],
