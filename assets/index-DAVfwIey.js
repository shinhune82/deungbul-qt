 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,K){var Y=B.length;B.push(K);e:for(;0<Y;){var ve=Y-1>>>1,ce=B[ve];if(0<i(ce,K))B[ve]=K,B[Y]=ce,Y=ve;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var K=B[0],Y=B.pop();if(Y!==K){B[0]=Y;e:for(var ve=0,ce=B.length,xe=ce>>>1;ve<xe;){var on=2*(ve+1)-1,an=B[on],ln=on+1,un=B[ln];if(0>i(an,Y))ln<ce&&0>i(un,an)?(B[ve]=un,B[ln]=Y,ve=ln):(B[ve]=an,B[on]=Y,ve=on);else if(ln<ce&&0>i(un,Y))B[ve]=un,B[ln]=Y,ve=ln;else break e}}return K}function i(B,K){var Y=B.sortIndex-K.sortIndex;return Y!==0?Y:B.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,v=3,k=!1,C=!1,P=!1,O=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,E=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(B){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=B)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function b(B){if(P=!1,A(B),!C)if(n(u)!==null)C=!0,be(F);else{var K=n(h);K!==null&&Ce(b,K.startTime-B)}}function F(B,K){C=!1,P&&(P=!1,I(m),m=-1),k=!0;var Y=v;try{for(A(K),g=n(u);g!==null&&(!(g.expirationTime>K)||B&&!x());){var ve=g.callback;if(typeof ve=="function"){g.callback=null,v=g.priorityLevel;var ce=ve(g.expirationTime<=K);K=t.unstable_now(),typeof ce=="function"?g.callback=ce:g===n(u)&&r(u),A(K)}else r(u);g=n(u)}if(g!==null)var xe=!0;else{var on=n(h);on!==null&&Ce(b,on.startTime-K),xe=!1}return xe}finally{g=null,v=Y,k=!1}}var j=!1,_=null,m=-1,w=5,T=-1;function x(){return!(t.unstable_now()-T<w)}function R(){if(_!==null){var B=t.unstable_now();T=B;var K=!0;try{K=_(!0,B)}finally{K?S():(j=!1,_=null)}}else j=!1}var S;if(typeof E=="function")S=function(){E(R)};else if(typeof MessageChannel<"u"){var Z=new MessageChannel,se=Z.port2;Z.port1.onmessage=R,S=function(){se.postMessage(null)}}else S=function(){O(R,0)};function be(B){_=B,j||(j=!0,S())}function Ce(B,K){m=O(function(){B(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){C||k||(C=!0,be(F))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return v},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(v){case 1:case 2:case 3:var K=3;break;default:K=v}var Y=v;v=K;try{return B()}finally{v=Y}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,K){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var Y=v;v=B;try{return K()}finally{v=Y}},t.unstable_scheduleCallback=function(B,K,Y){var ve=t.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?ve+Y:ve):Y=ve,B){case 1:var ce=-1;break;case 2:ce=250;break;case 5:ce=1073741823;break;case 4:ce=1e4;break;default:ce=5e3}return ce=Y+ce,B={id:f++,callback:K,priorityLevel:B,startTime:Y,expirationTime:ce,sortIndex:-1},Y>ve?(B.sortIndex=Y,e(h,B),n(u)===null&&B===n(h)&&(P?(I(m),m=-1):P=!0,Ce(b,Y-ve))):(B.sortIndex=ce,e(u,B),C||k||(C=!0,be(F))),B},t.unstable_shouldYield=x,t.unstable_wrapCallback=function(B){var K=v;return function(){var Y=v;v=K;try{return B.apply(this,arguments)}finally{v=Y}}}})(My);Ly.exports=My;var PT=Ly.exports;/**
 * @license React
...
*/var br,G_;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,m){function w(){}w.prototype=m.prototype,_.D=m.prototype,_.prototype=new w,_.prototype.constructor=_,_.C=function(T,x,R){for(var S=Array(arguments.length-2),Z=2;Z<arguments.length;Z++)S[Z-2]=arguments[Z];return m.prototype[x].apply(T,S)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(_,m,w){w||(w=0);var T=Array(16);if(typeof m=="string")for(var x=0;16>x;++x)T[x]=m.charCodeAt(w++)|m.charCodeAt(w++)<<8|m.charCodeAt(w++)<<16|m.charCodeAt(w++)<<24;else for(x=0;16>x;++x)T[x]=m[w++]|m[w++]<<8|m[w++]<<16|m[w++]<<24;m=_.g[0],w=_.g[1],x=_.g[2];var R=_.g[3],S=m+(R^w&(x^R))+T[0]+3614090360&4294967295;m=w+(S<<7&4294967295|S>>>25),S=R+(x^m&(w^x))+T[1]+3905402710&4294967295,R=m+(S<<12&4294967295|S>>>20),S=x+(w^R&(m^w))+T[2]+606105819&4294967295,x=R+(S<<17&4294967295|S>>>15),S=w+(m^x&(R^m))+T[3]+3250441966&4294967295,w=x+(S<<22&4294967295|S>>>10),S=m+(R^w&(x^R))+T[4]+4118548399&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(x^m&(w^x))+T[5]+1200080426&4294967295,R=m+(S<<12&4294967295|S>>>20),S=x+(w^R&(m^w))+T[6]+2821735955&4294967295,x=R+(S<<17&4294967295|S>>>15),S=w+(m^x&(R^m))+T[7]+4249261313&4294967295,w=x+(S<<22&4294967295|S>>>10),S=m+(R^w&(x^R))+T[8]+1770035416&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(x^m&(w^x))+T[9]+2336552879&4294967295,R=m+(S<<12&4294967295|S>>>20),S=x+(w^R&(m^w))+T[10]+4294925233&4294967295,x=R+(S<<17&4294967295|S>>>15),S=w+(m^x&(R^m))+T[11]+2304563134&4294967295,w=x+(S<<22&4294967295|S>>>10),S=m+(R^w&(x^R))+T[12]+1804603682&4294967295,m=w+(S<<7&4294967295|S>>>25),S=R+(x^m&(w^x))+T[13]+4254626195&4294967295,R=m+(S<<12&4294967295|S>>>20),S=x+(w^R&(m^w))+T[14]+2792965006&4294967295,x=R+(S<<17&4294967295|S>>>15),S=w+(m^x&(R^m))+T[15]+1236535329&4294967295,w=x+(S<<22&4294967295|S>>>10),S=m+(x^R&(w^x))+T[1]+4129170786&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^x&(m^w))+T[6]+3225465664&4294967295,R=m+(S<<9&4294967295|S>>>23),S=x+(m^w&(R^m))+T[11]+643717713&4294967295,x=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(x^R))+T[0]+3921069994&4294967295,w=x+(S<<20&4294967295|S>>>12),S=m+(x^R&(w^x))+T[5]+3593408605&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^x&(m^w))+T[10]+38016083&4294967295,R=m+(S<<9&4294967295|S>>>23),S=x+(m^w&(R^m))+T[15]+3634488961&4294967295,x=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(x^R))+T[4]+3889429448&4294967295,w=x+(S<<20&4294967295|S>>>12),S=m+(x^R&(w^x))+T[9]+568446438&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^x&(m^w))+T[14]+3275163606&4294967295,R=m+(S<<9&4294967295|S>>>23),S=x+(m^w&(R^m))+T[3]+4107603335&4294967295,x=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(x^R))+T[8]+1163531501&4294967295,w=x+(S<<20&4294967295|S>>>12),S=m+(x^R&(w^x))+T[13]+2850285829&4294967295,m=w+(S<<5&4294967295|S>>>27),S=R+(w^x&(m^w))+T[2]+4243563512&4294967295,R=m+(S<<9&4294967295|S>>>23),S=x+(m^w&(R^m))+T[7]+1735328473&4294967295,x=R+(S<<14&4294967295|S>>>18),S=w+(R^m&(x^R))+T[12]+2368359562&4294967295,w=x+(S<<20&4294967295|S>>>12),S=m+(w^x^R)+T[5]+4294588738&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^x)+T[8]+2272392833&4294967295,R=m+(S<<11&4294967295|S>>>21),S=x+(R^m^w)+T[11]+1839030562&4294967295,x=R+(S<<16&4294967295|S>>>16),S=w+(x^R^m)+T[14]+4259657740&4294967295,w=x+(S<<23&4294967295|S>>>9),S=m+(w^x^R)+T[1]+2763975236&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^x)+T[4]+1272893353&4294967295,R=m+(S<<11&4294967295|S>>>21),S=x+(R^m^w)+T[7]+4139469664&4294967295,x=R+(S<<16&4294967295|S>>>16),S=w+(x^R^m)+T[10]+3200236656&4294967295,w=x+(S<<23&4294967295|S>>>9),S=m+(w^x^R)+T[13]+681279174&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^x)+T[0]+3936430074&4294967295,R=m+(S<<11&4294967295|S>>>21),S=x+(R^m^w)+T[3]+3572445317&4294967295,x=R+(S<<16&4294967295|S>>>16),S=w+(x^R^m)+T[6]+76029189&4294967295,w=x+(S<<23&4294967295|S>>>9),S=m+(w^x^R)+T[9]+3654602809&4294967295,m=w+(S<<4&4294967295|S>>>28),S=R+(m^w^x)+T[12]+3873151461&4294967295,R=m+(S<<11&4294967295|S>>>21),S=x+(R^m^w)+T[15]+530742520&4294967295,x=R+(S<<16&4294967295|S>>>16),S=w+(x^R^m)+T[2]+3299628645&4294967295,w=x+(S<<23&4294967295|S>>>9),S=m+(x^(w|~R))+T[0]+4096336452&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~x))+T[7]+1126891415&4294967295,R=m+(S<<10&4294967295|S>>>22),S=x+(m^(R|~w))+T[14]+2878612391&4294967295,x=R+(S<<15&4294967295|S>>>17),S=w+(R^(x|~m))+T[5]+4237533241&4294967295,w=x+(S<<21&4294967295|S>>>11),S=m+(x^(w|~R))+T[12]+1700485571&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~x))+T[3]+2399980690&4294967295,R=m+(S<<10&4294967295|S>>>22),S=x+(m^(R|~w))+T[10]+4293915773&4294967295,x=R+(S<<15&4294967295|S>>>17),S=w+(R^(x|~m))+T[1]+2240044497&4294967295,w=x+(S<<21&4294967295|S>>>11),S=m+(x^(w|~R))+T[8]+1873313359&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~x))+T[15]+4264355552&4294967295,R=m+(S<<10&4294967295|S>>>22),S=x+(m^(R|~w))+T[6]+2734768916&4294967295,x=R+(S<<15&4294967295|S>>>17),S=w+(R^(x|~m))+T[13]+1309151649&4294967295,w=x+(S<<21&4294967295|S>>>11),S=m+(x^(w|~R))+T[4]+4149444226&4294967295,m=w+(S<<6&4294967295|S>>>26),S=R+(w^(m|~x))+T[11]+3174756917&4294967295,R=m+(S<<10&4294967295|S>>>22),S=x+(m^(R|~w))+T[2]+718787259&4294967295,x=R+(S<<15&4294967295|S>>>17),S=w+(R^(x|~m))+T[9]+3951481745&4294967295,_.g[0]=_.g[0]+m&4294967295,_.g[1]=_.g[1]+(x+(S<<21&4294967295|S>>>11))&4294967295,_.g[2]=_.g[2]+x&4294967295,_.g[3]=_.g[3]+R&4294967295}r.prototype.u=function(_,m){m===void 0&&(m=_.length);for(var w=m-this.blockSize,T=this.B,x=this.h,R=0;R<m;){if(x==0)for(;R<=w;)i(this,_,R),R+=this.blockSize;if(typeof _=="string"){for(;R<m;)if(T[x++]=_.charCodeAt(R++),x==this.blockSize){i(this,T),x=0;break}}else for(;R<m;)if(T[x++]=_[R++],x==this.blockSize){i(this,T),x=0;break}}this.h=x,this.o+=m},r.prototype.v=function(){var _=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);_[0]=128;for(var m=1;m<_.length-8;++m)_[m]=0;var w=8*this.o;for(m=_.length-8;m<_.length;++m)_[m]=w&255,w/=256;for(this.u(_),_=Array(16),m=w=0;4>m;++m)for(var T=0;32>T;T+=8)_[w++]=this.g[m]>>>T&255;return _};function s(_,m){var w=l;return Object.prototype.hasOwnProperty.call(w,_)?w[_]:w[_]=m(_)}function o(_,m){this.h=m;for(var w=[],T=!0,x=_.length-1;0<=x;x--){var R=_[x]|0;T&&R==m||(w[x]=R,T=!1)}this.g=w}var l={};function u(_){return-128<=_&&128>_?s(_,function(m){return new o([m|0],0>m?-1:0)}):new o([_|0],0>_?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return g;if(0>_)return O(h(-_));for(var m=[],w=1,T=0;_>=w;T++)m[T]=_/w|0,w*=4294967296;return new o(m,0)}function f(_,m){if(_.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(_.charAt(0)=="-")return O(f(_.substring(1),m));if(0<=_.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=h(Math.pow(m,8)),T=g,x=0;x<_.length;x+=8){var R=Math.min(8,_.length-x),S=parseInt(_.substring(x,x+R),m);8>R?(R=h(Math.pow(m,R)),T=T.j(R).add(h(S))):(T=T.j(w),T=T.add(h(S)))}return T}var g=u(0),v=u(1),k=u(16777216);t=o.prototype,t.m=function(){if(P(this))return-O(this).m();for(var _=0,m=1,w=0;w<this.g.length;w++){var T=this.i(w);_+=(0<=T?T:4294967296+T)*m,m*=4294967296}return _},t.toString=function(_){if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(C(this))return"0";if(P(this))return"-"+O(this).toString(_);for(var m=h(Math.pow(_,6)),w=this,T="";;){var x=b(w,m).g;w=I(w,x.j(m));var R=((0<w.g.length?w.g[0]:w.h)>>>0).toString(_);if(w=x,C(w))return R+T;for(;6>R.length;)R="0"+R;T=R+T}},t.i=function(_){return 0>_?0:_<this.g.length?this.g[_]:this.h};function C(_){if(_.h!=0)return!1;for(var m=0;m<_.g.length;m++)if(_.g[m]!=0)return!1;return!0}function P(_){return _.h==-1}t.l=function(_){return _=I(this,_),P(_)?-1:C(_)?0:1};function O(_){for(var m=_.g.length,w=[],T=0;T<m;T++)w[T]=~_.g[T];return new o(w,~_.h).add(v)}t.abs=function(){return P(this)?O(this):this},t.add=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0,x=0;x<=m;x++){var R=T+(this.i(x)&65535)+(_.i(x)&65535),S=(R>>>16)+(this.i(x)>>>16)+(_.i(x)>>>16);T=S>>>16,R&=65535,S&=65535,w[x]=S<<16|R}return new o(w,w[w.length-1]&-2147483648?-1:0)};function I(_,m){return _.add(O(m))}t.j=function(_){if(C(this)||C(_))return g;if(P(this))return P(_)?O(this).j(O(_)):O(O(this).j(_));if(P(_))return O(this.j(O(_)));if(0>this.l(k)&&0>_.l(k))return h(this.m()*_.m());for(var m=this.g.length+_.g.length,w=[],T=0;T<2*m;T++)w[T]=0;for(T=0;T<this.g.length;T++)for(var x=0;x<_.g.length;x++){var R=this.i(T)>>>16,S=this.i(T)&65535,Z=_.i(x)>>>16,se=_.i(x)&65535;w[2*T+2*x]+=S*se,E(w,2*T+2*x),w[2*T+2*x+1]+=R*se,E(w,2*T+2*x+1),w[2*T+2*x+1]+=S*Z,E(w,2*T+2*x+1),w[2*T+2*x+2]+=R*Z,E(w,2*T+2*x+2)}for(T=0;T<m;T++)w[T]=w[2*T+1]<<16|w[2*T];for(T=m;T<2*m;T++)w[T]=0;return new o(w,0)};function E(_,m){for(;(_[m]&65535)!=_[m];)_[m+1]+=_[m]>>>16,_[m]&=65535,m++}function A(_,m){this.g=_,this.h=m}function b(_,m){if(C(m))throw Error("division by zero");if(C(_))return new A(g,g);if(P(_))return m=b(O(_),m),new A(O(m.g),O(m.h));if(P(m))return m=b(_,O(m)),new A(O(m.g),m.h);if(30<_.g.length){if(P(_)||P(m))throw Error("slowDivide_ only works with positive integers.");for(var w=v,T=m;0>=T.l(_);)w=F(w),T=F(T);var x=j(w,1),R=j(T,1);for(T=j(T,2),w=j(w,2);!C(T);){var S=R.add(T);0>=S.l(_)&&(x=x.add(w),R=S),T=j(T,1),w=j(w,1)}return m=I(_,x.j(m)),new A(x,m)}for(x=g;0<=_.l(m);){for(w=Math.max(1,Math.floor(_.m()/m.m())),T=Math.ceil(Math.log(w)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),R=h(w),S=R.j(m);P(S)||0<S.l(_);)w-=T,R=h(w),S=R.j(m);C(R)&&(R=v),x=x.add(R),_=I(_,S)}return new A(x,_)}t.A=function(_){return b(this,_).h},t.and=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)&_.i(T);return new o(w,this.h&_.h)},t.or=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)|_.i(T);return new o(w,this.h|_.h)},t.xor=function(_){for(var m=Math.max(this.g.length,_.g.length),w=[],T=0;T<m;T++)w[T]=this.i(T)^_.i(T);return new o(w,this.h^_.h)};function F(_){for(var m=_.g.length+1,w=[],T=0;T<m;T++)w[T]=_.i(T)<<1|_.i(T-1)>>>31;return new o(w,_.h)}function j(_,m){var w=m>>5;m%=32;for(var T=_.g.length-w,x=[],R=0;R<T;R++)x[R]=0<m?_.i(R+w)>>>m|_.i(R+w+1)<<32-m:_.i(R+w);return new o(x,_.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,G_=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,br=o}).apply(typeof og<"u"?og:typeof self<"u"?self:typeof window<"u"?window:{});var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je="WebChannelConnection";class c1 extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+n.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(n,r,i,s,o){const l=gc(),u=this.xo(n,r.toUriEncodedString());q("RestConnection",`Sending RPC '${n}' ${l}:`,u,i);const h={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(h,s,o),this.No(n,u,h,i).then(f=>(q("RestConnection",`Received RPC '${n}' ${l}: `,f),f),f=>{throw Oi("RestConnection",`RPC '${n}' ${l} failed with error: `,f,"url: ",u,"request:",i),f})}Lo(n,r,i,s,o,l){return this.Mo(n,r,i,s,o)}Oo(n,r,i){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ki}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,o)=>n[o]=s),i&&i.headers.forEach((s,o)=>n[o]=s)}xo(n,r){const i=l1[n];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,n,r,i){const s=gc();return new Promise((o,l)=>{const u=new Y_;u.setWithCredentials(!0),u.listenOnce(X_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case La.NO_ERROR:const f=u.getResponseJson();q(Je,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(f)),o(f);break;case La.TIMEOUT:q(Je,`RPC '${e}' ${s} timed out`),l(new $(V.DEADLINE_EXCEEDED,"Request time out"));break;case La.HTTP_ERROR:const g=u.getStatus();if(q(Je,`RPC '${e}' ${s} failed with status:`,g,"response text:",u.getResponseText()),g>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const k=v==null?void 0:v.error;if(k&&k.status&&k.message){const C=function(O){const I=O.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(I)>=0?I:V.UNKNOWN}(k.status);l(new $(C,k.message))}else l(new $(V.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new $(V.UNAVAILABLE,"Connection failed."));break;default:G()}}finally{q(Je,`RPC '${e}' ${s} completed.`)}});const h=JSON.stringify(i);q(Je,`RPC '${e}' ${s} sending request:`,i),u.send(n,"POST",h,r,15)})}Bo(e,n,r){const i=gc(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=ew(),l=Z_(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const f=s.join("");q(Je,`Creating RPC '${e}' stream ${i}: ${f}`,u);const g=o.createWebChannel(f,u);let v=!1,k=!1;const C=new u1({Io:O=>{k?q(Je,`Not sending because RPC '${e}' stream ${i} is closed:`,O):(v||(q(Je,`Opening RPC '${e}' stream ${i} transport.`),g.open(),v=!0),q(Je,`RPC '${e}' stream ${i} sending:`,O),g.send(O))},To:()=>g.close()}),P=(O,I,E)=>{O.listen(I,A=>{try{E(A)}catch(b){setTimeout(()=>{throw b},0)}})};return P(g,xs.EventType.OPEN,()=>{k||(q(Je,`RPC '${e}' stream ${i} transport opened.`),C.yo())}),P(g,xs.EventType.CLOSE,()=>{k||(k=!0,q(Je,`RPC '${e}' stream ${i} transport closed`),C.So())}),P(g,xs.EventType.ERROR,O=>{k||(k=!0,Oi(Je,`RPC '${e}' stream ${i} transport errored:`,O),C.So(new $(V.UNAVAILABLE,"The operation could not be completed")))}),P(g,xs.EventType.MESSAGE,O=>{var I;if(!k){const E=O.data[0];ue(!!E);const A=E,b=A.error||((I=A[0])===null||I===void 0?void 0:I.error);if(b){q(Je,`RPC '${e}' stream ${i} received error:`,b);const F=b.status;let j=function(w){const T=Re[w];if(T!==void 0)return xw(T)}(F),_=b.message;j===void 0&&(j=V.INTERNAL,_="Unknown error status: "+F+" with message "+b.message),k=!0,C.So(new $(j,_)),g.close()}else q(Je,`RPC '${e}' stream ${i} received:`,E),C.bo(E)}}),P(l,J_.STAT_EVENT,O=>{O.stat===xh.PROXY?q(Je,`RPC '${e}' stream ${i} detected buffering proxy`):O.stat===xh.NOPROXY&&q(Je,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{C.wo()},0),C}}function yc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function za(t,e,n){return`firebase:${t}:${e}:${n}`}class xi{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=za(this.userKey,i.apiKey,s),this.fullPersistenceKey=za("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?_n._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new xi(wn(Xg),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||wn(Xg);const o=za(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const g=_n._fromJSON(e,f);h!==s&&(l=g),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new xi(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new xi(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
